...
> [!WARNING]
> Использование чит-программ строго запрещено Габеном. Это может привести к блокировке вашего аккаунта! Если вы будете слишком хорошо играть, то активируется система 50% и Габеша будет лично подкидывать вам 5 актеров. (Сапорты лесные, Мид слитый)
