...
pub mod client_dll {
    ...
    // Field count: 1
    pub mod C_ItemCrate {
        pub const m_eLootType: usize = 0xC90; // int32
    }
    ...
    pub mod CCitadel_ArmorUpgrade_SpellShieldVData {
        pub const m_SpellShieldBuffModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbility_Rutger_ForceField_VData {
        pub const m_AuraModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_VictimPushModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SlowModifier: usize = 0x1580; // CEmbeddedSubclass<CBaseModifier>
        pub const m_strDomeCreated: usize = 0x1590; // CSoundEventName
        pub const m_strChargeUpSound: usize = 0x15A0; // CSoundEventName
        pub const m_strPushAndDamage: usize = 0x15B0; // CSoundEventName
        pub const m_ChronoSphereChargeParticle: usize = 0x15C0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CitadelAbilityVData
    // Field count: 9
    pub mod CCitadel_Ability_Tokamak_CrimsonCannonVData {
        pub const m_LaserShot: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ChargeParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CasterOnlyTargetParticle: usize = 0x1720; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_EnemyTargetedParticle: usize = 0x1800; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strEnemyBeenTargetedSound: usize = 0x18E0; // CSoundEventName
        pub const m_strCasterTargetSelectedSound: usize = 0x18F0; // CSoundEventName
        pub const m_strFireSound: usize = 0x1900; // CSoundEventName
        pub const m_strImpactSound: usize = 0x1910; // CSoundEventName
        pub const m_strBlockedSound: usize = 0x1920; // CSoundEventName
    }
    ...
    pub mod C_TriggerItemShop {
        pub const m_iszSoundName: usize = 0x9A0; // CUtlSymbolLarge
    }
    // Parent: CBaseFilter
    // Field count: 1
    pub mod CFilterName {
        pub const m_iFilterName: usize = 0x5C0; // CUtlSymbolLarge
    }
    ...
    pub mod CAbility_Synth_Blitz_VData {
        pub const m_BlitzModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_TechAmpModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SlowParticle: usize = 0x1580; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strProcSound: usize = 0x1660; // CSoundEventName
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CAbilityMedicHealVData {
        pub const m_HealBeamParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_HealTargetParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strHealCastSound: usize = 0x1720; // CSoundEventName
    }
    // Parent: C_BaseEntity
    // Field count: 0
    ...
    pub mod C_Citadel_Ice_Dome_Blocker {
        pub const m_flTurnSolidTime: usize = 0xB00; // GameTime_t
    }
    ...
    pub mod CCitadel_Ability_Protection_RacketVData {
        pub const m_CastOtherParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ArmorModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
    }
    ...
    pub mod FilterHealth {
        pub const m_bAdrenalineActive: usize = 0x5C0; // bool
        pub const m_iHealthMin: usize = 0x5C4; // int32
        pub const m_iHealthMax: usize = 0x5C8; // int32
    }
    // Parent: C_CitadelProjectile
    // Field count: 2
    pub mod C_Projectile_Stomp_Projectile {
        pub const m_flWidth: usize = 0x8E8; // float32
        pub const m_tDieTime: usize = 0x8EC; // GameTime_t
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 2
    pub mod CCitadelBaseTriggerAbility {
        pub const m_hAbilityToTrigger: usize = 0xCA0; // CHandle<C_CitadelBaseAbility>
        pub const m_SwappedToTime: usize = 0xCA4; // GameTime_t
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbilityPowerSurgeVData {
        pub const m_ChainParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CastHitParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_BuffModifier: usize = 0x1720; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ChainModifier: usize = 0x1730; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_BaseEventProcVData
    // Field count: 3
    ...
    pub mod CCitadel_Ability_ZipLine {
        pub const m_flActivatePressTime: usize = 0x1098; // GameTime_t
        pub const m_bThinking: usize = 0x109C; // bool
        pub const m_bMoveCollidedPushUp: usize = 0x109D; // bool
        pub const m_flTimeStartZipping: usize = 0x10AC; // GameTime_t
        pub const m_flTimeForKnockdownProtection: usize = 0x10B0; // GameTime_t
        pub const m_flTimeStopZipping: usize = 0x10B4; // GameTime_t
        pub const m_flCasterSpeed: usize = 0x10B8; // float32
        pub const m_vecInitialVel: usize = 0x10BC; // CNetworkVelocityVector
        pub const m_vecAttachPoint: usize = 0x10F0; // Vector
        pub const m_pPrevNode: usize = 0x10FC; // CHandle<C_BaseEntity>
        pub const m_pNextNode: usize = 0x1100; // CHandle<C_BaseEntity>
        pub const m_flTimeEnterState: usize = 0x1104; // GameTime_t
        pub const m_flLatchTime: usize = 0x1108; // GameTime_t
        pub const m_flDamagedTime: usize = 0x110C; // GameTime_t
        pub const m_eAttachState: usize = 0x1110; // EAttachState_t
        pub const m_iAttachedZipLineLane: usize = 0x1114; // int32
        pub const m_bDroppedFromZipline: usize = 0x1118; // bool
        pub const m_hAttachZipLine: usize = 0x1119; // AttachmentHandle_t
        pub const m_vAttachZipLineOffset: usize = 0x111C; // Vector
        pub const m_flZiplineAirDrag: usize = 0x1128; // float32
    }
    ...
    pub mod C_TeamRelativeParticleSystem {
        pub const m_iszFriendlyEffectName: usize = 0xE28; // CUtlSymbolLarge
        pub const m_iszEnemyEffectName: usize = 0xE30; // CUtlSymbolLarge
        pub const m_iFriendlyEffectIndex: usize = 0xE38; // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
        pub const m_iEnemyEffectIndex: usize = 0xE40; // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod C_BaseModelEntity {
        pub const m_CRenderComponent: usize = 0x568; // CRenderComponent*
        pub const m_CHitboxComponent: usize = 0x570; // CHitboxComponent
        pub const m_LastHitGroup: usize = 0x598; // HitGroup_t
        pub const m_bInitModelEffects: usize = 0x5C0; // bool
        pub const m_bIsStaticProp: usize = 0x5C1; // bool
        pub const m_nLastAddDecal: usize = 0x5C4; // int32
        pub const m_nDecalsAdded: usize = 0x5C8; // int32
        pub const m_iOldHealth: usize = 0x5CC; // int32
        pub const m_nRenderMode: usize = 0x5D0; // RenderMode_t
        pub const m_nRenderFX: usize = 0x5D1; // RenderFx_t
        pub const m_szAddModifier: usize = 0x5D8; // CUtlString
        pub const m_bAllowFadeInView: usize = 0x5E0; // bool
        pub const m_bHasCollision: usize = 0x600; // bool
        pub const m_vSupport: usize = 0x604; // Vector
        pub const m_clrRender: usize = 0x610; // Color
        pub const m_vecRenderAttributes: usize = 0x618; // C_UtlVectorEmbeddedNetworkVar<EntityRenderAttribute_t>
        pub const m_bRenderToCubemaps: usize = 0x698; // bool
        pub const m_bNoInterpolate: usize = 0x699; // bool
        pub const m_Collision: usize = 0x6A0; // CCollisionProperty
        pub const m_Glow: usize = 0x750; // CGlowProperty
        pub const m_flGlowBackfaceMult: usize = 0x7A8; // float32
        pub const m_fadeMinDist: usize = 0x7AC; // float32
        pub const m_fadeMaxDist: usize = 0x7B0; // float32
        pub const m_flFadeScale: usize = 0x7B4; // float32
        pub const m_flShadowStrength: usize = 0x7B8; // float32
        pub const m_nObjectCulling: usize = 0x7BC; // uint8
        pub const m_nAddDecal: usize = 0x7C0; // int32
        pub const m_vDecalPosition: usize = 0x7C4; // Vector
        pub const m_vDecalForwardAxis: usize = 0x7D0; // Vector
        pub const m_flDecalHealBloodRate: usize = 0x7DC; // float32
        pub const m_flDecalHealHeightRate: usize = 0x7E0; // float32
        pub const m_ConfigEntitiesToPropagateMaterialDecalsTo: usize = 0x7E8; // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
        pub const m_vecViewOffset: usize = 0x800; // CNetworkViewOffsetVector
        pub const m_pClientAlphaProperty: usize = 0x830; // CClientAlphaProperty*
        pub const m_ClientOverrideTint: usize = 0x838; // Color
        pub const m_bUseClientOverrideTint: usize = 0x83C; // bool
    }
    // Parent: C_BaseEntity
    // Field count: 1
    pub mod C_MiniMapMarker {
        pub const m_eType: usize = 0x568; // EMiniMapMarkerType_t
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CCitadel_Ability_BulletFlurryVData {
        pub const m_ChannelParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_BulletFlurryModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod C_PointClientUIHUD {
        pub const m_bCheckCSSClasses: usize = 0x898; // bool
        pub const m_bIgnoreInput: usize = 0xA18; // bool
        pub const m_flWidth: usize = 0xA1C; // float32
        pub const m_flHeight: usize = 0xA20; // float32
        pub const m_flDPI: usize = 0xA24; // float32
        pub const m_flInteractDistance: usize = 0xA28; // float32
        pub const m_flDepthOffset: usize = 0xA2C; // float32
        pub const m_unOwnerContext: usize = 0xA30; // uint32
        pub const m_unHorizontalAlign: usize = 0xA34; // uint32
        pub const m_unVerticalAlign: usize = 0xA38; // uint32
        pub const m_unOrientation: usize = 0xA3C; // uint32
        pub const m_bAllowInteractionFromAllSceneWorlds: usize = 0xA40; // bool
        pub const m_vecCSSClasses: usize = 0xA48; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
    }
    // Parent: CCitadelModifierVData
    // Field count: 0
    ...
    pub mod CCitadel_Item_TechDamagePulseVData {
        pub const m_PulseParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TargetParticle: usize = 0x1688; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strPulseTickSound: usize = 0x1768; // CSoundEventName
        pub const m_iMaxTargets: usize = 0x1778; // int32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod C_SpotlightEnd {
        pub const m_flLightScale: usize = 0x860; // float32
    ...
    pub mod CCitadel_Ability_BulletFlurry {
        pub const m_flFlurryEndTime: usize = 0xCA0; // CCitadelAutoScaledTime
        ...
        pub const m_flNextAttackTime: usize = 0xDF8; // GameTime_t
        pub const m_nSatVolumeIndex: usize = 0xDFC; // SatVolumeIndex_t
    }
    // Parent: C_AI_CitadelNPC
    // Field count: 6
    pub mod C_NPC_Boss_Tier2 {
        pub const m_iLane: usize = 0x1470; // int32
        pub const m_flFadeOutStart: usize = 0x1474; // GameTime_t
        pub const m_flFadeOutEnd: usize = 0x1478; // GameTime_t
        pub const m_hTargetedEnemy: usize = 0x147C; // CHandle<C_BaseEntity>
        pub const m_vecElectricBeamLookTarget: usize = 0x1480; // Vector
    ...
    pub mod CCitadel_Item_ColdFrontVData {
        pub const m_AOEModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbilityCrowdControlVData {
        pub const m_CastParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SlowModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DebuffModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CitadelAbilityVData
    // Field count: 19
    pub mod CCitadel_Ability_ProximityRitual_VData {
        pub const m_PredatoryStatueModel: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
        pub const m_CatReappearParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CatDisappearParticle: usize = 0x1720; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CatEyesParticle: usize = 0x1800; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CatSummonParticle: usize = 0x18E0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CatRecallParticle: usize = 0x19C0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_RecallLineParticle: usize = 0x1AA0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strRecallSound: usize = 0x1B80; // CSoundEventName
        pub const m_strKilledSound: usize = 0x1B90; // CSoundEventName
        pub const m_PredatoryStatueModifier: usize = 0x1BA0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_RecentDamageModifier: usize = 0x1BB0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flHeavyMeleeDmg: usize = 0x1BC0; // float32
        pub const m_flLightMeleeDmg: usize = 0x1BC4; // float32
        pub const m_flAbilityDamageScale: usize = 0x1BC8; // float32
        pub const m_flNPCDamageScale: usize = 0x1BCC; // float32
        pub const m_flCastDelayMin: usize = 0x1BD0; // float32
        pub const m_flCastDelayMax: usize = 0x1BD4; // float32
        pub const m_flCastDelayMaxDist: usize = 0x1BD8; // float32
        pub const m_flPostCastCooldown: usize = 0x1BDC; // float32
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 2
    pub mod CCitadel_Ability_PowerJump {
        pub const m_nTargetingParticleIndex: usize = 0xCA4; // ParticleIndex_t
        pub const m_bAirRaiding: usize = 0xCA8; // bool
    }
    // Parent: CCitadelModifierVData
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Climb_Rope {
        pub const m_vTop: usize = 0xCA0; // CNetworkOriginQuantizedVector
        pub const m_vBottom: usize = 0xCD0; // CNetworkOriginQuantizedVector
        pub const m_flActivatePressTime: usize = 0xD00; // GameTime_t
        pub const m_flDisconnectTime: usize = 0xD04; // GameTime_t
        pub const m_flClimbStartTime: usize = 0xD08; // GameTime_t
        pub const m_vLastPos: usize = 0xD0C; // Vector
        pub const m_bRequestStopClimbing: usize = 0xD20; // bool
        pub const m_bRequestJumpToRoof: usize = 0xD21; // bool
        pub const m_flLastMoveTime: usize = 0xD24; // GameTime_t
        pub const m_flMoveDownStartTime: usize = 0xD28; // GameTime_t
        pub const m_eClimbState: usize = 0xD2C; // EClimbRopeState_t
        pub const m_ClimbCount: usize = 0xD34; // int32
    }
    // Parent: C_Team
    // Field count: 6
    pub mod C_CitadelTeam {
        pub const m_hPayload: usize = 0x620; // CHandle<C_BaseEntity>
        pub const m_nBossesAlive: usize = 0x624; // int32
        pub const m_nBossesMax: usize = 0x628; // int32
        pub const m_nFlexSlotsUnlocked: usize = 0x62C; // EFlexSlotTypes_t
        pub const m_nBaseGuardianLanesCleared: usize = 0x630; // int32
        pub const m_vecFOWEntities: usize = 0x638; // C_UtlVectorEmbeddedNetworkVar<STeamFOWEntity>
    }
    // Parent: C_BaseEntity
    // Field count: 1
    pub mod C_EnvWind {
    ...
    pub mod CCitadel_Ability_Mirage_Teleport {
        pub const m_hDummyForCamera: usize = 0xCA8; // CHandle<C_BaseEntity>
        pub const m_vCastStartPosition: usize = 0xCAC; // Vector
        pub const m_vTargetPosition: usize = 0xCB8; // Vector
        pub const m_vTargetAngles: usize = 0xCC4; // QAngle
    }
    // Parent: CCitadelModifier
    // Field count: 5
    ...
    pub mod CAbilityHoldMelee_VData {
        pub const m_mapAttacks: usize = 0x1580; // CUtlOrderedMap<EMeleeHold_AttackType,AttackData_t>
        pub const m_flNextAttackOnParry: usize = 0x15A8; // float32
        pub const m_flParryWindow: usize = 0x15AC; // float32
        pub const m_flParryStunTime: usize = 0x15B0; // float32
        pub const m_flParryCooldown: usize = 0x15B4; // float32
        pub const m_AirMeleeUpScale: usize = 0x15B8; // CRemapFloat
        pub const m_HoldBeginEffect: usize = 0x15C8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SuccessfulParryParticle: usize = 0x16A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ParryActivateParticle: usize = 0x1788; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_cameraSequenceHoldStart: usize = 0x1868; // CitadelCameraOperationsSequence_t
        pub const m_cameraSequenceHitImpact: usize = 0x18F0; // CitadelCameraOperationsSequence_t
        pub const m_strHoldBegin: usize = 0x1978; // CSoundEventName
        pub const m_strSuccessfulParrySound: usize = 0x1988; // CSoundEventName
        pub const m_ParryVictimModifier: usize = 0x1998; // CEmbeddedSubclass<CCitadelModifier>
    }
    ...
    pub mod CAI_NPC_TrooperVData {
        pub const m_TrooperType: usize = 0x10D8; // TrooperType_t
        pub const m_flTrooperDamageResistPct: usize = 0x10DC; // float32
        pub const m_flT1BossDamageResistPct: usize = 0x10E0; // float32
        pub const m_flT2BossDamageResistPct: usize = 0x10E4; // float32
        pub const m_flBarrackGuardianDamageResistPct: usize = 0x10E8; // float32
        pub const m_flNearDeathDuration: usize = 0x10EC; // float32
        pub const m_flFlySpeed: usize = 0x10F0; // float32
        pub const m_flFlyHeight: usize = 0x10F4; // float32
        pub const m_flMeleeDamage: usize = 0x10F8; // float32
        pub const m_flMeleeDuration: usize = 0x10FC; // float32
        pub const m_flMeleeChargeRange: usize = 0x1100; // float32
        pub const m_flAttackT1BossMaxRange: usize = 0x1104; // float32
        pub const m_flAttackTrooperMaxRange: usize = 0x1108; // float32
        pub const m_flShieldDamageResistPct: usize = 0x110C; // float32
        pub const m_flHealthBarOffsetDucking: usize = 0x1110; // float32
        pub const m_flTrooperDPS: usize = 0x1114; // float32
        pub const m_flPlayerDPS: usize = 0x1118; // float32
        pub const m_flT1BossDPS: usize = 0x111C; // float32
        pub const m_flT1BossDPSBaseResist: usize = 0x1120; // float32
        pub const m_flT1BossDPSMaxResist: usize = 0x1124; // float32
        pub const m_flT1BossDPSMaxResistTimeInSeconds: usize = 0x1128; // float32
        pub const m_flT2BossDPS: usize = 0x112C; // float32
        pub const m_flT2BossDPSBaseResist: usize = 0x1130; // float32
        pub const m_flT2BossDPSMaxResist: usize = 0x1134; // float32
        pub const m_flT2BossDPSMaxResistTimeInSeconds: usize = 0x1138; // float32
        pub const m_flT3BossDPS: usize = 0x113C; // float32
        pub const m_flBarrackBossDPS: usize = 0x1140; // float32
        pub const m_flGeneratorBossDPS: usize = 0x1144; // float32
        pub const m_BossAttackParticle: usize = 0x1148; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_LastHitParticle: usize = 0x1228; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TargetingLaserParticle: usize = 0x1308; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TargetingEyeFlashParticle: usize = 0x13E8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_sZiplineContainerBreakFromDamageParticle: usize = 0x14C8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_sZiplineContainerBreakFromLandingParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_MedicHealActiveParticle: usize = 0x1688; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_sPlayerLastHitSound: usize = 0x1768; // CSoundEventName
        pub const m_sCelebrationSound: usize = 0x1778; // CSoundEventName
        pub const m_sZiplineContainerBreakSound: usize = 0x1788; // CSoundEventName
        pub const m_NearDeathModifier: usize = 0x1798; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_TrooperBossInvulnModifier: usize = 0x17A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    ...
    pub mod CAbility_Fathom_ReefdwellerHarpoon_VData {
        pub const m_DetachBuff: usize = 0x1560; // CEmbeddedSubclass<CCitadel_Modifier_ReefdwellerHarpoon_DetachBuff>
        pub const m_strSwapStarted: usize = 0x1570; // CSoundEventName
        pub const m_cameraSequenceFlying: usize = 0x1580; // CitadelCameraOperationsSequence_t
        pub const m_flAirSpeedMax: usize = 0x1608; // float32
        pub const m_flFallSpeedMax: usize = 0x160C; // float32
        pub const m_flAirDrag: usize = 0x1610; // float32
        pub const m_flInitialSlowSpeed: usize = 0x1614; // float32
        pub const m_flInitialSpeedBias: usize = 0x1618; // float32
        pub const m_flMaxSurfacePitch: usize = 0x161C; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Gunslinger_SalvoVData {
        pub const m_BulletWarningParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ProcWatcherModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_VictimWarningModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CItemRefresherVData {
        pub const m_RefreshParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod C_BaseCombatCharacter {
        pub const m_hMyWearables: usize = 0xC98; // C_NetworkUtlVectorBase<CHandle<C_EconWearable>>
        pub const m_leftFootAttachment: usize = 0xCB0; // AttachmentHandle_t
        pub const m_rightFootAttachment: usize = 0xCB1; // AttachmentHandle_t
        pub const m_nWaterWakeMode: usize = 0xCB4; // C_BaseCombatCharacter::WaterWakeMode_t
        pub const m_flWaterWorldZ: usize = 0xCB8; // float32
        pub const m_flWaterNextTraceTime: usize = 0xCBC; // float32
    }
    ...
    pub mod CCitadel_Upgrade_StabilizingTripodVData {
        pub const m_SelfDebuffModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    ...
    pub mod CCitadel_Ability_Tokamak_DyingStarVData {
        pub const m_ExplosionParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_FlameAuraParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strInFlightAnimGraphParam: usize = 0x1720; // CGlobalSymbol
        pub const m_strExplodeSound: usize = 0x1728; // CSoundEventName
        pub const m_InFlightModifier: usize = 0x1738; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Ability_PrimaryWeaponVData
    // Field count: 7
    pub mod CCitadel_Ability_PrimaryWeapon_BebopVData {
        pub const m_strWindupSound: usize = 0x15A8; // CSoundEventName
        pub const m_strBeamStartSound: usize = 0x15B8; // CSoundEventName
        pub const m_strBeamLoopSound1: usize = 0x15C8; // CSoundEventName
        pub const m_strBeamLoopSound2: usize = 0x15D8; // CSoundEventName
        pub const m_strBeamStopSound: usize = 0x15E8; // CSoundEventName
        pub const m_szWeaponBeamParticle: usize = 0x15F8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flWindupRepeatCycle: usize = 0x16D8; // float32
    }
    // Parent: CCitadelModifierVData
    // Field count: 5
    ...
    pub mod CCitadel_Item_Stasis_BombVData {
        pub const m_AuraModifier: usize = 0x16A8; // CEmbeddedSubclass<CBaseModifier>
    }
    ...
    pub mod C_FuncMonitor {
        pub const m_targetCamera: usize = 0x860; // CUtlString
        pub const m_nResolutionEnum: usize = 0x868; // int32
        pub const m_bRenderShadows: usize = 0x86C; // bool
        pub const m_bUseUniqueColorTarget: usize = 0x86D; // bool
        pub const m_brushModelName: usize = 0x870; // CUtlString
        pub const m_hTargetCamera: usize = 0x878; // CHandle<C_BaseEntity>
        pub const m_bEnabled: usize = 0x87C; // bool
        pub const m_bDraw3DSkybox: usize = 0x87D; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Chrono_PulseGrenade_VData {
        pub const m_PulseAreaModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strHitSound: usize = 0x1570; // CSoundEventName
        pub const m_strDebuffStatName: usize = 0x1580; // CUtlString
    }
    // Parent: CCitadelBaseAbilityServerOnly
    // Field count: 0
    ...
    pub mod CCitadelAbilityTangoTetherVData {
        pub const m_TetherModifier: usize = 0x1560; // CEmbeddedSubclass<CBaseModifier>
        pub const m_GrappleTargetModifier: usize = 0x1570; // CEmbeddedSubclass<CBaseModifier>
        pub const m_BulletGrappleTracerParticle: usize = 0x1580; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_EnemyGrappleParticle: usize = 0x1660; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strDamageTarget: usize = 0x1740; // CSoundEventName
        pub const m_strGrappleHitTarget: usize = 0x1750; // CSoundEventName
        pub const m_strGrappleHitWorld: usize = 0x1760; // CSoundEventName
        pub const m_strGrappleHitNothing: usize = 0x1770; // CSoundEventName
    }
    // Parent: CitadelItemVData
    // Field count: 1
    pub mod CCitadel_WeaponUpgrade_BansheeSlugs_VData {
        pub const m_DebuffModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_BaseEventProcVData
    // Field count: 1
    ...
    pub mod CItem_Infuser_VData {
        ...
        pub const m_CastParticle: usize = 0x15B8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    ...
    // Field count: 8
    pub mod C_LightGlow {
        pub const m_nHorizontalSize: usize = 0x860; // uint32
        pub const m_nVerticalSize: usize = 0x864; // uint32
        pub const m_nMinDist: usize = 0x868; // uint32
        pub const m_nMaxDist: usize = 0x86C; // uint32
        pub const m_nOuterMaxDist: usize = 0x870; // uint32
        pub const m_flGlowProxySize: usize = 0x874; // float32
        pub const m_flHDRColorScale: usize = 0x878; // float32
        pub const m_GlowOverlay: usize = 0x880; // C_LightGlowOverlay
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CAbilityCrackshotVData {
        pub const m_ExplosionParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ExplosionVictimParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DebuffModifier: usize = 0x1720; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_CrackshotImmuneModifier: usize = 0x1730; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_HeadShotVictimSound: usize = 0x1740; // CSoundEventName
        pub const m_HeadShotConfirmationSound: usize = 0x1750; // CSoundEventName
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CItemPhantomStrike_VData {
        pub const m_DebuffModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_PullDownModifier: usize = 0x15B8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_CasterModifier: usize = 0x15C8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strExplodeSound: usize = 0x15D8; // CSoundEventName
        ...
        pub const m_BuffParticle: usize = 0x17A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flTeleportDistance: usize = 0x1888; // float32
        pub const m_flVelocityScale: usize = 0x188C; // float32
    }
    // Parent: CitadelAbilityVData
    // Field count: 1
    pub mod CAbilityMantleVData {
        pub const m_vecMantleTypes: usize = 0x1560; // CUtlVector<MantleType_t>
    }
    ...
    pub mod CCitadel_Ability_Thumper_1 {
        pub const m_vecAimPos: usize = 0xCA0; // Vector
        pub const m_vecAimNormal: usize = 0xCAC; // Vector
        pub const m_flPushForce: usize = 0xCB8; // float32
    }
    ...
    pub mod CCitadel_Ability_PuddleVData {
        pub const m_PuddleModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
    }
    ...
    pub mod CCitadel_Item_DPS_Aura_VData {
        pub const m_AOECastParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ActiveModifier: usize = 0x1688; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod C_ClientRagdoll {
        pub const m_bFadeOut: usize = 0xB00; // bool
        pub const m_bImportant: usize = 0xB01; // bool
        pub const m_flEffectTime: usize = 0xB04; // GameTime_t
        pub const m_gibDespawnTime: usize = 0xB08; // GameTime_t
        pub const m_iCurrentFriction: usize = 0xB0C; // int32
        pub const m_iMinFriction: usize = 0xB10; // int32
        pub const m_iMaxFriction: usize = 0xB14; // int32
        pub const m_iFrictionAnimState: usize = 0xB18; // int32
        pub const m_bReleaseRagdoll: usize = 0xB1C; // bool
        pub const m_iEyeAttachment: usize = 0xB1D; // AttachmentHandle_t
        pub const m_bFadingOut: usize = 0xB1E; // bool
        pub const m_flScaleEnd: usize = 0xB20; // float32[10]
        pub const m_flScaleTimeStart: usize = 0xB48; // GameTime_t[10]
        pub const m_flScaleTimeEnd: usize = 0xB70; // GameTime_t[10]
    }
    ...
    pub mod CCitadel_Ability_IceDome {
        pub const m_flDomeStartTime: usize = 0xCD8; // GameTime_t
        pub const m_flDomeEndTime: usize = 0xCDC; // GameTime_t
    }
    // Parent: CCitadel_Modifier_BaseEventProc
    // Field count: 0
    ...
    pub mod CAbilityKobunVData {
        pub const m_vSummonFollowOffset: usize = 0x1560; // Vector
        pub const m_CloneModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CitadelAbilityVData
    // Field count: 3
    pub mod CCitadel_Ability_Tengu_UrnVData {
        ...
        pub const m_AuraModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ExplodeSound: usize = 0x1650; // CSoundEventName
    }
    // Parent: CitadelAbilityVData
    // Field count: 2
    pub mod CCitadel_Ability_ThrowSandVData {
        pub const m_SandDebuff: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SilenceDebuff: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CitadelItemVData
    // Field count: 2
    pub mod CCitadel_Item_RescueBeamVData {
        pub const m_DispelAndHealModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_PullModifier: usize = 0x15B8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelAnimatingModelEntity
    // Field count: 2
    pub mod C_CitadelPayload {
        pub const m_flProgress: usize = 0xB08; // float32
        pub const m_nNumPushers: usize = 0xB0C; // int32
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 2
    pub mod CCitadel_Ability_Fathom_Breach {
        pub const m_nRollFXIndex: usize = 0xCA0; // ParticleIndex_t
        pub const m_bInFlight: usize = 0xCA4; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CItem_FleetfootBoots_VData {
        pub const m_FleetfootBootsModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_FleetfootBootsBonusClipModifier: usize = 0x15B8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Item_TrackingProjectileApplyModifier
    // Field count: 0
    ...
    pub mod CCitadel_Item_ModDisruptorVData {
        pub const m_DetonateParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DisruptModifier: usize = 0x1688; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flWaveSpeed: usize = 0x1698; // float32
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod CCitadel_Ability_ProximityRitual {
        pub const m_eState: usize = 0xCA0; // ECatStatueState_t
        pub const m_hStatue: usize = 0xCA4; // CHandle<C_BaseEntity>
    ...
    pub mod CCitadel_Ability_Bounce_Pad {
        pub const m_vForward: usize = 0xCA0; // Vector
        pub const m_bShouldDeploy: usize = 0xCAC; // bool
        pub const m_bAnglesSet: usize = 0xCAD; // bool
        pub const m_bCanCancel: usize = 0xCAE; // bool
        pub const m_angFacing: usize = 0xDC8; // QAngle
    }
    // Parent: CitadelItemVData
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Tier2Boss_RocketBarrageVData {
        ...
        pub const m_RocketFireSound: usize = 0x1650; // CSoundEventName
        pub const m_AuraModifier: usize = 0x1660; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: C_AI_CitadelNPC
    // Field count: 0
    ...
    pub mod CAbility_Mirage_SandPhantom {
        pub const m_vecVictimModifiers: usize = 0xCA0; // CUtlVector<CModifierHandleTyped<CCitadelModifier>>
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CAbilityLashVData {
        pub const m_LashParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_BuffModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strVictimCastSound: usize = 0x1650; // CSoundEventName
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod C_Citadel_Projectile_Viscous_GooGrenade {
        pub const m_nBounces: usize = 0x8E8; // int32
        pub const m_tNextDetonateTime: usize = 0x8EC; // GameTime_t
        pub const m_vecProjectileHitTargets: usize = 0x8F0; // CUtlVector<CHandle<C_BaseEntity>>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_RestorativeGoo {
        pub const m_flSelfCastEndTime: usize = 0xCA0; // GameTime_t
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod C_RagdollPropAttached {
        pub const m_boneIndexAttached: usize = 0xB78; // uint32
        pub const m_ragdollAttachedObjectIndex: usize = 0xB7C; // uint32
        pub const m_attachmentPointBoneSpace: usize = 0xB80; // Vector
        pub const m_attachmentPointRagdollSpace: usize = 0xB8C; // Vector
        pub const m_vecOffset: usize = 0xB98; // Vector
        pub const m_parentTime: usize = 0xBA4; // float32
        pub const m_bHasParent: usize = 0xBA8; // bool
    }
    // Parent: C_BaseToggle
    // Field count: 11
    pub mod C_BaseTrigger {
        pub const m_OnStartTouch: usize = 0x860; // CEntityIOOutput
        pub const m_OnStartTouchAll: usize = 0x888; // CEntityIOOutput
        pub const m_OnEndTouch: usize = 0x8B0; // CEntityIOOutput
        pub const m_OnEndTouchAll: usize = 0x8D8; // CEntityIOOutput
        pub const m_OnTouching: usize = 0x900; // CEntityIOOutput
        pub const m_OnTouchingEachEntity: usize = 0x928; // CEntityIOOutput
        pub const m_OnNotTouching: usize = 0x950; // CEntityIOOutput
        pub const m_hTouchingEntities: usize = 0x978; // CUtlVector<CHandle<C_BaseEntity>>
        pub const m_iFilterName: usize = 0x990; // CUtlSymbolLarge
        pub const m_hFilter: usize = 0x998; // CHandle<CBaseFilter>
        pub const m_bDisabled: usize = 0x99C; // bool
    }
    // Parent: CitadelAbilityVData
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Chrono_KineticCarbine {
        pub const m_bWantsSlow: usize = 0xCA0; // bool
        pub const m_flLatchedTimeScaleFracChangeTime: usize = 0xCA4; // GameTime_t
        pub const m_flLatchedTimeScaleFrac: usize = 0xCA8; // float32
        pub const m_flSpeedBoostEndTime: usize = 0xCAC; // GameTime_t
        pub const m_flShotTimeScaleEndTime: usize = 0xCB0; // GameTime_t
        pub const m_flStoredPowerPct: usize = 0xCB8; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_ArmorUpgrade_AblativeCoat {
        pub const m_iCurrentResistValue: usize = 0xCB8; // int32
    }
    // Parent: CCitadelModifierVData
    // Field count: 0
    ...
    pub mod CAbility_Mirage_SandPhantom_VData {
        pub const m_WhirlwindEvasionModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SandPhantomModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Gunslinger_Salvo {
        pub const m_CastTarget: usize = 0xCA4; // CHandle<C_BaseEntity>
        pub const m_iCurrentShots: usize = 0xCA8; // int32
        pub const m_iTotalShots: usize = 0xCAC; // int32
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Bebop_LaserBeam {
        pub const m_bZoomed: usize = 0xDF0; // bool
        pub const m_bAirCast: usize = 0xDF1; // bool
        pub const m_vBeamAimPos: usize = 0xDF4; // Vector
        pub const m_angBeamAngles: usize = 0xE00; // QAngle
        pub const m_bNeedsBeamReset: usize = 0xE18; // bool
    }
    ...
    pub mod CCitadel_WeaponUpgrade_BurstFireVData {
        pub const m_ActivationSound: usize = 0x15A8; // CSoundEventName
        pub const m_BuffModifier: usize = 0x15B8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod CCitadel_Ability_ZipLine_VData {
        pub const m_flZiplineAirDrag: usize = 0x1560; // float32
        pub const m_flMinButtonHoldTimeToActivate: usize = 0x1564; // float32
        pub const m_flCrouchDropSpeedFraction: usize = 0x1568; // float32
        pub const m_flCrouchDropAirDragSuppressDuration: usize = 0x156C; // float32
        pub const m_flDetachDisallowedTime: usize = 0x1570; // float32
        pub const m_flCameraWobbleIntensity: usize = 0x1574; // float32
        pub const m_DOFWhileZiplining: usize = 0x1578; // DOFDesc_t
        pub const m_ZipLinePreviewParticle: usize = 0x1588; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ZipLineSpeedParticle: usize = 0x1668; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ZipLineTetherParticle: usize = 0x1748; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ZipLineTetherAttachParticle: usize = 0x1828; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ZipLineTetherStartParticle: usize = 0x1908; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ZipLineEnemyKnockdownProtectionParticle: usize = 0x19E8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ZipLineSelfKnockdownProtectionParticle: usize = 0x1AC8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ZipLineKnockdownProtectionStatusParticle: usize = 0x1BA8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strZipLineSummonSound: usize = 0x1C88; // CSoundEventName
        pub const m_strZipLineLatchedSound: usize = 0x1C98; // CSoundEventName
        pub const m_strZipLineStartSound: usize = 0x1CA8; // CSoundEventName
        pub const m_RidingZipLineModifier: usize = 0x1CB8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_KnockedOffSlowModifier: usize = 0x1CC8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ZipLineIntroModifier: usize = 0x1CD8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ZipLineKnockdownImmuneModifier: usize = 0x1CE8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ZipLineSlowModifier: usize = 0x1CF8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_cameraSequenceAwaitingTether: usize = 0x1D08; // CitadelCameraOperationsSequence_t
        pub const m_cameraSequenceLatched: usize = 0x1D90; // CitadelCameraOperationsSequence_t
        pub const m_cameraSequenceAttached: usize = 0x1E18; // CitadelCameraOperationsSequence_t
        pub const m_cameraSequenceClear: usize = 0x1EA0; // CitadelCameraOperationsSequence_t
    }
    // Parent: CitadelItemVData
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Trapper_SpiderJar {
        ...
        pub const m_bHasMadeSpiders: usize = 0xCB8; // bool
    }
    // Parent: CitadelAbilityVData
    // Field count: 2
    pub mod CCitadel_Ability_ViperVenomVData {
        pub const m_VenomModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_CastVenomParticle: usize = 0x1570; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadel_Item_PowerShard {
        pub const m_hLastSignatureToActivate: usize = 0xCB8; // CHandle<C_CitadelBaseAbility>
    }
    // Parent: CCitadel_Modifier_ScalingPowerUp
    // Field count: 0
    ...
    pub mod C_BaseButton {
        pub const m_glowEntity: usize = 0x860; // CHandle<C_BaseModelEntity>
        pub const m_usable: usize = 0x864; // bool
        pub const m_szDisplayText: usize = 0x868; // CUtlSymbolLarge
    }
    ...
    pub mod CCitadel_Ability_Tokamak_CrimsonCannon {
        pub const m_bAirCast: usize = 0xCA0; // bool
        pub const m_bIsZoomed: usize = 0xE68; // bool
    }
    // Parent: CCitadelModifierAura
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Mirage_FireBeetles {
        pub const m_vLaunchPosition: usize = 0xCA0; // Vector
        pub const m_qLaunchAngle: usize = 0xCAC; // QAngle
        pub const m_flCastStartTime: usize = 0xCB8; // GameTime_t
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod C_NPC_ShieldedSentry {
        pub const m_CCitadelAbilityComponent: usize = 0xB08; // CCitadelAbilityComponent
        pub const m_flAttackRange: usize = 0xCAC; // float32
        pub const m_flAimPitch: usize = 0xCB0; // float32
    }
    ...
    pub mod C_PointClientUIWorldPanel {
        pub const m_bForceRecreateNextUpdate: usize = 0x898; // bool
        pub const m_bMoveViewToPlayerNextThink: usize = 0x899; // bool
        pub const m_bCheckCSSClasses: usize = 0x89A; // bool
    ...
    pub mod CAbility_Synth_PlasmaFlux_VData {
        pub const m_WeaponDamageBonusModifier: usize = 0x1560; // CEmbeddedSubclass<CBaseModifier>
        pub const m_TeleportTrailParticle: usize = 0x1570; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ImpactParticle: usize = 0x1650; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strCasterLoopingSound: usize = 0x1730; // CSoundEventName
        pub const m_strProjectileExpireSound: usize = 0x1740; // CSoundEventName
        pub const m_strImpactSound: usize = 0x1750; // CSoundEventName
        pub const m_strTimerSound: usize = 0x1760; // CSoundEventName
        pub const m_cameraSequenceTeleport: usize = 0x1770; // CitadelCameraOperationsSequence_t
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 10
    pub mod CCitadel_Ability_GooBowlingBall {
        pub const m_nAirJumpsLeft: usize = 0xFE8; // int32
        pub const m_bIsRolling: usize = 0xFEC; // bool
        pub const m_hBall: usize = 0xFF0; // CHandle<C_CitadelViscousBall>
        pub const m_eRollingState: usize = 0xFF4; // EViscousBowlingBallState_t
        pub const m_flNextStateTime: usize = 0xFF8; // GameTime_t
        pub const m_flNextWallCheck: usize = 0xFFC; // GameTime_t
        pub const m_flRollStartTime: usize = 0x1000; // GameTime_t
        pub const m_flWallExitTime: usize = 0x1004; // GameTime_t
        pub const m_vecWallExitVelocity: usize = 0x1008; // Vector
        pub const m_nDirectionParticleIndex: usize = 0x101C; // ParticleIndex_t
    }
    // Parent: CCitadelModifierVData
    // Field count: 7
    ...
    pub mod C_NPC_FieldSentry {
        pub const m_flAttackRange: usize = 0xB0C; // float32
        pub const m_flAimPitch: usize = 0xB10; // float32
    }
    // Parent: CCitadelAnimatingModelEntity
    // Field count: 0
    ...
    pub mod CCitadel_Ability_ChargedTackle {
        pub const m_bPreparing: usize = 0xE98; // bool
        pub const m_bTackling: usize = 0xE99; // bool
        pub const m_flTackleStartTime: usize = 0xE9C; // GameTime_t
        pub const m_flPrepareStartTime: usize = 0xEA0; // GameTime_t
        pub const m_vecTackleDir: usize = 0xEA4; // Vector
        pub const m_vecLastPosition: usize = 0xEB0; // Vector
        pub const m_nStuckFramesCount: usize = 0xEBC; // int32
        pub const m_vecHitEnemies: usize = 0xEC0; // CUtlVector<CHandle<C_BaseEntity>>
        pub const m_nDistancePreview: usize = 0xED8; // ParticleIndex_t
    }
    // Parent: CitadelAbilityVData
    // Field count: 5
    pub mod CCitadelAbilityChargedBombVData {
        pub const m_ChargeBombModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ExplodeParticle: usize = 0x1570; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strExplodeSound: usize = 0x1650; // CSoundEventName
        pub const m_flChargeForMaxDamage: usize = 0x1660; // float32
        pub const m_flMinDamagePercent: usize = 0x1664; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CNPC_Boss_Tier2VData {
        pub const m_flPlayerInitialSightRange: usize = 0x10D8; // float32
        pub const m_strWIPModelName: usize = 0x10E0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
        pub const m_vecWeakPoints: usize = 0x11C0; // CUtlVector<WeakPointParams_t>
        pub const m_BeamChargingEffect: usize = 0x11D8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_BeamPreviewEffect: usize = 0x12B8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_BeamActiveEffect: usize = 0x1398; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_StompImpactEffect: usize = 0x1478; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_StompWarningEffect: usize = 0x1558; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flTossSpeed: usize = 0x1638; // float32
        pub const m_flStompDamage: usize = 0x163C; // float32
        pub const m_flStompDamageMaxHealthPercent: usize = 0x1640; // float32
        pub const m_flStompTossUpMagnitude: usize = 0x1644; // float32
        pub const m_flStunDuration: usize = 0x1648; // float32
        pub const m_flStompImpactRadius: usize = 0x164C; // float32
        pub const m_flStompImpactHeight: usize = 0x1650; // float32
        pub const m_flSweepRadius: usize = 0x1654; // float32
        pub const m_flSweepSpeed: usize = 0x1658; // float32
        pub const m_flSweepZScale: usize = 0x165C; // float32
        pub const m_flSweepMaxAngle: usize = 0x1660; // float32
        pub const m_flSweepMaxRange: usize = 0x1664; // float32
        pub const m_flSweepAdjustSpeed: usize = 0x1668; // float32
        pub const m_flBurstDuration: usize = 0x166C; // float32
        pub const m_flBurstCooldown: usize = 0x1670; // float32
        pub const m_BackdoorProtectionModifier: usize = 0x1678; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flBackDoorProtectionRange: usize = 0x1688; // float32
        pub const m_InvulModifier: usize = 0x1690; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flInvulModifierRange: usize = 0x16A0; // float32
        pub const m_FriendlyAuraModifier: usize = 0x16A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flRangeArmorMaxResist: usize = 0x16B8; // float32
        pub const m_flRangeArmorMinResist: usize = 0x16BC; // float32
        pub const m_flRangeArmorMaxDist: usize = 0x16C0; // float32
        pub const m_flRangeArmorMinDist: usize = 0x16C4; // float32
        pub const m_NearbyEnemyResist: usize = 0x16C8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: C_SoundAreaEntityBase
    // Field count: 2
    ...
    pub mod CCitadel_Ability_PrimaryWeapon_Bebop {
        pub const m_flStartWindUpTime: usize = 0x1030; // GameTime_t
        pub const m_flStartFiringTime: usize = 0x1034; // GameTime_t
        pub const m_bFiring: usize = 0x1038; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod C_TextureBasedAnimatable {
        pub const m_bLoop: usize = 0x860; // bool
        pub const m_flFPS: usize = 0x864; // float32
        pub const m_hPositionKeys: usize = 0x868; // CStrongHandle<InfoForResourceTypeCTextureBase>
        pub const m_hRotationKeys: usize = 0x870; // CStrongHandle<InfoForResourceTypeCTextureBase>
        pub const m_vAnimationBoundsMin: usize = 0x878; // Vector
        pub const m_vAnimationBoundsMax: usize = 0x884; // Vector
        pub const m_flStartTime: usize = 0x890; // float32
        pub const m_flStartFrame: usize = 0x894; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CNPC_TrooperNeutralNodeMoverVData {
        pub const m_bEnableMovementToNodes: usize = 0x1440; // bool
        pub const m_flExposedDuration: usize = 0x1444; // CRangeFloat
        pub const m_flHideDuration: usize = 0x144C; // CRangeFloat
        pub const m_HidingModifier: usize = 0x1458; // CEmbeddedSubclass<CCitadelModifier>
    }
    ...
    pub mod CAbilityThumper3VData {
        pub const m_DroneModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifierVData
    // Field count: 3
    ...
    pub mod CCitadel_Item_TechCleaveVData {
        pub const m_TechCleaveModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_sCleaveProcSound: usize = 0x15B8; // CSoundEventName
    }
    // Parent: CCitadelModifier
    // Field count: 2
    ...
    pub mod CCitadel_ArmorUpgrade_PersonalRejuvenatorVData {
        pub const m_DeployParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_RespawnParticle: usize = 0x1688; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_sDeploySound: usize = 0x1768; // CSoundEventName
        pub const m_sRespawnSound: usize = 0x1778; // CSoundEventName
    }
    // Parent: CCitadelModifier
    // Field count: 18
    ...
    pub mod CCitadel_Ability_Bebop_LaserBeamVData {
        pub const m_LaserModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ChargeParticle: usize = 0x1570; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flCancelCooldown: usize = 0x1650; // float32
    }
    // Parent: CCitadel_Modifier_Invis
    // Field count: 1
    ...
    pub mod CCitadel_ArmorUpgrade_VexBarrierVData {
        pub const m_ShieldModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CFilterMultiple {
        pub const m_nFilterType: usize = 0x5C0; // filter_t
        pub const m_iFilterName: usize = 0x5C8; // CUtlSymbolLarge[10]
        pub const m_hFilter: usize = 0x618; // CHandle<C_BaseEntity>[10]
        pub const m_nFilterCount: usize = 0x640; // int32
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Magician_BigBolt {
        pub const m_flNextShootTime: usize = 0xEA0; // GameTime_t
        pub const m_iBoltsFired: usize = 0xEA4; // int32
        pub const m_iRemainingBolts: usize = 0xEA8; // int32
        pub const m_bPreppingShoot: usize = 0xEAC; // bool
    }
    // Parent: CCitadel_Modifier_Intrinsic_Base
    // Field count: 0
    ...
    pub mod CAbilityRestorativeGooVData {
        pub const m_RestorativeGooParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_RestorativeGooModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 3
    pub mod CCitadel_Ability_Teleport {
        pub const m_bTeleportingToTarget: usize = 0xCA0; // bool
        pub const m_vTargetPosition: usize = 0xCA4; // Vector
        pub const m_vTargetAngles: usize = 0xCB0; // QAngle
    }
    // Parent: CCitadelModifier
    // Field count: 1
    pub mod CModifier_Upgrade_ArcaneSurge_WeaponBuff {
    ...
    pub mod CItemStimPakVData {
        pub const m_StimPakModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_CastParticle: usize = 0x15B8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Magician_EscapeVData {
        pub const m_EscapedModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_PoofParticle: usize = 0x1570; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TetherParticle: usize = 0x1650; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strEscaped: usize = 0x1730; // CSoundEventName
        pub const m_cameraSequenceTeleport: usize = 0x1740; // CitadelCameraOperationsSequence_t
    }
    // Parent: CitadelAbilityVData
    // Field count: 1
    pub mod CAbility_Rutger_CheatDeath_VData {
        pub const m_ModifierCheatDeathActivated: usize = 0x1560; // CEmbeddedSubclass<CBaseModifier>
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CItemMetalSkinVData {
        pub const m_MetalSkinModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CitadelItemVData
    // Field count: 3
    pub mod CCitadel_Upgrade_AmmoScavenger_VData {
        pub const m_BuffModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_StackSound: usize = 0x15B8; // CSoundEventName
        pub const m_AmmoSound: usize = 0x15C8; // CSoundEventName
    }
    // Parent: CCitadelModifierVData
    // Field count: 7
    ...
    // Field count: 1
    pub mod C_LaneNode {
        pub const m_nPlayerTeamEventIndex: usize = 0x898; // int32
    }
    // Parent: CCitadelModelEntity
    // Field count: 1
    pub mod C_CitadelViscousBall {
        pub const m_hAbility: usize = 0x868; // CHandle<C_CitadelBaseAbility>
    }
    // Parent: CitadelAbilityVData
    // Field count: 4
    pub mod CAbilityThumper2VData {
        pub const m_StompParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strStompExplosionSound: usize = 0x1640; // CSoundEventName
        pub const m_BuffModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_BarbedWireAuraModifier: usize = 0x1660; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_BaseEventProcVData
    // Field count: 3
    ...
    pub mod CAbilityVacuumVData {
        pub const m_VacuumAuraModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flAirSpeedMax: usize = 0x1570; // float32
        pub const m_flFallSpeedMax: usize = 0x1574; // float32
        pub const m_flAirDrag: usize = 0x1578; // float32
        pub const m_flMaxMovespeed: usize = 0x157C; // float32
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CAbilitySprintVData {
        pub const m_SprintParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strSprintSound: usize = 0x1640; // CSoundEventName
        pub const m_flInCombatDuration: usize = 0x1650; // float32
        pub const m_flSprintAccMS: usize = 0x1654; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod CAbility_Synth_Affliction {
        pub const m_hAOEParticle: usize = 0xD10; // ParticleIndex_t
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadel_Ability_InfinitySlashVData {
        pub const m_flRiseSpeed: usize = 0x1568; // float32
        pub const m_flRiseDuration: usize = 0x156C; // float32
        pub const m_flSpeedDecayScale: usize = 0x1570; // float32
        pub const m_flExplodeHoldTime: usize = 0x1574; // float32
        pub const m_flExplosionShakeAmplitude: usize = 0x1578; // float32
        pub const m_flExplosionShakeFrequency: usize = 0x157C; // float32
        pub const m_flExplosionShakeDuration: usize = 0x1580; // float32
        pub const m_AOERangeEffect: usize = 0x1588; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_AnimCastEffect: usize = 0x1668; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_cameraSequenceExplosion: usize = 0x1748; // CitadelCameraOperationsSequence_t
        pub const m_BuffModifier: usize = 0x17D0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_BuffTimerModifier: usize = 0x17E0; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CCitadel_Ability_TangoTether {
        ...
        pub const m_vecCastStartPos: usize = 0xCA4; // Vector
        pub const m_vecDashStartPos: usize = 0xCB0; // Vector
        pub const m_vecDashEndPos: usize = 0xCBC; // Vector
        pub const m_angDashStartAng: usize = 0xCC8; // QAngle
        pub const m_flDashStartTime: usize = 0xCD4; // GameTime_t
        ...
        pub const m_flVelSpring: usize = 0xCE4; // float32
        pub const m_flGrappleShotAttackTime: usize = 0xCE8; // GameTime_t
        pub const m_nTicksNotMoving: usize = 0xCEC; // int32
        pub const m_vecPrevPos: usize = 0xCF0; // Vector
        pub const m_rgTargetPos: usize = 0xCFC; // Vector[20]
        pub const m_rgTargetPosTime: usize = 0xDEC; // GameTime_t[20]
        pub const m_nGrappleTravelEffect: usize = 0xE3C; // ParticleIndex_t
    }
    // Parent: CCitadelBaseShivAbility
    // Field count: 1
    pub mod CCitadel_Ability_ShivDagger {
        pub const m_bIsInRicochet: usize = 0xCA0; // bool
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Bull_LeapVData {
        pub const m_CrashSpeedScaleCurve: usize = 0x1560; // CPiecewiseCurve
        pub const m_BoostModifier: usize = 0x15A0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_CrashModifier: usize = 0x15B0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ImmunityModifier: usize = 0x15C0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_LandingBonusesModifier: usize = 0x15D0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_TakeOffParticle: usize = 0x15E0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ImpactParticle: usize = 0x16C0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_AoEPreviewParticle: usize = 0x17A0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_nHoverParticle: usize = 0x1880; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strCrashingSound: usize = 0x1960; // CSoundEventName
        pub const m_strImpactSound: usize = 0x1970; // CSoundEventName
        pub const m_flStartupTime: usize = 0x1980; // float32
        pub const m_flForwardBoostSpeed: usize = 0x1984; // float32
        pub const m_flUpBoostSpeed: usize = 0x1988; // float32
        pub const m_flBoostTurnRate: usize = 0x198C; // float32
        pub const m_flHoverTime: usize = 0x1990; // float32
        pub const m_flMinAimAngle: usize = 0x1994; // float32
        pub const m_flBoostGain: usize = 0x1998; // float32
        pub const m_flBoostTime: usize = 0x199C; // float32
        pub const m_flLandingTime: usize = 0x19A0; // float32
        pub const m_flCrashSpeed: usize = 0x19A4; // float32
        pub const m_flHoverInputSpeedMax: usize = 0x19A8; // float32
        pub const m_flHoverInputAcceleration: usize = 0x19AC; // float32
        pub const m_flHoverSpeedDecay: usize = 0x19B0; // float32
    }
    // Parent: C_BaseEntity
    // Field count: 29
    pub mod C_CitadelBaseAbility {
        pub const m_vecIntrinsicModifiers: usize = 0x638; // CUtlVector<CModifierHandleTyped<CCitadelModifier>>
        pub const m_pCastDelayAutoModifier: usize = 0x650; // CModifierHandleTyped<CCitadelModifier>
        pub const m_pChannelAutoModifier: usize = 0x668; // CModifierHandleTyped<CCitadelModifier>
        pub const m_strUsedCastGraphParam: usize = 0x680; // CGlobalSymbol
        pub const m_nCastParamNeedsResetTick: usize = 0x688; // int32
        pub const m_bIsCoolingDownInternal: usize = 0x68C; // bool
        pub const m_flCancelLockoutTime: usize = 0x690; // GameTime_t
        pub const m_bChanneling: usize = 0x6B0; // bool
        pub const m_bInCastDelay: usize = 0x6B1; // bool
        pub const m_vecImbuedByAbilitiyIDs: usize = 0x6B8; // C_NetworkUtlVectorBase<CUtlStringToken>
        pub const m_nUpgradeBits: usize = 0x6D0; // int32
        pub const m_iBucketID: usize = 0x6D4; // int32
        pub const m_bToggleState: usize = 0x6D8; // bool
        pub const m_flCooldownStart: usize = 0x6DC; // GameTime_t
        pub const m_flCooldownEnd: usize = 0x6E0; // GameTime_t
        pub const m_flCastCompletedTime: usize = 0x6E4; // GameTime_t
        pub const m_flChannelStartTime: usize = 0x6E8; // GameTime_t
        pub const m_flCastDelayStartTime: usize = 0x6EC; // GameTime_t
        pub const m_eAbilitySlot: usize = 0x6F0; // EAbilitySlots_t
        pub const m_flPostCastDelayEndTime: usize = 0x6F4; // GameTime_t
        pub const m_iRemainingCharges: usize = 0x6F8; // int32
        pub const m_flChargeRechargeStart: usize = 0x6FC; // GameTime_t
        pub const m_flChargeRechargeEnd: usize = 0x700; // GameTime_t
        pub const m_flMovementControlActiveTime: usize = 0x704; // GameTime_t
        pub const m_flSelectedChangedTime: usize = 0x708; // GameTime_t
        pub const m_flAltCastHoldStartTime: usize = 0x70C; // GameTime_t
        pub const m_flAltCastDoubleTapStartTime: usize = 0x710; // GameTime_t
        pub const m_nImbuedAbilityID: usize = 0x714; // CUtlStringToken
        pub const m_bSelectionModeIsAltMode: usize = 0x718; // bool
    }
    // Parent: C_NPC_SimpleAnimatingAI
    // Field count: 1
    ...
    // Field count: 2
    pub mod CPathSimple {
        pub const m_CPathQueryComponent: usize = 0x570; // CPathQueryComponent
        pub const m_pathString: usize = 0x620; // CUtlString
    }
    // Parent: CitadelAbilityVData
    // Field count: 3
    pub mod CCitadel_Ability_MageWalkVData {
        pub const m_BubbleModifier: usize = 0x1560; // CEmbeddedSubclass<CBaseModifier>
        pub const m_TurretModifier: usize = 0x1570; // CEmbeddedSubclass<CBaseModifier>
        pub const m_strCastEffect: usize = 0x1580; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 7
    pub mod CAbility_Fathom_LurkersAmbush {
        pub const m_hRegenModifier: usize = 0xE28; // CModifierHandleTyped<CCitadelModifier>
        pub const m_hInvisModifier: usize = 0xE40; // CModifierHandleTyped<CCitadelModifier>
        pub const m_bIsVisibleOnMinimap: usize = 0xE58; // bool
        pub const m_flStoppedMovingStartTime: usize = 0xE5C; // GameTime_t
        pub const m_vLastPos: usize = 0xE60; // Vector
        pub const m_flImmobilizeDuration: usize = 0xE6C; // float32
        pub const m_flChannelTimeStarted: usize = 0xE70; // GameTime_t
    }
    // Parent: CCitadel_Modifier_Stunned
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Chrono_KineticCarbineVData {
        pub const m_flShotTimeScaleLingerDuration: usize = 0x1560; // float32
        pub const m_ChargingModifier: usize = 0x1568; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DebuffModifier: usize = 0x1578; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_cameraKineticCarbineShotFired: usize = 0x1588; // CitadelCameraOperationsSequence_t
    }
    // Parent: CitadelItemVData
    // Field count: 2
    pub mod CCitadel_Item_DivinersKevlar_VData {
        pub const m_BuffModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_PrecastSpiritBuffModifier: usize = 0x15B8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Item
    // Field count: 3
    pub mod CCitadel_Upgrade_MagicCarpet {
        pub const m_flFlyingStartTime: usize = 0xCB8; // GameTime_t
        pub const m_bFlying: usize = 0xD68; // bool
        pub const m_bSummoning: usize = 0xD69; // bool
    }
    // Parent: C_PointClientUIWorldPanel
    // Field count: 4
    ...
    pub mod CCitadel_Ability_Shakedown_Target {
        pub const m_hShadowdownAbility: usize = 0xCA0; // CHandle<CCitadel_Ability_Yakuza_Shakedown>
        pub const m_AimPos: usize = 0xCA4; // Vector
    }
    // Parent: CEntitySubclassVDataBase
    // Field count: 8
    ...
    pub mod CCitadel_Ability_SmokeBombVData {
        pub const m_InvisModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_BuffModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_PhaseOutModifier: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_PurgeParticle: usize = 0x1590; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadelModifier
    // Field count: 12
    ...
    pub mod C_CitadelProjectile_ImmobilizeTrap {
        pub const m_bShouldDraw: usize = 0x8E8; // bool
    }
    // Parent: C_BaseModelEntity
    // Field count: 13
    pub mod C_EntityDissolve {
        pub const m_flStartTime: usize = 0x868; // GameTime_t
        pub const m_flFadeInStart: usize = 0x86C; // float32
        pub const m_flFadeInLength: usize = 0x870; // float32
        pub const m_flFadeOutModelStart: usize = 0x874; // float32
        pub const m_flFadeOutModelLength: usize = 0x878; // float32
        pub const m_flFadeOutStart: usize = 0x87C; // float32
        pub const m_flFadeOutLength: usize = 0x880; // float32
        pub const m_flNextSparkTime: usize = 0x884; // GameTime_t
        pub const m_nDissolveType: usize = 0x888; // EntityDisolveType_t
        pub const m_vDissolverOrigin: usize = 0x88C; // Vector
        pub const m_nMagnitude: usize = 0x898; // uint32
        pub const m_bCoreExplode: usize = 0x89C; // bool
        pub const m_bLinkedToServerEnt: usize = 0x89D; // bool
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 2
    pub mod CAbility_Mirage_Tornado {
        pub const m_vLastValidMovementPosition: usize = 0xCA0; // Vector
        pub const m_hActiveProjectile: usize = 0xCAC; // CHandle<C_CitadelProjectile>
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CAbilityVandalOverflowVData {
        pub const m_LiftModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_TargetParticle: usize = 0x1570; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TargetCastSound: usize = 0x1650; // CSoundEventName
    }
    ...
    // Field count: 1
    pub mod CFilterTeam {
        pub const m_iFilterTeam: usize = 0x5C0; // int32
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod C_PostProcessingVolume {
        pub const m_hPostSettings: usize = 0x9B0; // CStrongHandle<InfoForResourceTypeCPostProcessingResource>
        pub const m_flFadeDuration: usize = 0x9B8; // float32
        pub const m_flMinLogExposure: usize = 0x9BC; // float32
        pub const m_flMaxLogExposure: usize = 0x9C0; // float32
        pub const m_flMinExposure: usize = 0x9C4; // float32
        pub const m_flMaxExposure: usize = 0x9C8; // float32
        pub const m_flExposureCompensation: usize = 0x9CC; // float32
        pub const m_flExposureFadeSpeedUp: usize = 0x9D0; // float32
        pub const m_flExposureFadeSpeedDown: usize = 0x9D4; // float32
        pub const m_flTonemapEVSmoothingRange: usize = 0x9D8; // float32
        pub const m_bMaster: usize = 0x9DC; // bool
        pub const m_bExposureControl: usize = 0x9DD; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_ChronoSwap {
        pub const m_bHitTarget: usize = 0xCA0; // bool
    }
    // Parent: CitadelAbilityVData
    // Field count: 8
    pub mod CAbilityCardTossVData {
        pub const m_ExplodeParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SummonedCard: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strCardTossSound: usize = 0x1720; // CSoundEventName
        pub const m_strCardSummonSound: usize = 0x1730; // CSoundEventName
        pub const m_flSummonedCardStartSideOffset: usize = 0x1740; // float32
        pub const m_flSummonedCardSideOffsetStep: usize = 0x1744; // float32
        pub const m_flSummonedCardForwardOffset: usize = 0x1748; // float32
        pub const m_flSummonedCardVerticalOffset: usize = 0x174C; // float32
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Sprint {
        pub const m_nSprintParticle: usize = 0xCA0; // ParticleIndex_t
        pub const m_bSprinting: usize = 0xCA4; // bool
        pub const m_flInCombatStartTime: usize = 0xCA8; // GameTime_t
        pub const m_flInCombatEndTime: usize = 0xCAC; // GameTime_t
        pub const m_flSprintStartTime: usize = 0xCB0; // GameTime_t
        pub const m_bInCombat: usize = 0xCB4; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod C_CitadelPositionHomingProjectile {
        pub const m_vecHomingPosition: usize = 0x8E8; // Vector
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_HealthSwap {
        ...
        pub const m_flHealthToCaster: usize = 0xCA4; // float32
        pub const m_flTargetHealthLost: usize = 0xCA8; // float32
        pub const m_flPostCastHoldEndTime: usize = 0xDC8; // GameTime_t
    }
    ...
    pub mod CAbility_Synth_Barrage_VData {
        pub const m_BarrageCasterModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_AmpModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DebuffModifier: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ShootParticle: usize = 0x1590; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        ...
        pub const m_strProjectileLaunchSound: usize = 0x1830; // CSoundEventName
        pub const m_flAttackInterval: usize = 0x1840; // float32
    }
    // Parent: CCitadelModifierVData
    // Field count: 5
    ...
    pub mod CBaseAnimGraph {
        pub const m_bInitiallyPopulateInterpHistory: usize = 0x8E0; // bool
        pub const m_bSuppressAnimEventSounds: usize = 0x8E2; // bool
        pub const m_bAnimGraphUpdateEnabled: usize = 0x8F0; // bool
        pub const m_flMaxSlopeDistance: usize = 0x8F4; // float32
        pub const m_vLastSlopeCheckPos: usize = 0x8F8; // Vector
        pub const m_bAnimationUpdateScheduled: usize = 0x904; // bool
        pub const m_vecForce: usize = 0x908; // Vector
        pub const m_nForceBone: usize = 0x914; // int32
        pub const m_pClientsideRagdoll: usize = 0x918; // CBaseAnimGraph*
        pub const m_bBuiltRagdoll: usize = 0x920; // bool
        pub const m_RagdollPose: usize = 0x938; // PhysicsRagdollPose_t
        pub const m_bRagdollClientSide: usize = 0x980; // bool
        pub const m_bHasAnimatedMaterialAttributes: usize = 0x990; // bool
        pub const m_animGraph2SerializeData: usize = 0xAD8; // C_NetworkUtlVectorBase<uint8>
        pub const m_nAnimGraph2SerializeDataSizeBytes: usize = 0xAF0; // int32
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod CAbilityUppercutVData {
        pub const m_UppercutAttackData: usize = 0x1580; // AttackData_t
        pub const m_UppercutModifier: usize = 0x1AA8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_BuffModifier: usize = 0x1AB8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ClipModifier: usize = 0x1AC8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flMaxPitchUp: usize = 0x1AD8; // float32
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadel_Ability_StaticChargeVData {
        pub const m_CastParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_StaticChargeModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_IceDomeVData {
        pub const m_IceDomeModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CCitadel_Item_WarpStone {
        pub const m_nCastDelayParticleIndex: usize = 0xCB8; // ParticleIndex_t
    }
    // Parent: CCitadel_Item
    // Field count: 1
    pub mod CCitadel_WeaponUpgrade_SiphonBullets {
        pub const m_iStacks: usize = 0xCB8; // int32
    }
    // Parent: C_BaseEntity
    // Field count: 16
    ...
    pub mod CNPC_TrooperNeutralVData {
        pub const m_eTrooperType: usize = 0x10D8; // ENeutralTrooperType
        pub const m_flGoldReward: usize = 0x10DC; // float32
        pub const m_flGoldRewardBonusPercentPerMinute: usize = 0x10E0; // float32
        pub const m_bGiveGoldOnHit: usize = 0x10E4; // bool
        pub const m_bOrbDropper: usize = 0x10E5; // bool
        pub const m_bCapSimultanousAttackers: usize = 0x10E6; // bool
        pub const m_flShieldReactivateDelay: usize = 0x10E8; // float32
        pub const m_flDyingDuration: usize = 0x10EC; // float32
        pub const m_bDamagedByBullets: usize = 0x10F0; // bool
        pub const m_bDamagedByMelee: usize = 0x10F1; // bool
        pub const m_bDamagedByAbilities: usize = 0x10F2; // bool
        pub const m_bFixedMeleeDamage: usize = 0x10F3; // bool
        pub const m_ShieldParticle: usize = 0x10F8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flRetaliateDamage: usize = 0x11D8; // float32
        pub const m_flRetaliateCooldown: usize = 0x11DC; // float32
        pub const m_retaliateParticle: usize = 0x11E0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_bHasAOEAttack: usize = 0x12C0; // bool
        pub const m_flAOERadius: usize = 0x12C4; // float32
        pub const m_flAOEDamage: usize = 0x12C8; // float32
        pub const m_flAOEAttackCooldown: usize = 0x12CC; // float32
        pub const m_AOEParticle: usize = 0x12D0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_AOEDebuffToApply: usize = 0x13B0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_AOEInitiateSound: usize = 0x13C0; // CSoundEventName
        pub const m_AOESound: usize = 0x13D0; // CSoundEventName
        pub const m_AOEDebuffDuration: usize = 0x13E0; // float32
        pub const m_vecRandomBodyGroup: usize = 0x13E8; // CUtlVector<CUtlString>
        pub const m_vecRandomSkin: usize = 0x1400; // CUtlVector<CUtlString>
        pub const m_flHullCapsuleRadius: usize = 0x1418; // float32
        pub const m_flHullCapsuleHeight: usize = 0x141C; // float32
        pub const m_bFaceEnemyWhileIdle: usize = 0x1420; // bool
        pub const m_IdleLoopSound: usize = 0x1428; // CSoundEventName
        pub const m_MoveType: usize = 0x1438; // MoveType_t
    }
    // Parent: C_CitadelProjectile
    // Field count: 0
    ...
    pub mod C_CitadelProjectile {
        pub const m_flMaxDistance: usize = 0x86C; // float32
        pub const m_flArmingTime: usize = 0x870; // float32
        pub const m_flChargeAmount: usize = 0x874; // float32
        pub const m_bCollideWithThrower: usize = 0x878; // bool
        pub const m_bNewCollideWithThrower: usize = 0x879; // bool
        pub const m_flTickSoundInterval: usize = 0x888; // float32
        pub const m_vInitialVelocity: usize = 0x890; // Vector
        pub const m_vInitialPosition: usize = 0x89C; // Vector
        pub const m_abilityID: usize = 0x8A8; // CUtlStringToken
        pub const m_hThrower: usize = 0x8AC; // CHandle<C_BaseEntity>
        pub const m_sParticleName: usize = 0x8B0; // CUtlSymbolLarge
        pub const m_vecSpawnPosition: usize = 0x8B8; // Vector
        pub const m_flProjectileSpeed: usize = 0x8C4; // float32
        pub const m_flMaxLifetime: usize = 0x8C8; // float32
        pub const m_flParticleRadius: usize = 0x8D0; // float32
        pub const m_flPreviousTimeScale: usize = 0x8E0; // float32
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Fathom_Breach_VData {
        pub const m_ExplosionParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_LeapParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strInFlightAnimGraphParam: usize = 0x1720; // CGlobalSymbol
        pub const m_strExplodeSound: usize = 0x1728; // CSoundEventName
        pub const m_InFlightModifier: usize = 0x1738; // CEmbeddedSubclass<CCitadelModifier>
    }
    ...
    pub mod CAbilityDashVData {
        pub const m_DashParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DownDashParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strArriveSound: usize = 0x1720; // CSoundEventName
        pub const m_strStaminaDrainedSound: usize = 0x1730; // CSoundEventName
        pub const m_cameraSequenceGroundDashActivate: usize = 0x1740; // CitadelCameraOperationsSequence_t
        pub const m_cameraSequenceAirDashActivate: usize = 0x17C8; // CitadelCameraOperationsSequence_t
        pub const m_flMaxAngDiff: usize = 0x1850; // float32
        pub const m_flDurationScaleForSpeed: usize = 0x1854; // float32
        pub const m_flSlideEarlyOutWindow: usize = 0x1858; // float32
        pub const m_flSlideLockoutTime: usize = 0x185C; // float32
        pub const m_flGroundDashAirbornDrag: usize = 0x1860; // float32
        pub const m_flGroundDashAirbornSpeedClamp: usize = 0x1864; // float32
        pub const m_strGroundDashActivate: usize = 0x1868; // CSoundEventName
        pub const m_curvePosition: usize = 0x1878; // CPiecewiseCurve
        pub const m_flGroundDashDuration: usize = 0x18B8; // float32
        pub const m_flGroundDashDistanceInMeters: usize = 0x18BC; // float32
        pub const m_flAirDashEndVelocityScale: usize = 0x18C0; // float32
        pub const m_flAirDashAccPct: usize = 0x18C4; // float32
        pub const m_flDuringDrag: usize = 0x18C8; // float32
        pub const m_flPostDrag: usize = 0x18CC; // float32
        pub const m_flPostDragDuration: usize = 0x18D0; // float32
        pub const m_flDownwardAirDashSpeed: usize = 0x18D4; // float32
        pub const m_strDashActivate: usize = 0x18D8; // CSoundEventName
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbilityNikumanVData {
        pub const m_NikumanModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SelfBuffModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CitadelItemVData
    // Field count: 6
    pub mod CItem_ActiveReload_VData {
        pub const m_SuccessModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strSuccessSound: usize = 0x15B8; // CSoundEventName
        pub const m_strFailureSound: usize = 0x15C8; // CSoundEventName
        pub const m_SuccessParticle: usize = 0x15D8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_FailureParticle: usize = 0x16B8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flGraceTime: usize = 0x1798; // float32
    }
    // Parent: CitadelAbilityVData
    // Field count: 10
    pub mod CitadelItemVData {
        pub const m_iItemTier: usize = 0x1564; // EModTier_t
        pub const m_nUpgradeSlotCost: usize = 0x1565; // int8
        pub const m_bWarnIfNoAffectedAbilities: usize = 0x1566; // bool
        pub const m_bRequiresChargedAbility: usize = 0x1567; // bool
        pub const m_bRequiresChanelledAbility: usize = 0x1568; // bool
        pub const m_vecComponentItems: usize = 0x1570; // CUtlVector<CSubclassName<4>>
        pub const m_bShowTextDescription: usize = 0x1588; // bool
        pub const m_bIsDefensiveItem: usize = 0x1589; // bool
        pub const m_eShopFilters: usize = 0x158A; // EShopFilters_t
        pub const m_vecTooltipSectionInfo: usize = 0x1590; // CUtlVector<ItemSectionInfo_t>
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CAbilityGangActivityCancelVData {
        pub const m_AbilitySwap: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 5
    ...
    pub mod CAbilitySleepDaggerVData {
        pub const m_ImpactParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SleepModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DrowsyModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SleepBombModifier: usize = 0x1660; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CitadelAbilityVData
    // Field count: 4
    pub mod CAbilityLashFlogVData {
        pub const m_FlogParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_FlogLifeLeachParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strHitConfirmSound: usize = 0x1720; // CSoundEventName
        pub const m_FlogDebuffModifier: usize = 0x1730; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_BaseEventProc
    // Field count: 0
    ...
    pub mod C_BasePlayerWeapon {
        pub const m_nNextPrimaryAttackTick: usize = 0xB00; // GameTick_t
        pub const m_flNextPrimaryAttackTickRatio: usize = 0xB04; // float32
        pub const m_nNextSecondaryAttackTick: usize = 0xB08; // GameTick_t
        pub const m_flNextSecondaryAttackTickRatio: usize = 0xB0C; // float32
        pub const m_iClip1: usize = 0xB10; // int32
        pub const m_iClip2: usize = 0xB14; // int32
        pub const m_pReserveAmmo: usize = 0xB18; // int32[2]
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod CCitadelAbilityHealingSlashVData {
        pub const m_flEffectSize: usize = 0x1568; // float32
        pub const m_flMaxAttackAngle: usize = 0x156C; // float32
        pub const m_remapAngleToTime: usize = 0x1570; // CRemapFloat
        pub const m_DebuffModifier: usize = 0x1580; // CEmbeddedSubclass<CBaseModifier>
        pub const m_ImpactParticle: usize = 0x1590; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_HealingSlashParticle: usize = 0x1670; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_HealingSlashSwordGlow: usize = 0x1750; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CastParticle: usize = 0x1830; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strDamageTarget: usize = 0x1910; // CSoundEventName
    }
    // Parent: None
    // Field count: 24
    ...
    // Field count: 23
    pub mod C_Fish {
        pub const m_pos: usize = 0xB00; // Vector
        pub const m_vel: usize = 0xB0C; // Vector
        pub const m_angles: usize = 0xB18; // QAngle
        pub const m_localLifeState: usize = 0xB24; // int32
        pub const m_deathDepth: usize = 0xB28; // float32
        pub const m_deathAngle: usize = 0xB2C; // float32
        pub const m_buoyancy: usize = 0xB30; // float32
        pub const m_wiggleTimer: usize = 0xB38; // CountdownTimer
        pub const m_wigglePhase: usize = 0xB50; // float32
        pub const m_wiggleRate: usize = 0xB54; // float32
        pub const m_actualPos: usize = 0xB58; // Vector
        pub const m_actualAngles: usize = 0xB64; // QAngle
        pub const m_poolOrigin: usize = 0xB70; // Vector
        pub const m_waterLevel: usize = 0xB7C; // float32
        pub const m_gotUpdate: usize = 0xB80; // bool
        pub const m_x: usize = 0xB84; // float32
        pub const m_y: usize = 0xB88; // float32
        pub const m_z: usize = 0xB8C; // float32
        pub const m_angle: usize = 0xB90; // float32
        pub const m_errorHistory: usize = 0xB94; // float32[20]
        pub const m_errorHistoryIndex: usize = 0xBE4; // int32
        pub const m_errorHistoryCount: usize = 0xBE8; // int32
        pub const m_averageError: usize = 0xBEC; // float32
    }
    // Parent: C_CitadelProjectile
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Trapper_WebWallVData {
        ...
        pub const m_DisarmModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_WebWallParticle: usize = 0x1580; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_WebWallDestroyedParticle: usize = 0x1660; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TimeWallChargeParticle: usize = 0x1740; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TimeWallHitParticle: usize = 0x1820; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TimeWallHitTimerParticle: usize = 0x1900; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strWebWallCreated: usize = 0x19E0; // CSoundEventName
        pub const m_strWebWallDestroyed: usize = 0x19F0; // CSoundEventName
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbilityLightningBallVData {
        pub const m_ZapModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strHitSound: usize = 0x1570; // CSoundEventName
        pub const m_strProjectileLoopingSound: usize = 0x1580; // CSoundEventName
        pub const m_ZapParticle: usize = 0x1590; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    ...
    pub mod CAbilityTrappersBoloVData {
        pub const m_ImpactParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TrapModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DebuffModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CPathAccompany {
        pub const m_flPathLength: usize = 0x568; // float32
        pub const m_vecNodes: usize = 0x570; // CUtlVector<PathAccompanyNode_t>
    }
    // Parent: C_BaseCombatCharacter
    // Field count: 28
    pub mod C_BasePlayerPawn {
        pub const m_pWeaponServices: usize = 0xD20; // CPlayer_WeaponServices*
        pub const m_pItemServices: usize = 0xD28; // CPlayer_ItemServices*
        pub const m_pAutoaimServices: usize = 0xD30; // CPlayer_AutoaimServices*
        pub const m_pObserverServices: usize = 0xD38; // CPlayer_ObserverServices*
        pub const m_pWaterServices: usize = 0xD40; // CPlayer_WaterServices*
        pub const m_pUseServices: usize = 0xD48; // CPlayer_UseServices*
        pub const m_pFlashlightServices: usize = 0xD50; // CPlayer_FlashlightServices*
        pub const m_pCameraServices: usize = 0xD58; // CPlayer_CameraServices*
        pub const m_pMovementServices: usize = 0xD60; // CPlayer_MovementServices*
        pub const m_ServerViewAngleChanges: usize = 0xD70; // C_UtlVectorEmbeddedNetworkVar<ViewAngleServerChange_t>
        pub const v_angle: usize = 0xDD8; // QAngle
        pub const v_anglePrevious: usize = 0xDE4; // QAngle
        pub const m_iHideHUD: usize = 0xDF0; // uint32
        pub const m_skybox3d: usize = 0xDF8; // sky3dparams_t
        pub const m_flDeathTime: usize = 0xE88; // GameTime_t
        pub const m_vecPredictionError: usize = 0xE8C; // Vector
        pub const m_flPredictionErrorTime: usize = 0xE98; // GameTime_t
        pub const m_vecLastCameraSetupLocalOrigin: usize = 0xE9C; // Vector
        pub const m_flLastCameraSetupTime: usize = 0xEA8; // GameTime_t
        pub const m_flFOVSensitivityAdjust: usize = 0xEAC; // float32
        pub const m_flMouseSensitivity: usize = 0xEB0; // float32
        pub const m_vOldOrigin: usize = 0xEB4; // Vector
        pub const m_flOldSimulationTime: usize = 0xEC0; // float32
        pub const m_nLastExecutedCommandNumber: usize = 0xEC4; // int32
        pub const m_nLastExecutedCommandTick: usize = 0xEC8; // int32
        pub const m_hController: usize = 0xECC; // CHandle<CBasePlayerController>
        pub const m_hDefaultController: usize = 0xED0; // CHandle<CBasePlayerController>
        pub const m_bIsSwappingToPredictableController: usize = 0xED4; // bool
    }
    // Parent: CCitadelModifierAuraVData
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Magician_AnimalCurse {
        pub const m_CachedTarget: usize = 0xCA0; // CHandle<C_BaseEntity>
    }
    // Parent: CitadelAbilityVData
    // Field count: 2
    pub mod CAbilityDistruptiveChargeVData {
        pub const m_Particle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_BuffModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod C_RopeKeyframe {
        pub const m_LinksTouchingSomething: usize = 0x868; // CBitVec<10>
        pub const m_nLinksTouchingSomething: usize = 0x86C; // int32
        pub const m_bApplyWind: usize = 0x870; // bool
        pub const m_fPrevLockedPoints: usize = 0x874; // int32
        pub const m_iForcePointMoveCounter: usize = 0x878; // int32
        pub const m_bPrevEndPointPos: usize = 0x87C; // bool[2]
        pub const m_vPrevEndPointPos: usize = 0x880; // Vector[2]
        pub const m_flCurScroll: usize = 0x898; // float32
        pub const m_flScrollSpeed: usize = 0x89C; // float32
        pub const m_RopeFlags: usize = 0x8A0; // uint16
        pub const m_iRopeMaterialModelIndex: usize = 0x8A8; // CStrongHandle<InfoForResourceTypeIMaterial2>
        pub const m_LightValues: usize = 0xB20; // Vector[10]
        pub const m_nSegments: usize = 0xB98; // uint8
        pub const m_hStartPoint: usize = 0xB9C; // CHandle<C_BaseEntity>
        pub const m_hEndPoint: usize = 0xBA0; // CHandle<C_BaseEntity>
        pub const m_iStartAttachment: usize = 0xBA4; // AttachmentHandle_t
        pub const m_iEndAttachment: usize = 0xBA5; // AttachmentHandle_t
        pub const m_Subdiv: usize = 0xBA6; // uint8
        pub const m_RopeLength: usize = 0xBA8; // int16
        pub const m_Slack: usize = 0xBAA; // int16
        pub const m_TextureScale: usize = 0xBAC; // float32
        pub const m_fLockedPoints: usize = 0xBB0; // uint8
        pub const m_nChangeCount: usize = 0xBB1; // uint8
        pub const m_Width: usize = 0xBB4; // float32
        pub const m_PhysicsDelegate: usize = 0xBB8; // C_RopeKeyframe::CPhysicsDelegate
        pub const m_hMaterial: usize = 0xBC8; // CStrongHandle<InfoForResourceTypeIMaterial2>
        pub const m_TextureHeight: usize = 0xBD0; // int32
        pub const m_vecImpulse: usize = 0xBD4; // Vector
        pub const m_vecPreviousImpulse: usize = 0xBE0; // Vector
        pub const m_flCurrentGustTimer: usize = 0xBEC; // float32
        pub const m_flCurrentGustLifetime: usize = 0xBF0; // float32
        pub const m_flTimeToNextGust: usize = 0xBF4; // float32
        pub const m_vWindDir: usize = 0xBF8; // Vector
        pub const m_vColorMod: usize = 0xC04; // Vector
        pub const m_vCachedEndPointAttachmentPos: usize = 0xC10; // Vector[2]
        pub const m_vCachedEndPointAttachmentAngle: usize = 0xC28; // QAngle[2]
        pub const m_bConstrainBetweenEndpoints: usize = 0xC40; // bool
    ...
    pub mod CFilterModifier {
        pub const m_iFilterModifier: usize = 0x5C0; // CUtlSymbolLarge
    }
    // Parent: C_BaseEntity
    // Field count: 16
    ...
    pub mod CAbilityWreckerScrapBlastVData {
        pub const m_SprayParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ChannelStartParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DebuffModifier: usize = 0x1720; // CEmbeddedSubclass<CBaseModifier>
    }
    // Parent: CCitadel_Modifier_BaseEventProcVData
    // Field count: 3
    ...
    pub mod CCitadel_Ability_FissureWall {
        pub const m_vecWallPreviewParticles: usize = 0xCB0; // CUtlVector<ParticleIndex_t>
        pub const m_vecStartPos: usize = 0xD70; // Vector
        pub const m_vecPosition: usize = 0xD7C; // Vector
        pub const m_vecInitialPosition: usize = 0xD88; // Vector
        pub const m_CastTime: usize = 0xD94; // GameTime_t
        pub const m_vecDirection: usize = 0xD98; // Vector
        pub const m_vecLeft: usize = 0xDA4; // Vector
        pub const m_Length: usize = 0xDB0; // float32
        pub const m_bTraveling: usize = 0xDB4; // bool
        pub const m_bPreview: usize = 0xDB5; // bool
    }
    // Parent: CCitadel_Modifier_BaseEventProc
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Shiv_Defer_Damage {
        pub const m_flTotalPendingDamage: usize = 0xD80; // float32
    }
    // Parent: CitadelAbilityVData
    // Field count: 10
    pub mod CCitadel_Ability_IceBeamVData {
        pub const m_BeamParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_HitParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SlowModifier: usize = 0x1720; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_BuildupModifier: usize = 0x1730; // CEmbeddedSubclass<CCitadel_Modifier_Base_Buildup>
        pub const m_BuildupProcModifier: usize = 0x1740; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_BeamStartSound: usize = 0x1750; // CSoundEventName
        pub const m_BeamStopSound: usize = 0x1760; // CSoundEventName
        pub const m_BeamPointStartLoopSound: usize = 0x1770; // CSoundEventName
        pub const m_BeamPointEndLoopSound: usize = 0x1780; // CSoundEventName
        pub const m_BeamPointClosestLoopSound: usize = 0x1790; // CSoundEventName
    }
    ...
    pub mod CCitadel_Ability_ViscousWeapon_Alt {
        pub const m_ChargeState: usize = 0xCA0; // EViscousChargedGunState
        pub const m_nClipConsumed: usize = 0xCA4; // float32
        pub const m_bIsCharging: usize = 0xCA8; // bool
        pub const m_bIsToggled: usize = 0xCA9; // bool
        pub const m_fxChargingParticle: usize = 0xCAC; // ParticleIndex_t
        pub const m_flLastBulletConsumedTime: usize = 0xCB8; // GameTime_t
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod C_PortraitWorldUnit {
        pub const m_bSuppressIntroEffects: usize = 0xD20; // bool
        pub const m_bIsAlternateLoadout: usize = 0xD21; // bool
        pub const m_bSpawnBackgroundModels: usize = 0xD22; // bool
        pub const m_bDeferredPortrait: usize = 0xD23; // bool
        pub const m_bShowParticleAssetModifiers: usize = 0xD24; // bool
        pub const m_bIgnorePortraitInfo: usize = 0xD25; // bool
        pub const m_bFlyingCourier: usize = 0xD26; // bool
        pub const m_nEffigyStatusEffect: usize = 0xD28; // int32
        pub const m_effigySequenceName: usize = 0xD30; // CUtlSymbolLarge
        pub const m_flStartingAnimationCycle: usize = 0xD38; // float32
        pub const m_flRareLoadoutAnimChance: usize = 0xD3C; // float32
        pub const m_environment: usize = 0xD50; // CitadelPortraitEnvironmentType_t
        pub const m_nStartupBehavior: usize = 0xD54; // StartupBehavior_t
        pub const m_cameraName: usize = 0xEC8; // CUtlSymbolLarge
        pub const m_nPortraitParticle: usize = 0xF00; // ParticleIndex_t
        pub const m_nAmbientParticle: usize = 0xF04; // ParticleIndex_t
        pub const m_nCourierType: usize = 0xF08; // int32
        pub const m_heroID: usize = 0xF0C; // HeroID_t
        pub const m_heroAnimGraphEnumName: usize = 0xF10; // CUtlSymbolLarge
        pub const m_heroShopAnimGraphEnumName: usize = 0xF18; // CUtlSymbolLarge
    }
    // Parent: C_EconEntity
    // Field count: 0
    ...
    pub mod CCitadelBulletTimeWarp {
        pub const m_flBulletTimeScale: usize = 0x860; // float32
        pub const m_flProjectileTimeScale: usize = 0x864; // float32
        pub const m_flExpireTime: usize = 0x868; // GameTime_t
        pub const m_flStopDuration: usize = 0x86C; // float32
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod C_EnvVolumetricFogVolume {
        ...
        pub const m_TintColor: usize = 0x5A8; // Color
        pub const m_bOverrideTintColor: usize = 0x5AC; // bool
        pub const m_bOverrideIndirectLightStrength: usize = 0x5AD; // bool
        pub const m_bOverrideSunLightStrength: usize = 0x5AE; // bool
        pub const m_bOverrideNoiseStrength: usize = 0x5AF; // bool
        pub const m_bAllowLPVIndirect: usize = 0x5B0; // bool
    }
    // Parent: CCitadel_Modifier_StunnedVData
    // Field count: 2
    ...
    pub mod CCitadel_Ability_Lash_Flog {
        pub const m_SandEffect: usize = 0xDB8; // ParticleIndex_t
    }
    // Parent: CitadelItemVData
    // Field count: 1
    pub mod CCitadel_WeaponUpgrade_SiphonBulletsVData {
        pub const m_PermanentHealthLoss: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    ...
    pub mod CPointOrient {
        pub const m_iszSpawnTargetName: usize = 0x568; // CUtlSymbolLarge
        pub const m_hTarget: usize = 0x570; // CHandle<C_BaseEntity>
        pub const m_bActive: usize = 0x574; // bool
        pub const m_nGoalDirection: usize = 0x578; // PointOrientGoalDirectionType_t
        pub const m_nConstraint: usize = 0x57C; // PointOrientConstraint_t
        pub const m_flMaxTurnRate: usize = 0x580; // float32
        pub const m_flLastGameTime: usize = 0x584; // GameTime_t
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod C_CitadelPlayerPawn {
        pub const m_angEyeAngles: usize = 0xF50; // QAngle
        pub const m_angClientCamera: usize = 0xF68; // QAngle
        pub const m_eZipLineLaneColor: usize = 0xF74; // CMsgLaneColor
        pub const m_nLevel: usize = 0xF78; // int32
        pub const m_nCurrencies: usize = 0xF7C; // int32[4]
        pub const m_nSpentCurrencies: usize = 0xF8C; // int32[4]
        pub const m_flLastSpawnTime: usize = 0xF9C; // GameTime_t
        pub const m_flRespawnTime: usize = 0xFA0; // GameTime_t
        pub const m_bInRegenerationZone: usize = 0xFA4; // bool
        pub const m_bInItemShopZone: usize = 0xFA5; // bool
        pub const m_timeRevealedOnMinimapByNPC: usize = 0xFA8; // GameTime_t
        pub const m_vecFullSellPriceItems: usize = 0xFB0; // C_NetworkUtlVectorBase<CUtlStringToken>
        pub const m_vecFullSellPriceAbilityUpgrades: usize = 0xFC8; // C_NetworkUtlVectorBase<FullSellPriceAbilityUpgrades_t>
        pub const m_bNetworkDisconnected: usize = 0xFE0; // bool
        pub const m_bHasIncomingThreats: usize = 0xFE1; // bool
        pub const m_bLearningAbility: usize = 0xFE2; // bool
        pub const m_nFlashStartTick: usize = 0xFE4; // int32
        pub const m_nFlashMaxStartTick: usize = 0xFE8; // int32
        pub const m_nFlashFadeStartTick: usize = 0xFEC; // int32
        pub const m_nFlashEndTick: usize = 0xFF0; // int32
        pub const m_nFlashMaxAlpha: usize = 0xFF4; // int8
        pub const m_nDeducedLane: usize = 0xFF8; // int32
        pub const m_nSuccessiveDucks: usize = 0xFFC; // int8
        pub const m_flLastDuckTime: usize = 0x1000; // GameTime_t
        pub const m_bDismissedReportCard: usize = 0x1004; // bool
        pub const m_flCurrentHealingAmount: usize = 0x1008; // float32
        pub const m_angLockedEyeAngles: usize = 0x100C; // QAngle
        pub const m_CCitadelAbilityComponent: usize = 0x1018; // CCitadelAbilityComponent
        pub const m_CCitadelHeroComponent: usize = 0x11B8; // CCitadelHeroComponent
        pub const m_flRichPresenceUpdateInterval: usize = 0x1280; // float32
        pub const m_bAnimGraphMovementClipped: usize = 0x1378; // bool
        pub const m_bAnimGraphMovementDisableGravity: usize = 0x1379; // bool
        pub const m_bAnimGraphMovementDirectAirControl: usize = 0x137A; // bool
        pub const m_bLastMoveWasAnimGraph: usize = 0x137B; // bool
        pub const m_flPredTimeSlowedStart: usize = 0x137C; // GameTime_t
        pub const m_flPredTimeSlowedEnd: usize = 0x1380; // GameTime_t
        pub const m_flPredSlowSpeed: usize = 0x1384; // float32
        pub const m_flTimeSlowedStart: usize = 0x1388; // GameTime_t[4]
        pub const m_flTimeSlowedEnd: usize = 0x1398; // GameTime_t[4]
        pub const m_flSlowSpeed: usize = 0x13A8; // float32[4]
        pub const m_flSprintAnimSuppressEndTime: usize = 0x13B8; // GameTime_t
        pub const m_iCurSlowSlot: usize = 0x13BC; // int32
        pub const m_vShootTestOffsetStanding: usize = 0x13C0; // Vector
        pub const m_vShootTestOffsetCrouching: usize = 0x13CC; // Vector
        pub const m_leanStartTime: usize = 0x13D8; // GameTime_t
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Fealty {
        pub const m_hTarget: usize = 0xCA0; // CHandle<C_BaseEntity>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadel_Upgrade_AerialAssualtVData {
        pub const m_WatcherModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_LaunchParticle: usize = 0x15B8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod CCitadel_Ability_StickyBomb {
        pub const m_flBombBonus: usize = 0xCA8; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_UtilityUpgrade_RocketBoosterVData {
        pub const m_LandingParticle: usize = 0x1698; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_AoEPreviewParticle: usize = 0x1778; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DropDownStartParticle: usize = 0x1858; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DropDownStartSound: usize = 0x1938; // CSoundEventName
        pub const m_LandingSound: usize = 0x1948; // CSoundEventName
        pub const m_DebuffModifier: usize = 0x1958; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flSlamEnabledTime: usize = 0x1968; // float32
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CAbility_Mirage_Tornado_VData {
        pub const m_TornadoCastParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CasterModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_WhirlwindEvasionModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_TornadoAura: usize = 0x1660; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_GrenadeTrailModifier: usize = 0x1670; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_cameraSequenceTravelingInTornado: usize = 0x1680; // CitadelCameraOperationsSequence_t
    }
    // Parent: CCitadelBaseYamatoAbility
    // Field count: 2
    pub mod CCitadel_Ability_PowerSlash {
        pub const m_nPowerLevel: usize = 0xCB4; // int32
        pub const m_nCastParticle: usize = 0xCB8; // ParticleIndex_t
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadel_WeaponUpgrade_BurstFire {
        pub const m_nFastFireEndTime: usize = 0xCB8; // GameTime_t
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod C_CitadelTeleportTrigger {
        pub const m_vExitOrigin: usize = 0x9A0; // Vector
    }
    // Parent: C_BaseModelEntity
    // Field count: 74
    pub mod C_BarnLight {
        pub const m_bEnabled: usize = 0x860; // bool
        pub const m_nColorMode: usize = 0x864; // int32
        pub const m_Color: usize = 0x868; // Color
        pub const m_flColorTemperature: usize = 0x86C; // float32
        pub const m_flBrightness: usize = 0x870; // float32
        pub const m_flBrightnessScale: usize = 0x874; // float32
        pub const m_nDirectLight: usize = 0x878; // int32
        pub const m_nBakedShadowIndex: usize = 0x87C; // int32
        pub const m_nLuminaireShape: usize = 0x880; // int32
        pub const m_flLuminaireSize: usize = 0x884; // float32
        pub const m_flLuminaireAnisotropy: usize = 0x888; // float32
        pub const m_LightStyleString: usize = 0x890; // CUtlString
        pub const m_flLightStyleStartTime: usize = 0x898; // GameTime_t
        pub const m_QueuedLightStyleStrings: usize = 0x8A0; // C_NetworkUtlVectorBase<CUtlString>
        pub const m_LightStyleEvents: usize = 0x8B8; // C_NetworkUtlVectorBase<CUtlString>
        pub const m_LightStyleTargets: usize = 0x8D0; // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
        pub const m_StyleEvent: usize = 0x8E8; // CEntityIOOutput[4]
        pub const m_hLightCookie: usize = 0x988; // CStrongHandle<InfoForResourceTypeCTextureBase>
        pub const m_flShape: usize = 0x990; // float32
        pub const m_flSoftX: usize = 0x994; // float32
        pub const m_flSoftY: usize = 0x998; // float32
        pub const m_flSkirt: usize = 0x99C; // float32
        pub const m_flSkirtNear: usize = 0x9A0; // float32
        pub const m_vSizeParams: usize = 0x9A4; // Vector
        pub const m_flRange: usize = 0x9B0; // float32
        pub const m_vShear: usize = 0x9B4; // Vector
        pub const m_nBakeSpecularToCubemaps: usize = 0x9C0; // int32
        pub const m_vBakeSpecularToCubemapsSize: usize = 0x9C4; // Vector
        pub const m_nCastShadows: usize = 0x9D0; // int32
        pub const m_nShadowMapSize: usize = 0x9D4; // int32
        pub const m_nShadowPriority: usize = 0x9D8; // int32
        pub const m_bContactShadow: usize = 0x9DC; // bool
        pub const m_bForceShadowsEnabled: usize = 0x9DD; // bool
        pub const m_nBounceLight: usize = 0x9E0; // int32
        pub const m_flBounceScale: usize = 0x9E4; // float32
        pub const m_flMinRoughness: usize = 0x9E8; // float32
        pub const m_vAlternateColor: usize = 0x9EC; // Vector
        pub const m_fAlternateColorBrightness: usize = 0x9F8; // float32
        pub const m_nFog: usize = 0x9FC; // int32
        pub const m_flFogStrength: usize = 0xA00; // float32
        pub const m_nFogShadows: usize = 0xA04; // int32
        pub const m_flFogScale: usize = 0xA08; // float32
        pub const m_bFogMixedShadows: usize = 0xA0C; // bool
        pub const m_flFadeSizeStart: usize = 0xA10; // float32
        pub const m_flFadeSizeEnd: usize = 0xA14; // float32
        pub const m_flShadowFadeSizeStart: usize = 0xA18; // float32
        pub const m_flShadowFadeSizeEnd: usize = 0xA1C; // float32
        pub const m_bPrecomputedFieldsValid: usize = 0xA20; // bool
        pub const m_vPrecomputedBoundsMins: usize = 0xA24; // Vector
        pub const m_vPrecomputedBoundsMaxs: usize = 0xA30; // Vector
        pub const m_vPrecomputedOBBOrigin: usize = 0xA3C; // Vector
        pub const m_vPrecomputedOBBAngles: usize = 0xA48; // QAngle
        pub const m_vPrecomputedOBBExtent: usize = 0xA54; // Vector
        pub const m_nPrecomputedSubFrusta: usize = 0xA60; // int32
        pub const m_vPrecomputedOBBOrigin0: usize = 0xA64; // Vector
        pub const m_vPrecomputedOBBAngles0: usize = 0xA70; // QAngle
        pub const m_vPrecomputedOBBExtent0: usize = 0xA7C; // Vector
        pub const m_vPrecomputedOBBOrigin1: usize = 0xA88; // Vector
        pub const m_vPrecomputedOBBAngles1: usize = 0xA94; // QAngle
        pub const m_vPrecomputedOBBExtent1: usize = 0xAA0; // Vector
        pub const m_vPrecomputedOBBOrigin2: usize = 0xAAC; // Vector
        pub const m_vPrecomputedOBBAngles2: usize = 0xAB8; // QAngle
        pub const m_vPrecomputedOBBExtent2: usize = 0xAC4; // Vector
        pub const m_vPrecomputedOBBOrigin3: usize = 0xAD0; // Vector
        pub const m_vPrecomputedOBBAngles3: usize = 0xADC; // QAngle
        pub const m_vPrecomputedOBBExtent3: usize = 0xAE8; // Vector
        pub const m_vPrecomputedOBBOrigin4: usize = 0xAF4; // Vector
        pub const m_vPrecomputedOBBAngles4: usize = 0xB00; // QAngle
        pub const m_vPrecomputedOBBExtent4: usize = 0xB0C; // Vector
        pub const m_vPrecomputedOBBOrigin5: usize = 0xB18; // Vector
        pub const m_vPrecomputedOBBAngles5: usize = 0xB24; // QAngle
        pub const m_vPrecomputedOBBExtent5: usize = 0xB30; // Vector
        pub const m_bInitialBoneSetup: usize = 0xB80; // bool
        pub const m_VisClusters: usize = 0xB88; // C_NetworkUtlVectorBase<uint16>
    }
    // Parent: C_BaseEntity
    // Field count: 8
    ...
    pub mod CAbilityIntimidateVData {
        pub const m_EnemyModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DebuffModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_AoEPlayerParticle: usize = 0x1580; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_AoEParticle: usize = 0x1660; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadelModifierVData
    // Field count: 0
    ...
    pub mod CCitadel_MobileResupply {
        ...
        pub const m_bFloating: usize = 0xB0C; // bool
    }
    // Parent: CCitadel_Modifier_BaseEventProc
    // Field count: 0
    ...
    pub mod CitadelAbilityVData {
        ...
        pub const m_bShowTargetingPreviewWhileChanneling: usize = 0xD4; // bool
        pub const m_bShowTargetingPreviewWhileCasting: usize = 0xD5; // bool
        ...
        pub const m_strFlyUpLocString: usize = 0xDD8; // CUtlString
        pub const m_strFlyDownLocString: usize = 0xDE0; // CUtlString
        pub const m_additionalAbilities: usize = 0xDE8; // AdditionalAbilities_t
        pub const m_strCancelAbilityKey: usize = 0xE08; // CUtlString
        pub const m_strSecondaryStatName: usize = 0xE10; // CUtlString
        pub const m_strCastButtonLocToken: usize = 0xE18; // CUtlString
        pub const m_strAltCastButtonLocToken: usize = 0xE20; // CUtlString
        pub const m_cameraSequenceCastStart: usize = 0xE28; // CitadelCameraOperationsSequence_t
        pub const m_bEndCastStartSequenceOnCastComplete: usize = 0xEB0; // bool
        pub const m_cameraSequenceCastComplete: usize = 0xEB8; // CitadelCameraOperationsSequence_t
        pub const m_cameraSequenceChannelStart: usize = 0xF40; // CitadelCameraOperationsSequence_t
        pub const m_bEndChannelStartSequenceOnChannelComplete: usize = 0xFC8; // bool
        pub const m_flCameraPreviewOffset: usize = 0xFCC; // float32
        pub const m_flCameraPreviewDistance: usize = 0xFD0; // float32
        pub const m_flCameraPreviewSpeed: usize = 0xFD4; // float32
        pub const m_previewParticle: usize = 0xFD8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_PreviewPathParticle: usize = 0x10B8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_mapCastEventParticles: usize = 0x1198; // CUtlOrderedMap<AbilityCastEvent_t,CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>>
        pub const m_skillshotHitParticle: usize = 0x11C0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_skillshotMissParticle: usize = 0x12A0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TargetingPreviewParticle: usize = 0x1380; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strSelectedSound: usize = 0x1460; // CSoundEventName
        pub const m_strUnselectedSound: usize = 0x1470; // CSoundEventName
        pub const m_strSelectedLoopSound: usize = 0x1480; // CSoundEventName
        pub const m_strCastSound: usize = 0x1490; // CSoundEventName
        pub const m_strChannelSound: usize = 0x14A0; // CSoundEventName
        pub const m_strChannelLoopSound: usize = 0x14B0; // CSoundEventName
        pub const m_strCastDelaySound: usize = 0x14C0; // CSoundEventName
        pub const m_strCastDelayLoopSound: usize = 0x14D0; // CSoundEventName
        pub const m_strHitConfirmationSound: usize = 0x14E0; // CSoundEventName
        pub const m_strDamageTakenSound: usize = 0x14F0; // CSoundEventName
        pub const m_strAbilityOffCooldownSound: usize = 0x1500; // CSoundEventName
        pub const m_strAbilityChargeReadySound: usize = 0x1510; // CSoundEventName
        pub const m_bPlayMeepMop: usize = 0x1520; // bool
        pub const m_AutoChannelModifier: usize = 0x1528; // CEmbeddedSubclass<CBaseModifier>
        pub const m_AutoCastDelayModifier: usize = 0x1538; // CEmbeddedSubclass<CBaseModifier>
        pub const m_AutoIntrinsicModifiers: usize = 0x1548; // CUtlVector<CEmbeddedSubclass<CBaseModifier>>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_UtilityUpgrade_RocketBooster {
        pub const m_nTargetingParticleIndex: usize = 0xD2C; // ParticleIndex_t
        pub const m_flCastTime: usize = 0xD30; // GameTime_t
        pub const m_bCrashingDown: usize = 0xD34; // bool
        pub const m_bImpulseApplied: usize = 0xD35; // bool
        pub const m_bCanCrash: usize = 0xD36; // bool
        pub const m_vecCrashPosition: usize = 0xD38; // Vector
        pub const m_vecCrashDirection: usize = 0xD44; // Vector
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod CAbilityPowerSlashVData {
        ...
        pub const m_flMaxPowerPadding: usize = 0x156C; // float32
        pub const m_flEffectGroundTrace: usize = 0x1570; // float32
        pub const m_flWhizbyMaxRange: usize = 0x1574; // float32
        pub const m_flStartPosTestCapsuleLength: usize = 0x1578; // float32
        pub const m_flCoverLOSBackDist: usize = 0x157C; // float32
        pub const m_vecLongEffectOffset: usize = 0x1580; // Vector
        pub const m_PowerSlashParticle: usize = 0x1590; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_PowerSlashFullParticle: usize = 0x1670; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ImpactParticle: usize = 0x1750; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CastParticle: usize = 0x1830; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_PowerUpParticle: usize = 0x1910; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strStartSound: usize = 0x19F0; // CSoundEventName
        pub const m_strHitConfirmSound: usize = 0x1A00; // CSoundEventName
        pub const m_strPowerUp1Sounds: usize = 0x1A10; // CSoundEventName
        pub const m_strPowerUp2Sounds: usize = 0x1A20; // CSoundEventName
        pub const m_strPowerUp3Sounds: usize = 0x1A30; // CSoundEventName
        pub const m_strWhizbySound: usize = 0x1A40; // CSoundEventName
        pub const m_strSlashSound: usize = 0x1A50; // CSoundEventName
        pub const m_strSlashFullSound: usize = 0x1A60; // CSoundEventName
        pub const m_SlowModifier: usize = 0x1A70; // CEmbeddedSubclass<CBaseModifier>
    }
    // Parent: CitadelAbilityVData
    // Field count: 3
    pub mod CCitadel_Ability_IceGrenadeVData {
        pub const m_ExplodeParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_IceGrenadeSlowModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ExplosionSound: usize = 0x1650; // CSoundEventName
    }
    // Parent: CitadelItemVData
    // Field count: 1
    pub mod CCitadel_ArmorUpgrade_ReturnFireVData {
        pub const m_ReactiveArmorModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod C_EconEntity {
        pub const m_AttributeManager: usize = 0xCA8; // CAttributeContainer
        pub const m_bClientside: usize = 0xE00; // bool
        pub const m_nDisableMode: usize = 0xE04; // EconEntityParticleDisableMode_t
        pub const m_bParticleSystemsCreated: usize = 0xE08; // bool
        pub const m_bForceDestroyAttachedParticlesImmediately: usize = 0xE09; // bool
        pub const m_vecAttachedParticles: usize = 0xE10; // CUtlVector<C_EconEntity::AttachedParticleInfo_t>
        pub const m_hViewmodelAttachment: usize = 0xE28; // CHandle<CBaseAnimGraph>
        pub const m_iOldTeam: usize = 0xE2C; // int32
        pub const m_bAttachmentDirty: usize = 0xE30; // bool
        pub const m_iOldStyle: usize = 0xE31; // style_index_t
        pub const m_hOldProvidee: usize = 0xE34; // CHandle<C_BaseEntity>
        pub const m_vecAttachedModels: usize = 0xE38; // CUtlVector<C_EconEntity::AttachedModelData_t>
    }
    // Parent: CCitadelModifierAuraVData
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Viper_PetrifyBolaVData {
        pub const m_ExplodeParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SlowModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_PetrifyModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strBolaExplodeSound: usize = 0x1660; // CSoundEventName
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod CCitadel_Ability_ChargedShot {
        pub const m_ChannelParticle: usize = 0xCA0; // ParticleIndex_t
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbilityCadenceAnthemVData {
        pub const m_AnthemAOEModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_StunnedVData
    // Field count: 2
    ...
    pub mod CCitadelHeroLoader {
        pub const m_hero: usize = 0x568; // CUtlSymbolLarge
        pub const m_nLoadSeq: usize = 0x570; // int32
        pub const m_hOwner: usize = 0x574; // CHandle<C_BaseEntity>
    }
    ...
    pub mod C_ParticleSystem {
        pub const m_szSnapshotFileName: usize = 0x860; // char[512]
        pub const m_bActive: usize = 0xA60; // bool
        pub const m_bFrozen: usize = 0xA61; // bool
        pub const m_flFreezeTransitionDuration: usize = 0xA64; // float32
        pub const m_nStopType: usize = 0xA68; // int32
        pub const m_bAnimateDuringGameplayPause: usize = 0xA6C; // bool
        pub const m_iEffectIndex: usize = 0xA70; // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
        pub const m_flStartTime: usize = 0xA78; // GameTime_t
        pub const m_flPreSimTime: usize = 0xA7C; // float32
        pub const m_vServerControlPoints: usize = 0xA80; // Vector[4]
        pub const m_iServerControlPointAssignments: usize = 0xAB0; // uint8[4]
        pub const m_hControlPointEnts: usize = 0xAB4; // CHandle<C_BaseEntity>[64]
        pub const m_bNoSave: usize = 0xBB4; // bool
        pub const m_bNoFreeze: usize = 0xBB5; // bool
        pub const m_bNoRamp: usize = 0xBB6; // bool
        pub const m_bStartActive: usize = 0xBB7; // bool
        ...
        pub const m_bOldActive: usize = 0xDF8; // bool
        pub const m_bOldFrozen: usize = 0xDF9; // bool
    }
    // Parent: CCitadelModifierVData
    // Field count: 8
    ...
    pub mod CAbilityLashUltimateVData {
        pub const m_TargetPreviewParticle: usize = 0x1580; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_LaunchParticle: usize = 0x1660; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_UltimateCastParticle: usize = 0x1740; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_UltimateCastEnemyParticle: usize = 0x1820; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_AllyIndicatorParticle: usize = 0x1900; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strThrowEnemyAnimGraphParam: usize = 0x19E0; // CGlobalSymbol
        pub const m_GrappleEnemyModifier: usize = 0x19E8; // CEmbeddedSubclass<CCitadel_Modifier_LashGrappleEnemy_Debuff>
        pub const m_GrabSound: usize = 0x19F8; // CSoundEventName
        pub const m_MissSound: usize = 0x1A08; // CSoundEventName
        pub const m_ThrowSound: usize = 0x1A18; // CSoundEventName
        pub const m_flAirSpeedMax: usize = 0x1A28; // float32
        pub const m_flFallSpeedMax: usize = 0x1A2C; // float32
        pub const m_flAirDrag: usize = 0x1A30; // float32
        pub const m_flMaxPitchRangeScale: usize = 0x1A34; // float32
        pub const m_flThrowAnimTossPoint: usize = 0x1A38; // float32
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CAbility_Fathom_ReefdwellerHarpoon {
        pub const m_bHitTarget: usize = 0xCA0; // bool
        pub const m_vPrevPos: usize = 0xCA4; // Vector
        pub const m_bBulletFlying: usize = 0xCB0; // bool
        pub const m_bHasLatchedOnce: usize = 0xCB1; // bool
        pub const m_bLatched: usize = 0xCB2; // bool
        pub const m_vHarpoonTarget: usize = 0xCB4; // Vector
        pub const m_flLatchedYaw: usize = 0xCC0; // float32
        pub const m_flCloseEnoughStartTime: usize = 0xCC4; // GameTime_t
        pub const m_flStuckStartTime: usize = 0xCC8; // GameTime_t
        pub const m_flReelStartTime: usize = 0xCCC; // GameTime_t
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 1
    ...
    pub mod CAbilityGarbageVData {
        pub const m_GarbageAuraModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ExplodeParticle: usize = 0x1570; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flAirSpeedMax: usize = 0x1650; // float32
        pub const m_flFallSpeedMax: usize = 0x1654; // float32
        pub const m_flAirDrag: usize = 0x1658; // float32
        pub const m_flMaxMovespeed: usize = 0x165C; // float32
    }
    // Parent: CPlayerPawnComponent
    // Field count: 6
    ...
    pub mod CCitadel_Ability_TangoTether_Trigger {
        pub const m_hBaseAbility: usize = 0xCB4; // CHandle<C_CitadelBaseAbility>
    }
    // Parent: C_BaseModelEntity
    // Field count: 1
    pub mod C_AssignedLaneParticle {
        pub const m_iLane: usize = 0x880; // int32
    }
    // Parent: CitadelAbilityVData
    // Field count: 1
    pub mod CAbilityThumper4VData {
        pub const m_PullAOEModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod C_Citadel_Nano_Predatory_Statue {
        pub const m_hAbility: usize = 0xB10; // CHandle<C_CitadelBaseAbility>
        pub const m_flLifetime: usize = 0xB14; // float32
    }
    // Parent: CCitadel_Modifier_BaseEventProc
    // Field count: 0
    ...
    pub mod CAbilityLashDownStrikeVData {
        pub const m_TargetPreviewParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strGroundCastAnimGraphParam: usize = 0x1640; // CGlobalSymbol
        pub const m_strAirCastAnimGraphParam: usize = 0x1648; // CGlobalSymbol
        pub const m_StompParticle: usize = 0x1650; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_StompLineParticle: usize = 0x1730; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_StompLineObstructedParticle: usize = 0x1810; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_StompImpactParticle: usize = 0x18F0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_StompExplosionSound: usize = 0x19D0; // CSoundEventName
        pub const m_StompEnemyImpactSound: usize = 0x19E0; // CSoundEventName
        pub const m_strFallCollideImpactSound: usize = 0x19F0; // CSoundEventName
        pub const m_DownStrikeModifier: usize = 0x1A00; // CEmbeddedSubclass<CBaseModifier>
        pub const m_ImpactModifier: usize = 0x1A10; // CEmbeddedSubclass<CBaseModifier>
        pub const m_DragModifier: usize = 0x1A20; // CEmbeddedSubclass<CBaseModifier>
        pub const m_flHeightUILingerTime: usize = 0x1A30; // float32
        pub const m_flDamageFrustumHalfWidth: usize = 0x1A34; // float32
        pub const m_flDamageFrustumAngle: usize = 0x1A38; // float32
        pub const m_flDamageWaveSpeed: usize = 0x1A3C; // float32
        pub const m_flDamageTraceProbeDamageRadius: usize = 0x1A40; // float32
        pub const m_flDamageTraceProbeWorldRadius: usize = 0x1A44; // float32
        pub const m_flDamageTraceProbeStepUpHeight: usize = 0x1A48; // float32
        pub const m_flDamageTraceProbeStepDownHeight: usize = 0x1A4C; // float32
        pub const m_flDamageTraceProbeDropDownRate: usize = 0x1A50; // float32
        pub const m_flInitialDamageRadiusInMeters: usize = 0x1A54; // float32
        pub const m_nGroundCrackGap: usize = 0x1A58; // int32
        pub const m_flGroupLengthTolerance: usize = 0x1A5C; // float32
        pub const m_flDamageEffectScaleMin: usize = 0x1A60; // float32
        pub const m_flDamageEffectScaleMax: usize = 0x1A64; // float32
        pub const m_flTrackAmount: usize = 0x1A68; // float32
        pub const m_flCollideRadius: usize = 0x1A6C; // float32
    }
    // Parent: CitadelAbilityVData
    // Field count: 1
    pub mod CCitadel_Ability_ProjectMindVData {
        pub const m_ProjectMindModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CCitadel_Item_BubbleVData {
        ...
        pub const m_CastTargetSound: usize = 0x1688; // CSoundEventName
        pub const m_BubbleModifier: usize = 0x1698; // CEmbeddedSubclass<CBaseModifier>
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod C_CitadelZiplinePath {
        pub const m_iLaneNumber: usize = 0x678; // int32
    }
    // Parent: CitadelAbilityVData
    // Field count: 1
    pub mod CCitadel_Ability_BaseHeldItemVData {
        pub const m_ItemModel: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbilityCadenceGrandFinaleVData {
        pub const m_StageModel: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
        pub const m_flStageModelHeight: usize = 0x1640; // float32
        pub const m_flStageModelWidth: usize = 0x1644; // float32
        pub const m_flStageModelLength: usize = 0x1648; // float32
        pub const m_flStageModelScale: usize = 0x164C; // float32
        pub const m_GrandFinaleAOEModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_Stunned
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Bull_Leap {
        pub const m_flBoostYaw: usize = 0xCA0; // float32
        pub const m_vecCrashPosition: usize = 0xCA4; // Vector
        pub const m_vecCrashDirection: usize = 0xCB0; // Vector
        pub const m_eLeapState: usize = 0xCBC; // ELeapState_t
        pub const m_flStateEnterTime: usize = 0xCC0; // GameTime_t
        pub const m_flNextStateTime: usize = 0xCC8; // CCitadelAutoScaledTime
        pub const m_flBoostEndTime: usize = 0xCE0; // CCitadelAutoScaledTime
        pub const m_vecLastVel: usize = 0xE50; // Vector
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Tier2Boss_RocketBarrage {
        pub const m_nGrenadesLeft: usize = 0xCA0; // int32
    }
    // Parent: C_BaseEntity
    // Field count: 2
    pub mod CPointModifierThinker {
        pub const m_hModifier: usize = 0x568; // CModifierHandleTyped<CCitadelModifier>
        pub const m_bSendToClients: usize = 0x580; // bool
    }
    // Parent: C_BaseModelEntity
    // Field count: 9
    pub mod C_EnvDecal {
        pub const m_hDecalMaterial: usize = 0x860; // CStrongHandle<InfoForResourceTypeIMaterial2>
        pub const m_flWidth: usize = 0x868; // float32
        pub const m_flHeight: usize = 0x86C; // float32
        pub const m_flDepth: usize = 0x870; // float32
        pub const m_nRenderOrder: usize = 0x874; // uint32
        pub const m_bProjectOnWorld: usize = 0x878; // bool
        pub const m_bProjectOnCharacters: usize = 0x879; // bool
        pub const m_bProjectOnWater: usize = 0x87A; // bool
        pub const m_flDepthSortBias: usize = 0x87C; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod C_AI_BaseNPC {
        pub const m_NPCState: usize = 0xD20; // NPC_STATE
        pub const m_bFadeCorpse: usize = 0xD24; // bool
        pub const m_bImportantRagdoll: usize = 0xD25; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod CCitadel_Upgrade_OverdriveClip_VData {
        pub const m_OverdriveClipModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ReloadModifier: usize = 0x15B8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifierVData
    // Field count: 3
    ...
    pub mod CAbility_Synth_Barrage {
        pub const m_nProjectilesScheduled: usize = 0xF08; // int32
        pub const m_ChannelParticle: usize = 0xF0C; // ParticleIndex_t
        pub const m_flNextShootTime: usize = 0xF10; // GameTime_t
    }
    // Parent: CitadelAbilityVData
    // Field count: 3
    pub mod CAbilityWreckerUltimateVData {
        pub const m_BeamParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ChargeParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ActiveModifier: usize = 0x1720; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_BaseBulletPreRollProc
    // Field count: 0
    ...
    pub mod CCitadel_Ability_TurretClone {
        pub const m_flTurretExpireTime: usize = 0xDB8; // GameTime_t
        pub const m_bTeleported: usize = 0xDC0; // bool
        pub const m_bHasTurretReady: usize = 0xDC1; // bool
        pub const m_iCurrentSwapCount: usize = 0xDC4; // int32
        pub const m_vecTurretPosition: usize = 0xDC8; // Vector
        pub const m_nFXIndex: usize = 0xDD4; // ParticleIndex_t
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbilityCadenceCrescendoVData {
        pub const m_CrescendoAOEModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifierAura>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    pub mod CCitadel_Ability_Operative_Scattercharge {}
    // Parent: CCitadelModifierVData
    // Field count: 0
    ...
    pub mod CCitadel_Ability_UltCombo {
        pub const m_flLastAttackTime: usize = 0xCA0; // GameTime_t
        pub const m_nAttackNum: usize = 0xCA4; // int32
        pub const m_iBonusHealth: usize = 0xD50; // int32
        pub const m_hTarget: usize = 0xD54; // CHandle<C_BaseEntity>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod C_CitadelBoomerangProjectile {
        pub const m_bReturning: usize = 0x8E8; // bool
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    // Field count: 1
    pub mod C_BaseDoor {
        pub const m_bIsUsable: usize = 0x860; // bool
    }
    // Parent: C_CitadelProjectile
    // Field count: 1
    pub mod C_Citadel_Projectile_Bebop_Hook {
        pub const m_iChainEffect: usize = 0x8E8; // ParticleIndex_t
    }
    // Parent: CCitadel_Item
    // Field count: 1
    pub mod CCitadel_WeaponUpgrade_GlassCannon {
        pub const m_nKillsEarned: usize = 0xCB8; // int32
    }
    // Parent: C_BaseClientUIEntity
    // Field count: 2
    pub mod C_PointClientUIDialog {
        pub const m_hActivator: usize = 0x890; // CHandle<C_BaseEntity>
        pub const m_bStartEnabled: usize = 0x894; // bool
    }
    // Parent: CitadelAbilityVData
    // Field count: 3
    pub mod CCitadel_Ability_Trapper_SpiderJar_VData {
        pub const m_SpiderExplodeParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_JarExplodeParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SpiritStealDebuffModifier: usize = 0x1720; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_StatStealBaseVData
    // Field count: 1
    ...
    pub mod CAbilityRollingFireBallVData {
        pub const m_flBallLifetime: usize = 0x1560; // float32
        pub const m_flBallStepUpHeight: usize = 0x1564; // float32
        pub const m_flBallDistAboveGround: usize = 0x1568; // float32
        pub const m_flBallFloatDownRate: usize = 0x156C; // float32
        pub const m_flBallSpeed: usize = 0x1570; // float32
        pub const m_flBallTraceRadius: usize = 0x1574; // float32
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 3
    pub mod CCitadel_Ability_Hook {
        pub const m_hHookVictim: usize = 0xCA0; // CHandle<C_BaseEntity>
        pub const m_hProjectile: usize = 0xCA4; // CHandle<C_BaseEntity>
        pub const m_vecHookTargetStartPos: usize = 0xCA8; // Vector
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadelZipLineNode {
        pub const m_vecConnections: usize = 0x8A0; // C_NetworkUtlVectorBase<CHandle<CCitadelZipLineNode>>
        pub const m_eCaptureState: usize = 0x8B8; // int16
        pub const m_iPrimaryLane: usize = 0x8BA; // int16
        pub const m_nRopesParity: usize = 0x8BC; // int16
        pub const m_bCornerNode: usize = 0x8BE; // bool
        pub const m_bCapturable: usize = 0x8BF; // bool
        pub const m_bAlwaysUsable: usize = 0x8C0; // bool
        pub const m_bOneWay: usize = 0x8C1; // bool
        pub const m_bDisableZippingToByPlayers: usize = 0x8C2; // bool
        pub const m_bUseForMinimapDrawing: usize = 0x8C3; // bool
        pub const m_hGuardingBoss: usize = 0x8C4; // CHandle<C_BaseEntity>
        pub const m_flRopeRadius: usize = 0x8C8; // float32
        pub const m_bEnabled: usize = 0x8CC; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 3
    ...
    pub mod CAbility_Synth_Affliction_VData {
        ...
        pub const m_CastParticle: usize = 0x1650; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 7
    pub mod CCitadel_Ability_Tokamak_HeatSinks_Inherent {
        pub const m_nIntervalsElapsed: usize = 0xCA0; // int32
        pub const m_NextShotTime: usize = 0xCA4; // GameTime_t
        pub const m_flDissipationRate: usize = 0xCA8; // float32
        pub const m_flDissipationTime: usize = 0xCAC; // GameTime_t
        pub const m_flHeatTime: usize = 0xCB0; // GameTime_t
        pub const m_flOverheatSoundTime: usize = 0xCB4; // GameTime_t
        pub const m_bOverheating: usize = 0xCB8; // bool
    }
    // Parent: CitadelAbilityVData
    // Field count: 2
    pub mod CCitadel_Ability_Viper_Ability04VData {
        pub const m_ExplodeParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_PetrifyModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Tokamak_HotShot {
        pub const m_flDPS: usize = 0xE18; // float32
        pub const m_flNextDamageTick: usize = 0xE1C; // GameTime_t
        pub const m_vStart: usize = 0xE20; // Vector
        pub const m_vEnd: usize = 0xE2C; // Vector
        pub const m_vecEntitiesHit: usize = 0xE38; // CUtlVector<CHandle<C_BaseEntity>>
        pub const m_angBeamAngles: usize = 0xE50; // QAngle
        pub const m_bNeedsBeamReset: usize = 0xE68; // bool
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CCitadel_UtilityUpgrade_AOESmokeBombVData {
        pub const m_CastCompleteParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strBuffGainedSound: usize = 0x1688; // CSoundEventName
        pub const m_InvisModifier: usize = 0x1698; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CitadelItemVData
    // Field count: 10
    pub mod CItem_WarpStone_VData {
        pub const m_CasterModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_CasterDebuffModifier: usize = 0x15B8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strExplodeSound: usize = 0x15C8; // CSoundEventName
        pub const m_CastDelayParticle: usize = 0x15D8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TeleportTrailParticle: usize = 0x16B8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flGroundProbeSpeed: usize = 0x1798; // float32
        pub const m_flGroundStepDown: usize = 0x179C; // float32
        pub const m_flGroundStepUp: usize = 0x17A0; // float32
        pub const m_iMaxGroundIterations: usize = 0x17A4; // int32
        pub const m_flVelocityScale: usize = 0x17A8; // float32
    }
    // Parent: CCitadel_Modifier_BaseEventProc
    // Field count: 0
    ...
    pub mod CAbilityTokamakHotShotVData {
        pub const m_LaserModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strLaserStartSound: usize = 0x1570; // CSoundEventName
        pub const m_strLaserEndSound: usize = 0x1580; // CSoundEventName
        pub const m_strLaserLoopSound: usize = 0x1590; // CSoundEventName
        pub const m_strLaserHitSound: usize = 0x15A0; // CSoundEventName
        pub const m_ChargeParticle: usize = 0x15B0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_BeamParticle: usize = 0x1690; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_HitParticle: usize = 0x1770; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_GroundParticle: usize = 0x1850; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 1
    pub mod CCitadel_Ability_LifeDrain {
        pub const m_tDrainLifeStopTime: usize = 0xCA0; // GameTime_t
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 1
    pub mod CCitadel_Ability_StormCloud {
        pub const m_flFloat: usize = 0xD10; // float32
    }
    // Parent: CCitadel_Modifier_BaseEventProcVData
    // Field count: 4
    ...
    pub mod FilterDamageType {
        pub const m_iDamageType: usize = 0x5C0; // int32
    }
    // Parent: CCitadelModifierAura
    // Field count: 0
    ...
    // Parent: CitadelAbilityVData
    // Field count: 0
    pub mod CCitadel_Ability_Operative_ScatterCharge_VData {}
    // Parent: C_CitadelBaseAbility
    // Field count: 2
    ...
    pub mod CCitadel_Ability_Burrow {
        pub const m_bInGround: usize = 0xD80; // bool
        pub const m_SpinEndTime: usize = 0xD84; // GameTime_t
        pub const m_nBurrowEffect: usize = 0xD88; // ParticleIndex_t
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Item_Disarm_VData {
        pub const m_BuffModifier: usize = 0x16A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DebuffModifier: usize = 0x16B8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CScaleFunctionBase
    // Field count: 0
    ...
    pub mod CCitadel_WeaponUpgrade_WeaponEater {
        pub const m_nWeaponPower: usize = 0xD98; // int32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Hornet_Snipe {
        pub const m_flScopeStartTime: usize = 0xF54; // GameTime_t
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Shiv_KillingBlow {
        pub const m_bActive: usize = 0xE60; // bool
        pub const m_hCurrentTarget: usize = 0xE64; // CHandle<C_BaseEntity>
        pub const m_vStartPosition: usize = 0xE68; // Vector
        pub const m_vDeparturePosition: usize = 0xE74; // Vector
        pub const m_flDepartureTime: usize = 0xE80; // CCitadelAutoScaledTime
        pub const m_flArrivalTime: usize = 0xE98; // CCitadelAutoScaledTime
        pub const m_vLastKnownSafePos: usize = 0xEB0; // Vector
        pub const m_flDrainSuppressEndTime: usize = 0xEC0; // GameTime_t
    }
    // Parent: CitadelAbilityVData
    // Field count: 3
    pub mod CAbilityWreckerSalvageVData {
        pub const m_SalvageEnemyModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_StunEnemyModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_BuffModifier: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifierVData
    // Field count: 4
    ...
    pub mod CCitadel_Ability_RocketBarrage {
        pub const m_flCurrentTimeScale: usize = 0xE98; // float32
        pub const m_vecAimPos: usize = 0xE9C; // Vector
        pub const m_vecAimVel: usize = 0xEA8; // Vector
        pub const m_flLastUpdateTime: usize = 0xEB4; // GameTime_t
    }
    // Parent: CitadelAbilityVData
    // Field count: 2
    ...
    pub mod CCitadel_WeaponUpgrade_InstantReload {
        pub const m_bIsManualReloading: usize = 0xCB8; // bool
    }
    // Parent: CCitadelModifierAura
    // Field count: 0
    ...
    pub mod CAbilityTokamakBreachVData {
        pub const m_AllySmokeAOEModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_EnemySmokeAOEModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_PurgeParticle: usize = 0x1580; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CitadelAbilityVData
    // Field count: 1
    pub mod CAbilityTokamakHeatSinksVData {
        pub const m_HeatDotModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_FlameDashVData {
        pub const m_FlameDashModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DashBurstSound: usize = 0x1570; // CSoundEventName
        pub const m_ChargeHitSound: usize = 0x1580; // CSoundEventName
        pub const m_cameraSpeedBoost: usize = 0x1590; // CitadelCameraOperationsSequence_t
    }
    // Parent: CitadelAbilityVData
    // Field count: 7
    pub mod CCitadel_Ability_PrimaryWeaponVData {
        pub const m_DOFWhileZoomed: usize = 0x1560; // DOFDesc_t
        pub const m_bDOFFarSettingsAreOffsetByGunRange: usize = 0x1570; // bool
        pub const m_sDisarmedSound: usize = 0x1578; // CSoundEventName
        pub const m_flMinDisarmedSoundInterval: usize = 0x1588; // float32
        pub const m_sObstructedShotSound: usize = 0x1590; // CSoundEventName
        pub const m_flActionReloadTimingStart: usize = 0x15A0; // float32
        pub const m_flActionReloadTimingDuration: usize = 0x15A4; // float32
    }
    // Parent: CCitadel_Modifier_BaseEventProc
    // Field count: 0
    ...
    pub mod C_EnvParticleGlow {
        pub const m_flAlphaScale: usize = 0xE10; // float32
        pub const m_flRadiusScale: usize = 0xE14; // float32
        pub const m_flSelfIllumScale: usize = 0xE18; // float32
        pub const m_ColorTint: usize = 0xE1C; // Color
        pub const m_hTextureOverride: usize = 0xE20; // CStrongHandle<InfoForResourceTypeCTextureBase>
    }
    // Parent: C_BaseEntity
    // Field count: 15
    ...
    pub mod CCitadel_Ability_SettingSun {
        pub const m_TargetPreviews: usize = 0xCA0; // CUtlVector<ParticleIndex_t>
        pub const m_bWasSelected: usize = 0xD68; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_ArmorUpgrade_RegenerativeArmorVData {
        pub const m_RegenModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_BaseEventProc
    // Field count: 1
    ...
    pub mod CAI_CitadelNPCVData {
        pub const m_sAG2VariationName: usize = 0x398; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCNmGraphVariation>>
        pub const m_mapBoundAbilities: usize = 0x478; // CUtlOrderedMap<EAbilitySlots_t,CSubclassName<4>>
        pub const m_flSightRangePlayers: usize = 0x4A0; // float32
        pub const m_flSightRangeNPCs: usize = 0x4A4; // float32
        pub const m_MeleeAnimName: usize = 0x4A8; // CGlobalSymbol
        pub const m_flMeleeAttemptRange: usize = 0x4B0; // float32
        pub const m_flMeleeHitRange: usize = 0x4B4; // float32
        pub const m_MeleeAttackPoints: usize = 0x4B8; // CUtlVector<float32>
        pub const m_flMaxHealthBarDrawDistance: usize = 0x4D0; // float32
        pub const m_flWalkSpeed: usize = 0x4D4; // float32
        pub const m_flRunSpeed: usize = 0x4D8; // float32
        pub const m_flTurnRate: usize = 0x4DC; // float32
        pub const m_flAcceleration: usize = 0x4E0; // float32
        pub const m_flStepHeight: usize = 0x4E4; // float32
        pub const m_navHull: usize = 0x4E8; // int8
        pub const m_BeamStartSound: usize = 0x4F0; // CSoundEventName
        pub const m_BeamStopSound: usize = 0x500; // CSoundEventName
        pub const m_BeamPointStartLoopSound: usize = 0x510; // CSoundEventName
        pub const m_BeamPointEndLoopSound: usize = 0x520; // CSoundEventName
        pub const m_BeamPointClosestLoopSound: usize = 0x530; // CSoundEventName
        pub const m_strAmbientLoopSound: usize = 0x540; // CSoundEventName
        pub const m_DeathSound: usize = 0x550; // CSoundEventName
        pub const m_strLastHitSound: usize = 0x560; // CSoundEventName
        pub const m_bPlayLastHitSound: usize = 0x570; // bool
        pub const m_MeleeHitSound: usize = 0x578; // CSoundEventName
        pub const m_MeleeHitPlayerSound: usize = 0x588; // CSoundEventName
        pub const m_sDefaultMaterialGroupName: usize = 0x598; // CUtlString
        pub const m_sEnemyMaterialGroupName: usize = 0x5A0; // CUtlString
        pub const m_sTeam1MaterialGroupName: usize = 0x5A8; // CUtlString
        pub const m_sTeam2MaterialGroupName: usize = 0x5B0; // CUtlString
        pub const m_MeleeSwingParticle: usize = 0x5B8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_MeleeActivateParticle: usize = 0x698; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flModelScale: usize = 0x778; // float32
        pub const m_DeathParticle: usize = 0x780; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_HealthBarParticle: usize = 0x860; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_sHealthBarAttachment: usize = 0x940; // CUtlString
        pub const m_HealthBarColorFriend: usize = 0x948; // Color
        pub const m_HealthBarColorEnemy: usize = 0x94C; // Color
        pub const m_HealthBarColorTeam1: usize = 0x950; // Color
        pub const m_HealthBarColorTeam2: usize = 0x954; // Color
        pub const m_HealthBarColorTeamNeutral: usize = 0x958; // Color
        pub const m_flHealthBarOffset: usize = 0x95C; // float32
        pub const m_bSpawnBreakablesOnDeath: usize = 0x960; // bool
        pub const m_flBreakableForceScale: usize = 0x964; // float32
        pub const m_flPhysicsImpulseMultiplier: usize = 0x968; // float32
        pub const m_flBeamWeaponWidth: usize = 0x96C; // float32
        pub const m_flBeamTurnRate: usize = 0x970; // float32
        pub const m_BeamWeaponParticle: usize = 0x978; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_WeaponInfo: usize = 0xA58; // CCitadelWeaponInfo
    }
    // Parent: CCitadelModifierAuraVData
    // Field count: 1
    ...
    pub mod CCitadel_UtilityUpgrade_HealthNova_VData {
        pub const m_HealingModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod CNPC_ShieldedSentryVData {
        ...
        pub const m_flMinLifetime: usize = 0x35C; // float32
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod CAbilityImmobilizeTrapVData {
        pub const m_ExplodeParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_PreviewRingParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TrapHighlightParticle: usize = 0x1720; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ArmedParticle: usize = 0x1800; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strTripSound: usize = 0x18E0; // CSoundEventName
        pub const m_strExplodeSound: usize = 0x18F0; // CSoundEventName
        pub const m_strExpiredSound: usize = 0x1900; // CSoundEventName
        pub const m_strImmobilizeTargetSound: usize = 0x1910; // CSoundEventName
        pub const m_strArmingSound: usize = 0x1920; // CSoundEventName
        pub const m_TetherModifier: usize = 0x1930; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DebuffModifier: usize = 0x1940; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SlowModifier: usize = 0x1950; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 2
    pub mod CCitadel_Ability_FireBomb {
        pub const m_flDetonateTime: usize = 0xD18; // CCitadelAutoScaledTime
    ...
    // Field count: 18
    pub mod C_Sun {
        pub const m_fxSSSunFlareEffectIndex: usize = 0x860; // ParticleIndex_t
        pub const m_fxSunFlareEffectIndex: usize = 0x864; // ParticleIndex_t
        pub const m_fdistNormalize: usize = 0x868; // float32
        pub const m_vSunPos: usize = 0x86C; // Vector
        pub const m_vDirection: usize = 0x878; // Vector
        pub const m_iszEffectName: usize = 0x888; // CUtlSymbolLarge
        pub const m_iszSSEffectName: usize = 0x890; // CUtlSymbolLarge
        pub const m_clrOverlay: usize = 0x898; // Color
        pub const m_bOn: usize = 0x89C; // bool
        pub const m_bmaxColor: usize = 0x89D; // bool
        pub const m_flSize: usize = 0x8A0; // float32
        pub const m_flHazeScale: usize = 0x8A4; // float32
        pub const m_flRotation: usize = 0x8A8; // float32
        pub const m_flHDRColorScale: usize = 0x8AC; // float32
        pub const m_flAlphaHaze: usize = 0x8B0; // float32
        pub const m_flAlphaScale: usize = 0x8B4; // float32
        pub const m_flAlphaHdr: usize = 0x8B8; // float32
        pub const m_flFarZScale: usize = 0x8BC; // float32
    }
    // Parent: CitadelAbilityVData
    // Field count: 12
    pub mod CCitadel_Ability_Shiv_KillingBlowVData {
        pub const m_LeapModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ActiveBuff: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_KillableModifier: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_AttackParticle: usize = 0x1590; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ImpactParticle: usize = 0x1670; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_FlashParticle: usize = 0x1750; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_KillingBlowCastParticle: usize = 0x1830; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ChargeUpSound: usize = 0x1910; // CSoundEventName
        pub const m_OnKillSound: usize = 0x1920; // CSoundEventName
        pub const m_flPreArrivalAttackStartTime: usize = 0x1930; // float32
        pub const m_flKillableGlowRange: usize = 0x1934; // float32
        pub const m_flGlowMinTime: usize = 0x1938; // float32
    }
    // Parent: CCitadelBaseShivAbility
    // Field count: 8
    pub mod CCitadel_Ability_ShivDash {
        pub const m_vStartPosition: usize = 0xCA0; // Vector
        pub const m_vDashDirection: usize = 0xCAC; // Vector
        pub const m_bIsDashing: usize = 0xCB8; // bool
        pub const m_bStartedInAir: usize = 0xCB9; // bool
        pub const m_vecHitEnemies: usize = 0xCC0; // CUtlVector<CEntityIndex>
        pub const m_vecLastPosition: usize = 0xCD8; // Vector
        pub const m_nReductionsLeft: usize = 0xCE4; // int32
        pub const m_flStuckTime: usize = 0xF18; // GameTime_t
    }
    ...
    // Parent: CCitadelModifier
    // Field count: 0
    pub mod CCitadel_Modifier_Skirmish_Passive_Gold {}
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod C_ColorCorrectionVolume {
        pub const m_LastEnterWeight: usize = 0x9A0; // float32
        pub const m_LastEnterTime: usize = 0x9A4; // GameTime_t
        pub const m_LastExitWeight: usize = 0x9A8; // float32
        pub const m_LastExitTime: usize = 0x9AC; // GameTime_t
        pub const m_bEnabled: usize = 0x9B0; // bool
        pub const m_MaxWeight: usize = 0x9B4; // float32
        pub const m_FadeDuration: usize = 0x9B8; // float32
        pub const m_Weight: usize = 0x9BC; // float32
        pub const m_lookupFilename: usize = 0x9C0; // char[512]
    }
    // Parent: C_BaseModelEntity
    // Field count: 0
    ...
    // Parent: CCitadel_Modifier_Intrinsic_Base
    // Field count: 2
    pub mod CModifier_Operative_Scattercharge_Projectile {
    ...
    pub mod CCitadel_Ability_IceBeam {
        pub const m_flNextDamageTick: usize = 0x12B8; // GameTime_t
        pub const m_vStart: usize = 0x12BC; // Vector
        pub const m_vEnd: usize = 0x12C8; // Vector
        pub const m_vecEntitiesHit: usize = 0x1310; // CUtlVector<CHandle<C_BaseEntity>>
        pub const m_vBeamAimPos: usize = 0x1328; // Vector
        pub const m_angBeamAngles: usize = 0x1338; // QAngle
        pub const m_bNeedsBeamReset: usize = 0x1350; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Item_ComboBreakerVData {
        pub const m_ComboBreakerModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_HealModifier: usize = 0x15B8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Item_RescueBeam {
        pub const m_bCanPull: usize = 0xCB8; // bool
    }
    // Parent: CitadelAbilityVData
    // Field count: 1
    pub mod CAbilityCadenceLullabyVData {
        pub const m_SleepAOEModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_WeaponUpgrade_SurgingPowerVData {
        pub const m_ModifierSurgingPower: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_CastTargetEffect: usize = 0x15B8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod C_Citadel_Shield {
        pub const m_bAllowRotatingUp: usize = 0x868; // bool
        pub const m_bFixedPosition: usize = 0x869; // bool
        pub const m_flShieldOffset: usize = 0x86C; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_SettingSun_VData {
        pub const m_BeamTargetParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_UnitTargetParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SettingSunThinkerModifier: usize = 0x1720; // CEmbeddedSubclass<CBaseModifier>
        pub const m_flSSCameraPreviewOffset: usize = 0x1730; // float32
        pub const m_flSSCameraPreviewSpeed: usize = 0x1734; // float32
        pub const m_flSSCameraPreviewDistance: usize = 0x1738; // float32
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CAbilityWreckingBallVData {
        pub const m_SummonParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SummonReadyParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SummonParticleAttachment: usize = 0x1720; // CUtlString
        pub const m_ExplodeParticle: usize = 0x1728; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_AutoThrowModifier: usize = 0x1808; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_HoldingBallLoop: usize = 0x1818; // CSoundEventName
    }
    // Parent: CCitadelModifier
    // Field count: 2
    ...
    // Field count: 3
    pub mod C_OmniLight {
        pub const m_flInnerAngle: usize = 0xBA8; // float32
        pub const m_flOuterAngle: usize = 0xBAC; // float32
        pub const m_bShowLight: usize = 0xBB0; // bool
    }
    // Parent: CCitadel_Modifier_ScalingPowerUp
    // Field count: 0
    ...
    pub mod CCitadel_Projectile_MagicBolt {
        pub const bIsCloneProjectile: usize = 0x8E8; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 6
    ...
    pub mod CCitadel_Ability_ShieldedSentry_VData {
        pub const m_InnateModifier: usize = 0x1560; // CEmbeddedSubclass<CBaseModifier>
        pub const m_DebuffModifier: usize = 0x1570; // CEmbeddedSubclass<CBaseModifier>
        pub const m_flDamageFalloffEndScale: usize = 0x1580; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbility_Synth_PlasmaFlux {
        pub const m_bTeleported: usize = 0xCB0; // bool
        pub const m_flProjectileLaunchTime: usize = 0xCB4; // GameTime_t
        pub const m_flProjectileExpireTime: usize = 0xCB8; // GameTime_t
        pub const m_hActiveProjectile: usize = 0xCBC; // CHandle<C_BaseEntity>
    }
    // Parent: CCitadelModifierVData
    // Field count: 4
    ...
    pub mod CCitadel_Ability_ShivWeapon_VData {
        pub const m_flPushForce: usize = 0x15A8; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 4
    ...
    pub mod CFilterClass {
        pub const m_iFilterClass: usize = 0x5C0; // CUtlSymbolLarge
    }
    // Parent: CitadelAbilityVData
    // Field count: 6
    pub mod CCitadel_Ability_Magician_BigBoltVData {
        ...
        pub const m_ShootDelayParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CasterModifier: usize = 0x1720; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_BoltHitModifier: usize = 0x1730; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strBoltDelay: usize = 0x1740; // CSoundEventName
        pub const m_strBoltFire: usize = 0x1750; // CSoundEventName
    }
    // Parent: CitadelAbilityVData
    // Field count: 0
    ...
    pub mod CNPC_TrooperBossVData {
        pub const m_bMitigateDamageFromPlayers: usize = 0x17B8; // bool
        pub const m_flPlayerAutoAttackRange: usize = 0x17BC; // float32
        pub const m_flMinMeleeAttackTime: usize = 0x17C0; // float32
        pub const m_flInvulRange: usize = 0x17C4; // float32
        pub const m_sAngryStart: usize = 0x17C8; // CSoundEventName
        pub const m_sAngryLoop: usize = 0x17D8; // CSoundEventName
        pub const m_sAngryStop: usize = 0x17E8; // CSoundEventName
    }
    // Parent: CBaseFilter
    // Field count: 0
    pub mod CFilterLOS {}
    ...
    pub mod CAbilityTokamakRadianceVData {
        pub const m_RadianceModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CitadelAbilityVData
    // Field count: 4
    pub mod CCitadel_Ability_Gunslinger_DemonCarbineVData {
        ...
        pub const m_ChargingModifier: usize = 0x1568; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DebuffModifier: usize = 0x1578; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_cameraDemonCarbineShotFired: usize = 0x1588; // CitadelCameraOperationsSequence_t
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 1
    pub mod CCitadel_Ability_Perched_Predator {
        pub const m_hActiveProjectile: usize = 0xCA0; // CHandle<C_BaseEntity>
    }
    // Parent: None
    // Field count: 5
    ...
    pub mod CAbilityMeleeParryVData {
        pub const m_flWhiffDuration: usize = 0x1560; // float32
        pub const m_flMovementRestrictionTime: usize = 0x1564; // float32
        pub const m_flActiveTime: usize = 0x1568; // float32
        pub const m_flParryEndVisualTime: usize = 0x156C; // float32
        pub const m_flSuccessActiveTime: usize = 0x1570; // float32
        pub const m_flBossVictimNoMeleeTime: usize = 0x1574; // float32
        pub const m_flBossVictimCalmTime: usize = 0x1578; // float32
        pub const m_SuccessfulParryParticle: usize = 0x1580; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strSuccessfulParrySound: usize = 0x1660; // CSoundEventName
        pub const m_ParryActiveModifier: usize = 0x1670; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ParryVictimModifier: usize = 0x1680; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ParryCooldownModifier: usize = 0x1690; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ParryEndVisualModifier: usize = 0x16A0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ParryBossVictimNoMeleeModifier: usize = 0x16B0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ParryBossVictimCalmModifier: usize = 0x16C0; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CBaseAnimGraph
    // Field count: 1
    pub mod C_Citadel_BreakableProp {
        pub const m_nHitIndex: usize = 0xB00; // int32
    }
    // Parent: CCitadel_Modifier_BaseBulletPreRollProc
    // Field count: 1
    ...
    pub mod CCitadel_Ability_FlyingStrike {
        pub const m_desatVolIdx: usize = 0xCB8; // SatVolumeIndex_t
        pub const m_bShadowFormCast: usize = 0xCBC; // bool
        pub const m_vYamatoCastPos: usize = 0xCC0; // Vector
        pub const m_vTargetCastPos: usize = 0xCCC; // Vector
        pub const m_flFlyingToTargetStartTime: usize = 0xCD8; // GameTime_t
        pub const m_flEndAttackTime: usize = 0xCDC; // GameTime_t
        pub const m_flGrappleStartTime: usize = 0xCE0; // GameTime_t
        pub const m_flGrappleArriveTime: usize = 0xCE4; // GameTime_t
        pub const m_flAttackLatchTime: usize = 0xCE8; // GameTime_t
        pub const m_vAttackLatchPos: usize = 0xCEC; // Vector
        pub const m_hTarget: usize = 0xCF8; // CHandle<C_BaseEntity>
        pub const m_flGrappleShotAttackTime: usize = 0xCFC; // GameTime_t
        pub const m_rgPath: usize = 0xD04; // Vector[20]
        pub const m_nPathIdx: usize = 0xDF4; // int32
        pub const m_nPathSize: usize = 0xDF8; // int32
        pub const m_flPathLength: usize = 0xDFC; // float32
        pub const m_vFlyingInitialOffsetToPath: usize = 0xE00; // Vector
        pub const flDistFlown: usize = 0xE0C; // float32
        pub const m_vLastSafePos: usize = 0xE10; // Vector
        pub const m_nGrappleTravelEffect: usize = 0xEC8; // ParticleIndex_t
        pub const m_bPathDirty: usize = 0xF20; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 2
    ...
    pub mod CCitadel_WeaponUpgrade_WeaponEaterVData {
        pub const m_WeaponEaterTracker: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    ...
    pub mod CItemAOERootVData {
        pub const m_AOEParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strRootTargetSound: usize = 0x1688; // CSoundEventName
        pub const m_TetherModifier: usize = 0x1698; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CitadelItemVData
    // Field count: 3
    pub mod CCitadel_Item_TrackingProjectileApplyModifierVData {
        pub const m_ProjectileImpactParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TargetModifier: usize = 0x1688; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_FriendlyOnlyModifier: usize = 0x1698; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: C_CitadelTrackedProjectile
    // Field count: 1
    pub mod CCitadel_Projectile_HookBlade {
        pub const bIsReturning: usize = 0x8E8; // bool
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CCitadel_Ability_VoidSphereVData {
        ...
        pub const m_strAllyPositionPreview: usize = 0x1650; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadelCatapultTrigger {
        pub const m_vLaunchTarget: usize = 0x9A0; // Vector
        pub const m_flLaunchSpeed: usize = 0x9AC; // float32
        pub const m_nameTarget: usize = 0x9B0; // CUtlSymbolLarge
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod C_FuncLadder {
        pub const m_vecLadderDir: usize = 0x860; // Vector
        pub const m_Dismounts: usize = 0x870; // CUtlVector<CHandle<C_InfoLadderDismount>>
        pub const m_vecLocalTop: usize = 0x888; // Vector
        pub const m_vecPlayerMountPositionTop: usize = 0x894; // Vector
        pub const m_vecPlayerMountPositionBottom: usize = 0x8A0; // Vector
        pub const m_flAutoRideSpeed: usize = 0x8AC; // float32
        pub const m_bDisabled: usize = 0x8B0; // bool
        pub const m_bFakeLadder: usize = 0x8B1; // bool
        pub const m_bHasSlack: usize = 0x8B2; // bool
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod CCitadel_Modifier_Trapper_SpiderShield {
        pub const m_flNextPulseTime: usize = 0xC0; // GameTime_t
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Operative_Blindside_VData {
        pub const m_EnemyDebuffModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ExplodeParticle: usize = 0x1570; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ExplosionSound: usize = 0x1650; // CSoundEventName
    }
    // Parent: CCitadelModifier
    ...
    pub mod CCitadel_Ability_ZipLineBoost_VData {
        pub const m_ZipboostModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flTimeToActivate: usize = 0x1570; // float32
        pub const m_flTimeForHint: usize = 0x1574; // float32
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 10
    pub mod CCitadel_Ability_SuperNeutralCharge {
        pub const m_bPreparing: usize = 0xE60; // bool
        pub const m_bTackling: usize = 0xE61; // bool
        pub const m_flTackleStartTime: usize = 0xE64; // GameTime_t
        pub const m_flTackleDuration: usize = 0xE68; // float32
        pub const m_vecTackleDir: usize = 0xE6C; // Vector
        pub const m_vecLastPosition: usize = 0xE78; // Vector
        pub const m_nStuckFramesCount: usize = 0xE84; // int32
        pub const m_vecHitEnemies: usize = 0xE88; // CUtlVector<CEntityIndex>
        pub const m_flPrepareStartTime: usize = 0xEA0; // GameTime_t
        pub const m_nDistancePreview: usize = 0xEA4; // ParticleIndex_t
    }
    // Parent: None
    // Field count: 3
    ...
    pub mod CCitadel_Item_Bubble {
        pub const m_flEndTime: usize = 0xCB8; // GameTime_t
    }
    // Parent: C_BaseEntity
    // Field count: 37
    pub mod C_EnvVolumetricFogController {
        pub const m_flScattering: usize = 0x568; // float32
        pub const m_TintColor: usize = 0x56C; // Color
        pub const m_flAnisotropy: usize = 0x570; // float32
        pub const m_flFadeSpeed: usize = 0x574; // float32
        pub const m_flDrawDistance: usize = 0x578; // float32
        pub const m_flFadeInStart: usize = 0x57C; // float32
        pub const m_flFadeInEnd: usize = 0x580; // float32
        pub const m_flIndirectStrength: usize = 0x584; // float32
        pub const m_nVolumeDepth: usize = 0x588; // int32
        pub const m_fFirstVolumeSliceThickness: usize = 0x58C; // float32
        pub const m_nIndirectTextureDimX: usize = 0x590; // int32
        pub const m_nIndirectTextureDimY: usize = 0x594; // int32
        pub const m_nIndirectTextureDimZ: usize = 0x598; // int32
        pub const m_vBoxMins: usize = 0x59C; // Vector
        pub const m_vBoxMaxs: usize = 0x5A8; // Vector
        pub const m_bActive: usize = 0x5B4; // bool
        pub const m_flStartAnisoTime: usize = 0x5B8; // GameTime_t
        pub const m_flStartScatterTime: usize = 0x5BC; // GameTime_t
        pub const m_flStartDrawDistanceTime: usize = 0x5C0; // GameTime_t
        pub const m_flStartAnisotropy: usize = 0x5C4; // float32
        pub const m_flStartScattering: usize = 0x5C8; // float32
        pub const m_flStartDrawDistance: usize = 0x5CC; // float32
        pub const m_flDefaultAnisotropy: usize = 0x5D0; // float32
        pub const m_flDefaultScattering: usize = 0x5D4; // float32
        pub const m_flDefaultDrawDistance: usize = 0x5D8; // float32
        pub const m_bStartDisabled: usize = 0x5DC; // bool
        pub const m_bEnableIndirect: usize = 0x5DD; // bool
        pub const m_bIndirectUseLPVs: usize = 0x5DE; // bool
        pub const m_bIsMaster: usize = 0x5DF; // bool
        ...
        pub const m_fWindSpeed: usize = 0x600; // float32
        pub const m_vWindDirection: usize = 0x604; // Vector
        pub const m_bFirstTime: usize = 0x610; // bool
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Nano_Pounce_InstantVData {
        pub const m_LeapModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ActiveBuff: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SlowModifier: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_AttackParticle: usize = 0x1590; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    ...
    pub mod CCitadel_Ability_WreckingBall {
        pub const m_bHoldingBall: usize = 0xCD8; // bool
    }
    ...
    pub mod CAbility_Mirage_Teleport_VData {
        pub const m_BuffModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ImmunityModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_FireRateModifier: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_TeleportStartParticle: usize = 0x1590; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TeleportEndParticle: usize = 0x1670; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strArriveSound: usize = 0x1750; // CSoundEventName
        pub const m_strDepartSound: usize = 0x1760; // CSoundEventName
        pub const m_strChannelDestinationSound: usize = 0x1770; // CSoundEventName
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod C_PointCommentaryNode {
        ...
        pub const m_bWasActive: usize = 0xB09; // bool
        pub const m_flEndTime: usize = 0xB0C; // GameTime_t
        pub const m_flStartTime: usize = 0xB10; // GameTime_t
        pub const m_flStartTimeInCommentary: usize = 0xB14; // float32
        pub const m_iszCommentaryFile: usize = 0xB18; // CUtlSymbolLarge
        pub const m_iszTitle: usize = 0xB20; // CUtlSymbolLarge
        pub const m_iszSpeakers: usize = 0xB28; // CUtlSymbolLarge
        pub const m_iNodeNumber: usize = 0xB30; // int32
        pub const m_iNodeNumberMax: usize = 0xB34; // int32
        pub const m_bListenedTo: usize = 0xB38; // bool
        pub const m_hViewPosition: usize = 0xB48; // CHandle<C_BaseEntity>
        pub const m_bRestartAfterRestore: usize = 0xB4C; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Dash {
        pub const m_flDashAngle: usize = 0xCA0; // float32
        pub const m_GroundDashExecuteTime: usize = 0xCA4; // GameTime_t
        pub const m_nLastGroundDashTick: usize = 0xCA8; // int32
        pub const m_flGroundDashCastTime: usize = 0xCAC; // GameTime_t
        pub const m_bTagCanActivateGroundDash: usize = 0xCB0; // bool
        pub const m_flGroundDashEndTime: usize = 0xCB8; // CCitadelAutoScaledTime
        pub const m_flAirDashCastTime: usize = 0xCD0; // GameTime_t
        pub const m_flAirDashDragStartTime: usize = 0xCD4; // GameTime_t
        pub const m_nConsecutiveAirDashes: usize = 0xCD8; // int8
        pub const m_nConsecutiveDownDashes: usize = 0xCD9; // int8
        pub const m_bDownAirDash: usize = 0xCDA; // bool
    ...
    pub mod CAI_BaseNPCVData {
        ...
        pub const m_bAllowAnimgraphMotorMovementStates: usize = 0x2EC; // bool
        ...
        pub const m_defaultAdditionalMovementSettings: usize = 0x320; // AI_AdditionalMovementSettings
    }
    // Parent: None
    // Field count: 5
    ...
    pub mod CCitadel_Item_BaseProjectileAOEModifier {
        pub const m_vLaunchPosition: usize = 0xCB8; // Vector
        pub const m_qLaunchAngle: usize = 0xCC4; // QAngle
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadel_Item_DivinersKevlar {
        pub const m_bExecuted: usize = 0xCB8; // bool
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 4
    pub mod CCitadel_Ability_Trapper_WebWall {
        pub const m_vecCastPosition: usize = 0xD80; // Vector
        pub const m_vecCastPositionNormal: usize = 0xD8C; // Vector
        pub const m_vecEndPosition: usize = 0xD98; // Vector
        pub const m_vecEndPositionNormal: usize = 0xDA4; // Vector
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbility_Rutger_RocketLauncher_VData {
        pub const m_ImpactParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ShootParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_PsychicDaggerVData {
        pub const m_MakeDaggersModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifierVData
    // Field count: 5
    ...
    pub mod CCitadel_Ability_Bull_Charge {
        pub const m_anglesCharging: usize = 0xF40; // QAngle
        pub const m_flChargeStartTime: usize = 0xF4C; // GameTime_t
        pub const m_flFastChargeEndTime: usize = 0xF50; // GameTime_t
        pub const m_bHitAPlayer: usize = 0xF54; // bool
        pub const m_bFirstTick: usize = 0xF58; // bool
        pub const m_vGoalDir: usize = 0xF5C; // Vector
    }
    // Parent: CCitadel_Ability_PrimaryWeapon
    // Field count: 0
    ...
    pub mod CAbilitySlideVData {
        pub const m_flMinAngleToConsiderASlope: usize = 0x1560; // float32
        pub const m_flSlideMaxSlopeMaxAccSpeed: usize = 0x1564; // float32
        pub const m_flSlideMinSlopeMaxAccSpeed: usize = 0x1568; // float32
        pub const m_flButtonPressWindow: usize = 0x156C; // float32
        pub const m_flTurnSpeed: usize = 0x1570; // float32
        pub const m_flSlideMinSlopeAcceleration: usize = 0x1574; // float32
        pub const m_flSlideMaxSlopeAcceleration: usize = 0x1578; // float32
        pub const m_flTurnMinAngDiff: usize = 0x157C; // float32
        pub const m_flTurnMaxAngDiff: usize = 0x1580; // float32
        pub const m_flLandedFlatGroundFrictionGraceTime: usize = 0x1584; // float32
        pub const m_flFlatGroundFrictionGraceTime: usize = 0x1588; // float32
        pub const m_flFrictionFlatGroundGrace: usize = 0x158C; // float32
        pub const m_flFrictionFlatGround: usize = 0x1590; // float32
        pub const m_flFrictionMinSlope: usize = 0x1594; // float32
        pub const m_flFrictionMaxSlope: usize = 0x1598; // float32
        pub const m_flFrictionUphillMinSlope: usize = 0x159C; // float32
        pub const m_flFrictionUphillMaxSlope: usize = 0x15A0; // float32
        pub const m_flLandingSlopeScaleBias: usize = 0x15A4; // float32
        pub const m_flBoostMinTriggerSpeed: usize = 0x15A8; // float32
        pub const m_flBoostMaxTriggerSpeed: usize = 0x15AC; // float32
        pub const m_flBoostMinSpeed: usize = 0x15B0; // float32
        pub const m_flBoostMaxSpeed: usize = 0x15B4; // float32
        pub const m_flMinActivationSpeed: usize = 0x15B8; // float32
        pub const m_flMinSustainSpeed: usize = 0x15BC; // float32
        pub const m_flSprintBoostSpeed: usize = 0x15C0; // float32
        pub const m_flDashSlideStartTime: usize = 0x15C4; // float32
        pub const m_flDashSlideSpeed: usize = 0x15C8; // float32
        pub const m_flDashSlideFailSpeed: usize = 0x15CC; // float32
        pub const m_strDashSlideActivate: usize = 0x15D0; // CSoundEventName
        pub const m_flDashSlideFrictionTime: usize = 0x15E0; // float32
        pub const m_flDashSlideFriction: usize = 0x15E4; // float32
        pub const m_flDashMinActivationSpeed: usize = 0x15E8; // float32
        pub const m_flAccMinSlopeDeg: usize = 0x15EC; // float32
        pub const m_flAccMaxSlopeDeg: usize = 0x15F0; // float32
        pub const m_flAccMinSlopeScale: usize = 0x15F4; // float32
        pub const m_flSlideProbeForwardOffset: usize = 0x15F8; // float32
        pub const m_flSlideActivationProbeForwardOffset: usize = 0x15FC; // float32
        pub const m_flMaxDistanceBetweenProbeSamples: usize = 0x1600; // float32
        pub const m_flInitialSlideUseForwardProbeTime: usize = 0x1604; // float32
        pub const m_flCurrentSlopeSampleDistance: usize = 0x1608; // float32
        pub const m_flSampleVelDiffStdDevScaleCutoff: usize = 0x160C; // float32
        pub const m_flSlopeFacingAngleToActivate: usize = 0x1610; // float32
        pub const m_flAirDragAfterJump: usize = 0x1614; // float32
        pub const m_flAirDragAfterJumpTime: usize = 0x1618; // float32
        pub const m_flAirDragMaxAngle: usize = 0x161C; // float32
        pub const m_flAirDragResetTime: usize = 0x1620; // float32
        pub const m_flLateSlideJumpWindow: usize = 0x1624; // float32
        pub const m_SlideEffectRemap: usize = 0x1628; // CRemapFloat
        pub const m_GetupSpeedCurve: usize = 0x1638; // CPiecewiseCurve
        pub const m_flGetupBusyDuration: usize = 0x1678; // float32
        pub const m_cameraSequenceStartSliding: usize = 0x1680; // CitadelCameraOperationsSequence_t
        pub const m_cameraSequenceEndSliding: usize = 0x1708; // CitadelCameraOperationsSequence_t
        pub const m_SlideParticle: usize = 0x1790; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strStartSound: usize = 0x1870; // CSoundEventName
        pub const m_strLoopingSound: usize = 0x1880; // CSoundEventName
        pub const m_strStopSound: usize = 0x1890; // CSoundEventName
    }
    // Parent: C_BaseEntity
    // Field count: 3
    ...
    pub mod CAbilityTargetPracticeVData {
        pub const m_TargetPracticeSelfModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_TargetPracticeEnemyModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod C_AI_CitadelNPC {
        pub const m_bBeamActive: usize = 0xD44; // bool
        pub const m_vEyeBeamTarget: usize = 0xD48; // Vector
        pub const m_nPlayerTeamEvent: usize = 0x1208; // int32
        pub const m_vecWeakPoints: usize = 0x1258; // C_UtlVectorEmbeddedNetworkVar<WeakPoint_t>
        pub const m_bMinion: usize = 0x12C0; // bool
        pub const m_hLookTarget: usize = 0x12C4; // CHandle<C_BaseEntity>
        pub const m_CCitadelAbilityComponent: usize = 0x12C8; // CCitadelAbilityComponent
    }
    // Parent: C_Sprite
    // Field count: 2
    pub mod C_FireSprite {
        pub const m_vecMoveDir: usize = 0x970; // Vector
        pub const m_bFadeFromAbove: usize = 0x97C; // bool
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Nano_ShadowVData {
        pub const m_ShadowModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_PurgeModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_EnemyAura: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flAuraRadius: usize = 0x1590; // float32
    }
    // Parent: CitadelAbilityVData
    // Field count: 4
    pub mod CCitadel_Ability_FissureWallVData {
        pub const m_FriendlyWallParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_EnemyWallParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_WallTravelSoundLoop: usize = 0x1720; // CSoundEventName
        pub const m_WallModifier: usize = 0x1730; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CitadelItemVData
    // Field count: 1
    ...
    pub mod CCitadel_Upgrade_AmmoScavenger {
        pub const m_hLastOrbTarget: usize = 0xCB8; // CHandle<C_BaseEntity>
    }
    // Parent: CitadelAbilityVData
    // Field count: 0
    ...
    pub mod C_Precipitation {
        pub const m_flDensity: usize = 0x9A0; // float32
        pub const m_flParticleInnerDist: usize = 0x9B0; // float32
        pub const m_pParticleDef: usize = 0x9B8; // char*
        pub const m_tParticlePrecipTraceTimer: usize = 0x9E0; // TimedEvent[1]
        pub const m_bActiveParticlePrecipEmitter: usize = 0x9E8; // bool[1]
        pub const m_bParticlePrecipInitialized: usize = 0x9E9; // bool
        pub const m_bHasSimulatedSinceLastSceneObjectUpdate: usize = 0x9EA; // bool
        pub const m_nAvailableSheetSequencesMaxIndex: usize = 0x9EC; // int32
    }
    // Parent: CitadelItemVData
    // Field count: 1
    pub mod CCitadel_ArmorUpgrade_RegeneratingBulletShieldVData {
        pub const m_ActiveModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_BaseEventProcVData
    // Field count: 2
    ...
    pub mod CAbilityCadenceSilenceContraptionsVData {
        pub const m_SilenceContraptionsModifier: usize = 0x15E8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CEntitySubclassVDataBase
    // Field count: 7
    ...
    pub mod CCitadel_ArmorUpgrade_ActiveBulletShieldVData {
        pub const m_TempShieldModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_BaseEventProcVData
    // Field count: 2
    ...
    pub mod CAbilityPsychicPulseVData {
        ...
        pub const m_PulseParticle: usize = 0x1570; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flCastEffectLifetime: usize = 0x1650; // float32
        pub const m_flConeAngle: usize = 0x1654; // float32
        pub const m_flConeHalfWidth: usize = 0x1658; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod CCitadel_Item_Savior_VData {
        pub const m_SaviorModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_CastParticle: usize = 0x15B8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadel_Modifier_BaseBulletPreRollProc
    // Field count: 3
    ...
    pub mod CFilterAttributeInt {
        pub const m_sAttributeName: usize = 0x5C0; // CUtlStringToken
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod C_BaseClientUIEntity {
        pub const m_bEnabled: usize = 0x868; // bool
        pub const m_DialogXMLName: usize = 0x870; // CUtlSymbolLarge
        pub const m_PanelClassName: usize = 0x878; // CUtlSymbolLarge
        pub const m_PanelID: usize = 0x880; // CUtlSymbolLarge
    }
    // Parent: C_BaseModelEntity
    // Field count: 3
    pub mod C_FuncTrackTrain {
        pub const m_nLongAxis: usize = 0x860; // int32
        pub const m_flRadius: usize = 0x864; // float32
        pub const m_flLineLength: usize = 0x868; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbilitySleepBombVData {
        pub const m_ExplosionParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_AuraModifier: usize = 0x1640; // CEmbeddedSubclass<CBaseModifier>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod C_NPC_Trooper {
        ...
        pub const m_hTargetedEnemy: usize = 0x146C; // CHandle<C_BaseEntity>
        pub const m_flHealingChargeParticlePct: usize = 0x1470; // float32
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CAbilityAstroRifleVData {
        pub const m_SelfModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DebuffModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SlowModifier: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: C_CitadelBaseAbility
    ...
    pub mod CCitadel_Ability_LashDownStrike {
        pub const m_ImpactTime: usize = 0xD48; // GameTime_t
        pub const m_vDamagePos: usize = 0xD4C; // Vector
        pub const m_PreviewEffect: usize = 0xD5C; // ParticleIndex_t
        pub const m_vStrikeVel: usize = 0xF20; // Vector
        pub const m_flStartHeight: usize = 0xF2C; // float32
    }
    // Parent: CCitadel_Modifier_StunnedVData
    // Field count: 4
    pub mod CModifierPsychicLiftVData {
        pub const m_LiftParticle: usize = 0x6E8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strStartSound: usize = 0x7C8; // CSoundEventName
        pub const m_flOscillateFrequency: usize = 0x7D8; // float32
        pub const m_flOscillateHeight: usize = 0x7DC; // float32
    }
    // Parent: CitadelAbilityVData
    // Field count: 6
    pub mod CAbilityMeleeVData {
        pub const m_flMeleeInputBufferTime: usize = 0x1560; // float32
        pub const m_flCollisionDistance: usize = 0x1564; // float32
        pub const m_flHeavyAttackRequiredHoldTime: usize = 0x1568; // float32
        pub const m_flLightAttackMaxHoldTime: usize = 0x156C; // float32
        pub const m_MeleeDamageFlags: usize = 0x1570; // TakeDamageFlags_t
        pub const m_strEffectsAttachName: usize = 0x1578; // CUtlString
    }
    // Parent: None
    // Field count: 13
    ...
    pub mod C_CitadelItemPickup {
        pub const m_eLootType: usize = 0xB10; // int32
        pub const m_nCurrencyValue: usize = 0xB14; // int32
        pub const m_iszModelName: usize = 0xB18; // CUtlSymbolLarge
        pub const m_flModelScale: usize = 0xB20; // float32
        pub const m_hTargetPlayer: usize = 0xB24; // CHandle<C_BaseEntity>
        pub const m_flFallRate: usize = 0xB28; // float32
    }
    // Parent: CBaseAnimGraph
    // Field count: 4
    pub mod CBaseProp {
        pub const m_bModelOverrodeBlockLOS: usize = 0xB00; // bool
        pub const m_iShapeType: usize = 0xB04; // int32
        pub const m_bConformToCollisionBounds: usize = 0xB08; // bool
        pub const m_mPreferredCatchTransform: usize = 0xB0C; // matrix3x4_t
    }
    // Parent: CCitadel_Modifier_Intrinsic_Base
    // Field count: 2
    ...
    pub mod CAbilityHornetStingVData {
        pub const m_DebuffModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_HitParticle: usize = 0x1570; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadelModifierVData
    // Field count: 10
    ...
    pub mod CFilterMassGreater {
        pub const m_fFilterMass: usize = 0x5C0; // float32
    }
    // Parent: CitadelAbilityVData
    // Field count: 1
    ...
    // Field count: 1
    pub mod CItemXP {
        pub const m_timeLaunch: usize = 0x8C0; // GameTime_t
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod CAbilityRiotProtocolVData {
        pub const m_ChargeUpParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CastParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CastDelayModifier: usize = 0x1720; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_WardenBuffModifier: usize = 0x1730; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifierVData
    // Field count: 4
    ...
    pub mod C_Citadel_Destroyable_Building {
        pub const m_CCitadelAbilityComponent: usize = 0xB08; // CCitadelAbilityComponent
        pub const m_vecWeakPoints: usize = 0xCA8; // C_UtlVectorEmbeddedNetworkVar<WeakPoint_t>
        pub const m_bDestroyed: usize = 0xD10; // bool
        pub const m_bActive: usize = 0xD11; // bool
        pub const m_bFinal: usize = 0xD12; // bool
    }
    // Parent: CCitadel_Item
    // Field count: 1
    pub mod CItem_RestorativeLocket {
        pub const m_nNumStacks: usize = 0xD60; // int32
    }
    // Parent: CCitadel_Item
    // Field count: 1
    pub mod CCitadel_TechUpgrade_SuperAcolyteGloves {
        pub const fl_StoredDamage: usize = 0xCF0; // float32
    }
    // Parent: CLogicalEntity
    // Field count: 11
    ...
    pub mod CAbilityFealtyVData {
        pub const m_TargetModifier: usize = 0x1560; // CEmbeddedSubclass<CBaseModifier>
    }
    // Parent: CCitadel_Modifier_Disarmed
    // Field count: 0
    ...
    pub mod CCitadel_Ability_LifeDrainVData {
        pub const m_LifeDrainTargetModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_LifeDrainCasterModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_BaseEventProcVData
    // Field count: 3
    ...
    pub mod CCitadel_Ability_Viscous_TelepunchVData {
        pub const m_PortalParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CastParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_PunchParticle: usize = 0x1720; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_WallPunchParticle: usize = 0x1800; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CeilingPunchParticle: usize = 0x18E0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_EnemyPortalSound: usize = 0x19C0; // CSoundEventName
        pub const m_SelfPortalSound: usize = 0x19D0; // CSoundEventName
        pub const m_WindupSound: usize = 0x19E0; // CSoundEventName
        pub const m_PunchSound: usize = 0x19F0; // CSoundEventName
        pub const m_PunchRollSlowModifier: usize = 0x1A00; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ImpactModifier: usize = 0x1A10; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flEnemyPortalTelegraphTime: usize = 0x1A20; // float32
        pub const m_flSelfPortalTelegraphTime: usize = 0x1A24; // float32
        pub const m_flWindupTime: usize = 0x1A28; // float32
        pub const m_flAttackTime: usize = 0x1A2C; // float32
        pub const m_flGroundTraceOnPlayerHitDistance: usize = 0x1A30; // float32
        pub const m_flPlayerCheckSphereRadius: usize = 0x1A34; // float32
    }
    // Parent: CEntityComponent
    // Field count: 3
    ...
    pub mod CAbility_Synth_Blitz {
        pub const m_vecSpecialShots: usize = 0xCA0; // CUtlVector<ShotID_t>
        pub const m_nFastFireBulletsLeft: usize = 0xCB8; // int32
        pub const m_flBlitzEndTime: usize = 0xCC0; // CCitadelAutoScaledTime
        pub const m_bCanApplyTechAmp: usize = 0xCD8; // bool
        pub const m_bCanLifesteal: usize = 0xCD9; // bool
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CAbility_Synth_Pulse_VData {
        pub const m_EscapeModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DebuffModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_AoEParticle: usize = 0x1580; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_EffectParticle: usize = 0x1660; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ChannelParticle: usize = 0x1740; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_HitParticle: usize = 0x1820; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_RadiusParticle: usize = 0x1900; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strExpireSound: usize = 0x19E0; // CSoundEventName
        pub const m_cameraSequenceInSatchel: usize = 0x19F0; // CitadelCameraOperationsSequence_t
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod C_TriggerPhysics {
        pub const m_gravityScale: usize = 0x9A0; // float32
        pub const m_linearLimit: usize = 0x9A4; // float32
        pub const m_linearDamping: usize = 0x9A8; // float32
        pub const m_angularLimit: usize = 0x9AC; // float32
        pub const m_angularDamping: usize = 0x9B0; // float32
        pub const m_linearForce: usize = 0x9B4; // float32
        pub const m_flFrequency: usize = 0x9B8; // float32
        pub const m_flDampingRatio: usize = 0x9BC; // float32
        pub const m_vecLinearForcePointAt: usize = 0x9C0; // Vector
        pub const m_bCollapseToForcePoint: usize = 0x9CC; // bool
        pub const m_vecLinearForcePointAtWorld: usize = 0x9D0; // Vector
        pub const m_vecLinearForceDirection: usize = 0x9DC; // Vector
        pub const m_bConvertToDebrisWhenPossible: usize = 0x9E8; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CItem_RestorativeLocket_VData {
        pub const m_CastParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TrailParticle: usize = 0x1688; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadel_Modifier_BaseEventProcVData
    // Field count: 2
    ...
    pub mod CCitadel_Ability_Yakuza_Shakedown {
        pub const m_IgnoreChannelSlow: usize = 0xCA0; // int32
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadel_Item_CheatDeathVData {
        pub const m_DamagePulseParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DamageTargetParticle: usize = 0x1688; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_sHealPulseSound: usize = 0x1768; // CSoundEventName
        pub const m_sHealAndDamagePulseSound: usize = 0x1778; // CSoundEventName
        pub const m_DeathImmuneModifier: usize = 0x1788; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 2
    ...
    pub mod CAbilityEmpowerBulletVData {
        pub const m_EmpowerBulletModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod C_Citadel_FissureWall {
        pub const m_vStartPos: usize = 0xB00; // Vector
        pub const m_vEndPos: usize = 0xB0C; // Vector
        pub const m_flStartEmitTime: usize = 0xB18; // GameTime_t
        pub const m_flEndEmitTime: usize = 0xB1C; // GameTime_t
        pub const m_bSolid: usize = 0xB20; // bool
        pub const m_nTouchCount: usize = 0xB24; // int32
    }
    // Parent: CCitadelModifierVData
    // Field count: 12
    ...
    pub mod CCitadel_Ability_PassiveBeefyVData {
        pub const m_HealParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadelModifier
    // Field count: 2
    ...
    pub mod CPropAnimatingBreakable {
        pub const m_stages: usize = 0xB00; // CBreakableStageHelper
        pub const m_OnTakeDamage: usize = 0xB18; // CEntityIOOutput
        pub const m_OnFinalBreak: usize = 0xB40; // CEntityIOOutput
        pub const m_OnStageAdvanced: usize = 0xB68; // CEntityIOOutput
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbilityStickyBombVData {
        pub const m_BombAttachedModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_KillCheckModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_CastBombParticle: usize = 0x1580; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flAllyTargetRangeMult: usize = 0x1660; // float32
    }
    // Parent: C_BaseEntity
    // Field count: 25
    ...
    pub mod C_Citadel_BreakblePropGoldPickup {
        pub const m_iGoldReward: usize = 0xB30; // int32
    }
    // Parent: CCitadel_Item
    // Field count: 1
    pub mod CCitadel_Item_Intensifying_Clip {
        pub const m_flSpinUpTime: usize = 0xCF0; // float32
    }
    // Parent: C_EnvCubemap
    // Field count: 0
    ...
    pub mod C_NPC_TrooperBoss {
        pub const m_CCitadelPlayerClipComponent: usize = 0x14B0; // CCitadelPlayerClipComponent
        pub const m_flFadeOutStart: usize = 0x14DC; // GameTime_t
        pub const m_flFadeOutEnd: usize = 0x14E0; // GameTime_t
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CAbilityBouncePadVData {
        pub const m_BounceModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_AllyBounceModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SpeedOnLandModifier: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_NoBounceModifier: usize = 0x1590; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Melee_Base {
        pub const m_bUsingThisMelee: usize = 0xCA0; // bool
        pub const m_bUsingMeleeTagActive: usize = 0xCA1; // bool
        pub const m_bHitWithThisAttack: usize = 0xCA2; // bool
        pub const m_flLastActivateTime: usize = 0xCA4; // GameTime_t
        pub const m_flNextAttackAllowedTime: usize = 0xCA8; // GameTime_t
        pub const m_flAttackTriggeredTime: usize = 0xCAC; // GameTime_t
    }
    // Parent: CCitadel_Modifier_ChainLightningEffect
    // Field count: 0
    ...
    // Field count: 3
    pub mod CBaseFilter {
        pub const m_bNegated: usize = 0x568; // bool
        pub const m_OnPass: usize = 0x570; // CEntityIOOutput
        pub const m_OnFail: usize = 0x598; // CEntityIOOutput
    }
    // Parent: CitadelAbilityVData
    // Field count: 15
    pub mod CCitadel_Ability_Nano_Pounce_VData {
        ...
        pub const m_ActiveBuff: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SlowModifier: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DoublePounceModifier: usize = 0x1590; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_AttackParticle: usize = 0x15A0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_FlashParticle: usize = 0x1680; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CastParticle: usize = 0x1760; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ExplodeSlowParticle: usize = 0x1840; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_PrimaryHitParticle: usize = 0x1920; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_AttackSound: usize = 0x1A00; // CSoundEventName
        pub const m_strExplodeSound: usize = 0x1A10; // CSoundEventName
        pub const m_flAttackTimePhase01: usize = 0x1A20; // float32
        pub const m_flAttackTimePhase02: usize = 0x1A24; // float32
        pub const m_flAllyMinTargetRange: usize = 0x1A28; // float32
        pub const m_flTargetVerticalOffset: usize = 0x1A2C; // float32
    }
    // Parent: CitadelAbilityVData
    // Field count: 4
    pub mod CAbilityHornetChainVData {
        ...
        pub const m_ChainModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DisarmModifier: usize = 0x1660; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 11
    pub mod CCitadel_Ability_GuidedArrow {
        pub const m_hProjectile: usize = 0xCA8; // CHandle<C_BaseEntity>
        pub const m_flArrowSpeed: usize = 0xCAC; // float32
        pub const m_flSnapAnglesBackTime: usize = 0xCB0; // GameTime_t
        pub const m_nBonusTechPower: usize = 0xCB4; // int32
        pub const m_flCastTime: usize = 0xCB8; // GameTime_t
        pub const m_bNeedsExplosion: usize = 0xCBC; // bool
        pub const m_vProjectileRemovedOrigin: usize = 0xCC0; // Vector
        pub const m_angCasterAnglesAtCastTime: usize = 0xCCC; // QAngle
        pub const m_flTravelDistance: usize = 0xCD8; // float32
        pub const m_bInKillFlow: usize = 0xCDC; // bool
        pub const m_flProjectileTurnVel: usize = 0xCE0; // float32
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod CCitadel_Ability_HoldMelee {
        pub const m_flParryWindowEndTime: usize = 0xD20; // GameTime_t
        pub const m_flNextParryTime: usize = 0xD24; // GameTime_t
        pub const m_flStateStartTime: usize = 0xD28; // GameTime_t
        pub const m_flDashStartTime: usize = 0xD2C; // GameTime_t
        pub const m_eCurrentAttackState: usize = 0xD30; // EMeleeHold_AttackState
        pub const m_eCurrentAttackType: usize = 0xD34; // EMeleeHold_AttackType
        pub const m_vAirDashDir: usize = 0xD38; // Vector
        pub const m_bAttackStartedWhileSliding: usize = 0xD44; // bool
        pub const m_bCreatedChargeEffects: usize = 0xD45; // bool
        pub const m_angForced: usize = 0xD48; // QAngle
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CAbilityJumpVData {
        pub const m_flShootingLockoutAfterJump: usize = 0x1560; // float32
        pub const m_DashJumpParticle: usize = 0x1568; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_AirJumpParticle: usize = 0x1648; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_WallJumpParticle: usize = 0x1728; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_AirJumpExecutedSound: usize = 0x1808; // CSoundEventName
        pub const m_flMantleRefundWindow: usize = 0x1818; // float32
        pub const m_flZiplineRefundWindow: usize = 0x181C; // float32
        pub const m_flLateJumpGraceWindow: usize = 0x1820; // float32
        pub const m_flMaxSpeedDelta: usize = 0x1824; // float32
        pub const m_strDashJumpActivate: usize = 0x1828; // CSoundEventName
        pub const m_flDashJumpStartTime: usize = 0x1838; // float32
        pub const m_flDashJumpEndTime: usize = 0x183C; // float32
        pub const m_flDashJumpDistanceInMeters: usize = 0x1840; // float32
        pub const m_flDashJumpVerticalSpeed: usize = 0x1848; // float32
        pub const m_flDashJumpMissMaxSpeed: usize = 0x184C; // float32
        pub const m_flDashJumpMantleDisableTime: usize = 0x1850; // float32
        pub const m_WallJumpExecutedSound: usize = 0x1858; // CSoundEventName
        pub const m_flCollidedWallMaxDist: usize = 0x1868; // float32
        pub const m_flRemapSpeedToWallJumpVelocityDist: usize = 0x186C; // CRemapFloat
        pub const m_flWallJumpNormalSpeed: usize = 0x187C; // float32
        pub const m_WallJumpAirDragCurve: usize = 0x1880; // CPiecewiseCurve
        pub const m_flMaxWallYawOffset: usize = 0x18C0; // float32
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod C_NPC_SimpleAnimatingAI {
        pub const m_hEnemy: usize = 0xB00; // CHandle<C_BaseEntity>
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod CCitadel_Ability_IcePathVData {
        pub const m_IcePathModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flMomentumDecayRate: usize = 0x1570; // float32
        pub const m_flMomentumWeight: usize = 0x1574; // float32
        pub const m_flMaxPitchChange: usize = 0x1578; // float32
        pub const m_flMaxPitchUp: usize = 0x157C; // float32
        pub const m_flMaxPitchDown: usize = 0x1580; // float32
        pub const m_flMaxHeight: usize = 0x1584; // float32
        pub const m_flForwardAngleBias: usize = 0x1588; // float32
    }
    // Parent: CitadelAbilityVData
    // Field count: 4
    pub mod CCitadel_Ability_HealthSwapVData {
        pub const m_SwapParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SwapModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_PreCastModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_BuffModifier: usize = 0x1660; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadelControlPointTrigger {
        pub const m_flInitialRadius: usize = 0x9A0; // float32
        pub const m_flEndRadius: usize = 0x9A4; // float32
        pub const m_flProgress: usize = 0x9A8; // float32
        pub const m_flCaptureTime: usize = 0x9AC; // float32
        pub const m_hUnlockPrereq: usize = 0x9B0; // CHandle<C_BaseEntity>
        pub const m_bAvailable: usize = 0x9B4; // bool
        pub const m_bIsBeingCaptured: usize = 0x9B5; // bool
        pub const m_bIsBeingBlocked: usize = 0x9B6; // bool
        pub const m_flLastTouchedTime: usize = 0x9C0; // GameTime_t
        pub const m_vecBeamTarget: usize = 0x9C4; // Vector
        pub const m_vecBeamStart: usize = 0x9D0; // Vector
        pub const m_nFXProgressBeam: usize = 0x9DC; // ParticleIndex_t
        pub const m_strUnlockPrereq: usize = 0x9E0; // CUtlSymbolLarge
        pub const m_strBeamStart: usize = 0x9E8; // CUtlSymbolLarge
        pub const m_strBeamTarget: usize = 0x9F0; // CUtlSymbolLarge
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod CCitadel_Ability_PrimaryWeapon {
        pub const m_flNextPrimaryAttack: usize = 0xCA0; // GameTime_t
        pub const m_iClip: usize = 0xCA4; // int32
        pub const m_iBonusClip: usize = 0xCA8; // int32
        pub const m_flSpreadPenalty: usize = 0xCAC; // float32
        pub const m_flZoomTime: usize = 0xCB0; // GameTime_t
        pub const m_flZoomOutTime: usize = 0xCB4; // GameTime_t
        pub const m_iSpreadIndex: usize = 0xCB8; // int8
        pub const m_nShotRecoilIndex: usize = 0xCBA; // int16
        pub const m_flNextShotRecoilRecoveryTime: usize = 0xCBC; // GameTime_t
        pub const m_bIsZoomed: usize = 0xCC0; // bool
        pub const m_nBurstShotsRemaining: usize = 0xCC1; // uint8
        pub const m_nShotNumber: usize = 0xCC4; // uint32
        pub const m_bInReload: usize = 0xCC8; // bool
        pub const m_bSingleShotReloadFirstBullet: usize = 0xCC9; // bool
        pub const m_reloadQueuedStartTime: usize = 0xCCC; // GameTime_t
        pub const m_flReloadAvailableTime: usize = 0xCD0; // GameTime_t
        pub const m_bCanActiveReload: usize = 0xCD4; // bool
        pub const m_flLastAttackTime: usize = 0xCD8; // GameTime_t
        pub const m_flNextAttackDelayStartTime: usize = 0xCDC; // GameTime_t
        pub const m_flNextAttackDelayEndTime: usize = 0xCE0; // GameTime_t
        pub const m_flAttackDelayPauseTotalTime: usize = 0xCE4; // float32
        pub const m_flAttackDelayPauseEndTime: usize = 0xCE8; // GameTime_t
        pub const m_eNextAttackDelayReason: usize = 0xCEC; // ENextAttackDelayReason_t
        pub const m_bInputPressedWhileSelected: usize = 0xCF0; // bool
        pub const m_eActiveFireMode: usize = 0xCF4; // EFireMode_t
        pub const m_angRecoilAngles: usize = 0xCF8; // QAngle
        pub const m_angRecoilToAdd: usize = 0xD04; // QAngle
        pub const m_angRecoilRecovery: usize = 0xD10; // QAngle
        pub const m_flRecoilStartTime: usize = 0xD1C; // GameTime_t
        pub const m_flRecoilRecoverySpeed: usize = 0xD20; // float32
        pub const m_flAddApproachSpeed: usize = 0xD24; // float32
        pub const m_bFireBackwards: usize = 0xD28; // bool
        pub const m_currentSpread: usize = 0xD2C; // float32
        pub const m_currentMaxSpread: usize = 0xD30; // float32
        pub const m_currentFireSpread: usize = 0xD34; // float32
        pub const m_flCurrentSpinRate: usize = 0xD38; // float32
        pub const m_fFireDuration: usize = 0xD40; // float32
        pub const m_bFireOnEmpty: usize = 0xD45; // bool
        pub const m_bHasReleasedForSemiAuto: usize = 0xD46; // bool
        pub const m_flNextDisarmSound: usize = 0xD48; // GameTime_t
    }
    // Parent: CCitadelModifierVData
    // Field count: 5
    ...
    pub mod CCitadel_WeaponUpgrade_InstantReloadVData {
        pub const m_ReloadParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadelModifier
    // Field count: 3
    ...
    pub mod C_Citadel_Ice_Path_Shard_Physics {
        pub const m_ShardDesc: usize = 0x860; // ice_path_shard_model_desc_t
        pub const m_qForward: usize = 0x898; // QAngle
        pub const m_flStartTime: usize = 0x8A4; // GameTime_t
        pub const m_flEndTime: usize = 0x8A8; // GameTime_t
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod CAbilityPerchedPredatorVData {
        pub const m_ExplodeBaseParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ExplodeFriendlyParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ExplodeEnemyParticle: usize = 0x1720; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strExplodeSound: usize = 0x1800; // CSoundEventName
        pub const m_ModifierDragEnemy: usize = 0x1810; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flOnHitDetonateTimer: usize = 0x1820; // float32
        pub const m_flTraceTravelRadius: usize = 0x1824; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod CBaseTriggerAbilityVData {
        pub const m_AbilityToTrigger: usize = 0x1560; // CSubclassName<4>
        pub const m_flMinCancelTime: usize = 0x1570; // float32
        pub const m_eHintFeatureToMarkUsedOnTrigger: usize = 0x1574; // ECitadelHintFeature
    }
    // Parent: C_BaseEntity
    // Field count: 18
    ...
    pub mod CCitadel_ArmorUpgrade_DoubleJump {
        pub const m_nTickJumped: usize = 0xCB8; // int32
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod CCitadel_Ability_MeleeParry {
        pub const m_flParryStartTime: usize = 0xCA0; // GameTime_t
        pub const m_bAttackParried: usize = 0xCA4; // bool
        pub const m_flParrySuccessTime: usize = 0xCA8; // GameTime_t
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Spinning_BladeVData {
        pub const m_DebuffModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_CatchIndicator: usize = 0x1570; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CatchParticle: usize = 0x1650; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strThrowSound: usize = 0x1730; // CSoundEventName
        pub const m_strReturnSound: usize = 0x1740; // CSoundEventName
        pub const m_strCatchSound: usize = 0x1750; // CSoundEventName
        pub const m_strFailSound: usize = 0x1760; // CSoundEventName
        pub const m_strHitSound: usize = 0x1770; // CSoundEventName
    }
    // Parent: CitadelAbilityVData
    // Field count: 36
    pub mod CCitadel_Ability_Tengu_AirLiftVData {
        pub const m_FlyingModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_GrabModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_HoldBombModifier: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DroppedBuffModifier: usize = 0x1590; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ExplodingAllyModifier: usize = 0x15A0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_AoEModifier: usize = 0x15B0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_InitialExplodeParticle: usize = 0x15C0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_HoldBombEffect: usize = 0x16A0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strExplodeSound: usize = 0x1780; // CSoundEventName
        pub const m_flAirDrag: usize = 0x1790; // float32
        pub const m_flMaxFallSpeed: usize = 0x1794; // float32
        pub const m_flTargetAirSpeedFast: usize = 0x1798; // float32
        pub const m_flTargetAirSpeedBase: usize = 0x179C; // float32
        pub const m_flSprintMult: usize = 0x17A0; // float32
        pub const m_flAcceleration: usize = 0x17A4; // float32
        pub const m_flDecceleration: usize = 0x17A8; // float32
        pub const m_flAirSideSpeedPercent: usize = 0x17AC; // float32
        pub const m_flBoostTime: usize = 0x17B0; // float32
        pub const m_flBoostSpeedUp: usize = 0x17B4; // float32
        pub const m_flCrouchLaunchReduction: usize = 0x17B8; // float32
        pub const m_flMinFlyHeight: usize = 0x17BC; // float32
        pub const m_flMaxFlyHeight: usize = 0x17C0; // float32
        pub const m_flMaxPitchUp: usize = 0x17C4; // float32
        pub const m_flMaxPitchDown: usize = 0x17C8; // float32
        pub const m_flAllyDelayedBoostTime: usize = 0x17CC; // float32
        pub const m_flChannelingAirDrag: usize = 0x17D0; // float32
        pub const m_flChannelingMaxFallSpeed: usize = 0x17D4; // float32
        pub const m_flBombReleaseSpeed: usize = 0x17D8; // float32
        pub const m_flBombReleasePitch: usize = 0x17DC; // float32
        pub const m_flBombDropReleaseOffset: usize = 0x17E0; // float32
        pub const m_flHoldBombOffsetX: usize = 0x17E4; // float32
        pub const m_flHoldBombOffsetY: usize = 0x17E8; // float32
        pub const m_flHoldBombOffsetZ: usize = 0x17EC; // float32
        pub const m_flAnglePitchBias: usize = 0x17F0; // float32
        pub const m_flTrackAmount: usize = 0x17F4; // float32
        pub const m_flMoveCollideSpeed: usize = 0x17F8; // float32
    }
    // Parent: CCitadelModifierVData
    // Field count: 3
    ...
    pub mod CAbilityShivDeferDamageVData {
        pub const m_ActiveCastParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flDeferredDamageApplicationInterval: usize = 0x1640; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CBaseLockonAbilityVData {
        pub const m_TargetModifier: usize = 0x1560; // CEmbeddedSubclass<CBaseModifier>
        pub const m_strApplyLockonStack: usize = 0x1570; // CSoundEventName
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_RiotProtocol {
        pub const m_bActive: usize = 0xCA0; // bool
    }
    // Parent: CCitadel_Modifier_Intrinsic_BaseVData
    // Field count: 1
    ...
    pub mod CCitadel_Upgrade_MagicCarpetVData {
        pub const m_SummonParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_FlyingCarpetModifier: usize = 0x1688; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SummonFlyingCarpetModifier: usize = 0x1698; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SummonFlyingCarpetVisualModifier: usize = 0x16A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_FlyingCarpetVisualModifier: usize = 0x16B8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ShieldModifier: usize = 0x16C8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flSummonVisualDuration: usize = 0x16D8; // float32
        pub const m_flBurstSpeedBonus: usize = 0x16DC; // float32
        pub const m_flBurstSpeedMin: usize = 0x16E0; // float32
        pub const m_flBurstSpeedDuration: usize = 0x16E4; // float32
        pub const m_flMinDistanceAboveGround: usize = 0x16E8; // float32
    }
    // Parent: CCitadel_Modifier_BaseEventProc
    // Field count: 0
    ...
    pub mod C_NPC_NanoRollermine {
        pub const m_flForwardSpeed: usize = 0x1480; // float32
        pub const m_hOwnerPawn: usize = 0x1484; // CHandle<C_BaseEntity>
    }
    // Parent: C_AI_CitadelNPC
    // Field count: 1
    pub mod C_NPC_HeroCloneTrooper {
        pub const m_hOwner: usize = 0x1468; // CHandle<C_BaseEntity>
    }
    // Parent: CCitadelModifierAura
    // Field count: 0
    ...
    pub mod CCitadel_Ability_RocketBarrageVData {
        pub const m_BarrageModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_MoveSlowModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ImpactParticle: usize = 0x1580; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strExplodeSound: usize = 0x1660; // CSoundEventName
        pub const m_cameraSequenceSelected: usize = 0x1670; // CitadelCameraOperationsSequence_t
        pub const m_flMoveSpeedReductionPct: usize = 0x16F8; // float32
        pub const m_flHeightTestDistance: usize = 0x16FC; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod C_ShatterGlassShardPhysics {
        pub const m_ShardDesc: usize = 0xC98; // shard_model_desc_t
    }
    // Parent: CitadelAbilityVData
    // Field count: 0
    ...
    pub mod C_LightEntity {
        pub const m_CLightComponent: usize = 0x860; // CLightComponent*
    }
    // Parent: CCitadelModifierAura
    // Field count: 1
    ...
    pub mod CAbility_Synth_Grasp_VData {
        pub const m_CasterModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_VictimModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_BulletShieldModifier: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 2
    ...
    pub mod CCitadel_WeaponUpgrade_Headhunter_VData {
        pub const m_HeadshotBuffModifier: usize = 0x15C8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_BaseEventProc
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Magician_MagicBoltVData {
        pub const m_TargetDebuffModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ExplodeParticle: usize = 0x1570; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_RetargetParticle: usize = 0x1650; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strRedirect: usize = 0x1730; // CSoundEventName
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_FlameDash {
        pub const m_flDashEndTime: usize = 0xCA0; // CCitadelAutoScaledTime
        pub const m_bIsSpeedBursting: usize = 0xCB8; // bool
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Climb_RopeVData {
        pub const m_flMinButtonHoldTimeToActivate: usize = 0x1560; // float32
        pub const m_flClimbSpeedUp: usize = 0x1564; // float32
        pub const m_flClimbSpeedDown: usize = 0x1568; // float32
        pub const m_flClimbSpeedDownMax: usize = 0x156C; // float32
        pub const m_flClimbDownAccelTime: usize = 0x1570; // float32
        pub const m_flLatchSpeed: usize = 0x1574; // float32
        pub const m_flAttachOffset: usize = 0x1578; // float32
        pub const m_flMinReconnectTime: usize = 0x157C; // float32
        pub const m_flSideMoveReduction: usize = 0x1580; // float32
        pub const m_flTopOffset: usize = 0x1584; // float32
        pub const m_flBottomOffset: usize = 0x1588; // float32
        pub const m_flTraceRadiusSize: usize = 0x158C; // float32
        pub const m_flStopTimeToShoot: usize = 0x1590; // float32
        pub const m_flJumpOffVertical: usize = 0x1594; // float32
        pub const m_flJumpOffHorizontal: usize = 0x1598; // float32
        pub const m_flDuckOffVertical: usize = 0x159C; // float32
        pub const m_flDuckOffHorizontal: usize = 0x15A0; // float32
        pub const m_flActivateRange: usize = 0x15A4; // float32
        pub const m_flJumpToRoofRayCheckDist: usize = 0x15A8; // float32
        pub const m_flMinTimeToRoofCheck: usize = 0x15AC; // float32
        pub const m_flTimeToHintRefresh: usize = 0x15B0; // float32
        pub const m_iMaxHintCount: usize = 0x15B4; // float32
        pub const m_flClimbRopeSlowDurationOnHit: usize = 0x15B8; // float32
        pub const m_ClimbRopeSlowOnHitModifier: usize = 0x15C0; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: None
    // Field count: 25
    pub mod fogparams_t {
    ...
    pub mod C_Citadel_Projectile_Tier2Boss_RocketBarrage {
        pub const m_nLaserParticleIndex: usize = 0x8E8; // ParticleIndex_t
        pub const m_vecSmoothedVelocity: usize = 0x8EC; // Vector
    }
    // Parent: CCitadel_Modifier_Invis
    // Field count: 1
    ...
    pub mod CAbilityHatTrickVData {
        pub const m_SpectatingProjectileParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ExplosionParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_HatTrickChannelParticle: usize = 0x1720; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DebuffModifier: usize = 0x1800; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strExplodeSound: usize = 0x1810; // CSoundEventName
    }
    // Parent: CCitadelModifier
    // Field count: 7
    ...
    pub mod CCitadel_Modifier_ZiplineKnockdownImmuneVData {
        ...
        pub const m_ZipLineKnockdownProtectionStatusEnemyParticle: usize = 0x8A8;
    ...
    pub mod CCitadelAbilityFlyingStrikeVData {
        pub const m_flJumpFallSpeedMax: usize = 0x1568; // float32
        pub const m_flJumpAirDrag: usize = 0x156C; // float32
        pub const m_flJumpAirSpeedMax: usize = 0x1570; // float32
        pub const m_flOnCancelVerticalSpeedBonus: usize = 0x1574; // float32
        pub const m_flFlyingCloseEnoughToTarget: usize = 0x1578; // float32
        pub const m_curveSpeedScale: usize = 0x1580; // CPiecewiseCurve
        pub const m_flAnimToStrikePointTime: usize = 0x15C0; // float32
        pub const m_flAnimToStrikeArrivalBias: usize = 0x15C4; // float32
        pub const m_flGrappleShotFloatTime: usize = 0x15C8; // float32
        pub const m_flGrappleShotDelayToFlyOnHit: usize = 0x15CC; // float32
        pub const m_flGrappleSpeed: usize = 0x15D0; // float32
        pub const m_SlowModifier: usize = 0x15D8; // CEmbeddedSubclass<CBaseModifier>
        pub const m_GrappleTargetModifier: usize = 0x15E8; // CEmbeddedSubclass<CBaseModifier>
        pub const m_WeaponBuffModifier: usize = 0x15F8; // CEmbeddedSubclass<CBaseModifier>
        pub const m_LeapParticle: usize = 0x1608; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ImpactParticle: usize = 0x16E8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SlashParticle: usize = 0x17C8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_BulletGrappleTracerParticle: usize = 0x18A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_EnemyGrappleParticle: usize = 0x1988; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strDamageTarget: usize = 0x1A68; // CSoundEventName
        pub const m_strStartFlyingToTarget: usize = 0x1A78; // CSoundEventName
        pub const m_strStartAttack: usize = 0x1A88; // CSoundEventName
        pub const m_strGrappleHitTarget: usize = 0x1A98; // CSoundEventName
        pub const m_strGrappleHitWorld: usize = 0x1AA8; // CSoundEventName
        pub const m_strGrappleHitNothing: usize = 0x1AB8; // CSoundEventName
        pub const m_strGrappleLoop: usize = 0x1AC8; // CSoundEventName
        pub const m_strFlyingLoop: usize = 0x1AD8; // CSoundEventName
        pub const m_cameraSequenceFlying: usize = 0x1AE8; // CitadelCameraOperationsSequence_t
        pub const m_cameraSequenceAttacking: usize = 0x1B70; // CitadelCameraOperationsSequence_t
    }
    // Parent: CCitadel_Modifier_Base
    // Field count: 0
    ...
    pub mod CAbilityGooGrenadeVData {
        pub const m_GooGrenadeImpactModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_GooGrenadePuddleAuraModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_GooGrenadeSkipParticle: usize = 0x1580; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_GooGrenadeExplodeParticle: usize = 0x1660; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_GrenadeHitImpactSound: usize = 0x1740; // CSoundEventName
        pub const m_GrenadeMissImpactSound: usize = 0x1750; // CSoundEventName
        pub const m_flMinRestitution: usize = 0x1760; // float32
        pub const m_flMaxRestitution: usize = 0x1764; // float32
    }
    // Parent: CitadelAbilityVData
    // Field count: 5
    pub mod CCitadel_Ability_FireBombVData {
        ...
        pub const m_ProgressBarModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_FireBombModifier: usize = 0x1660; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DebuffModifier: usize = 0x1670; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_Tier3Boss_Base
    // Field count: 0
    ...
    pub mod C_CitadelGameRulesProxy {
        pub const m_pGameRules: usize = 0x568; // C_CitadelGameRules*
    }
    // Parent: C_BaseEntity
    // Field count: 2
    pub mod CCitadelTrooperMinimap {
        pub const m_timeLastUpdate: usize = 0x568; // GameTime_t
        pub const m_vecFOWEntities: usize = 0x570; // C_UtlVectorEmbeddedNetworkVar<STrooperFOWEntity>
    }
    // Parent: C_NPC_SimpleAnimatingAI
    // Field count: 1
    pub mod C_NPC_BaseDefenseSentry {
        pub const m_vecUnitStatusOffset: usize = 0xB08; // Vector
    }
    // Parent: C_DynamicProp
    // Field count: 5
    pub mod C_Citadel_DynamicProp {
        pub const m_nPlayerTeamEvent: usize = 0xDB0; // int32
        pub const m_strDefaultSkin: usize = 0xDB8; // CUtlString
        pub const m_strFriendlySkin: usize = 0xDC0; // CUtlString
        pub const m_strEnemySkin: usize = 0xDC8; // CUtlString
        pub const m_bIsWorld: usize = 0xDD0; // bool
    }
    // Parent: CBaseAnimGraph
    // Field count: 19
    pub mod C_BaseFlex {
        pub const m_flexWeight: usize = 0xB10; // C_NetworkUtlVectorBase<float32>
        pub const m_vLookTargetPosition: usize = 0xB28; // Vector
        pub const m_blinktoggle: usize = 0xB40; // bool
        pub const m_nLastFlexUpdateFrameCount: usize = 0xBA0; // int32
        pub const m_CachedViewTarget: usize = 0xBA4; // Vector
        pub const m_nNextSceneEventId: usize = 0xBB0; // SceneEventId_t
        pub const m_iBlink: usize = 0xBB4; // int32
        pub const m_blinktime: usize = 0xBB8; // float32
        pub const m_prevblinktoggle: usize = 0xBBC; // bool
        pub const m_iJawOpen: usize = 0xBC0; // int32
        pub const m_flJawOpenAmount: usize = 0xBC4; // float32
        pub const m_flBlinkAmount: usize = 0xBC8; // float32
        pub const m_iMouthAttachment: usize = 0xBCC; // AttachmentHandle_t
        pub const m_iEyeAttachment: usize = 0xBCD; // AttachmentHandle_t
        pub const m_bResetFlexWeightsOnModelChange: usize = 0xBCE; // bool
        pub const m_nEyeOcclusionRendererBone: usize = 0xBE8; // int32
        pub const m_mEyeOcclusionRendererCameraToBoneTransform: usize = 0xBEC; // matrix3x4_t
        pub const m_vEyeOcclusionRendererHalfExtent: usize = 0xC1C; // Vector
        pub const m_PhonemeClasses: usize = 0xC38; // C_BaseFlex::Emphasized_Phoneme[3]
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod CAbility_Fathom_LurkersAmbush_VData {
        pub const m_InvisModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadel_Modifier_LurkersAmbush_Invis>
        pub const m_RegenModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ImmobilizeModifier: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strSwapStarted: usize = 0x1590; // CSoundEventName
    }
    // Parent: CitadelAbilityVData
    // Field count: 7
    pub mod CCitadel_Ability_Mirage_FireBeetles_VData {
        ...
        pub const m_CasterModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DebuffModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_RecentlyDebuffedModifier: usize = 0x1660; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_StealWatcherModifier: usize = 0x1670; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ExplosionSound: usize = 0x1680; // CSoundEventName
        pub const m_strHitConfirm: usize = 0x1690; // CSoundEventName
    }
    // Parent: CitadelAbilityVData
    // Field count: 0
    ...
    // Field count: 12
    pub mod C_EnvSky {
        pub const m_hSkyMaterial: usize = 0x860; // CStrongHandle<InfoForResourceTypeIMaterial2>
        pub const m_hSkyMaterialLightingOnly: usize = 0x868; // CStrongHandle<InfoForResourceTypeIMaterial2>
        pub const m_bStartDisabled: usize = 0x870; // bool
        pub const m_vTintColor: usize = 0x871; // Color
        pub const m_vTintColorLightingOnly: usize = 0x875; // Color
        pub const m_flBrightnessScale: usize = 0x87C; // float32
        pub const m_nFogType: usize = 0x880; // int32
        pub const m_flFogMinStart: usize = 0x884; // float32
        pub const m_flFogMinEnd: usize = 0x888; // float32
        pub const m_flFogMaxStart: usize = 0x88C; // float32
        pub const m_flFogMaxEnd: usize = 0x890; // float32
        pub const m_bEnabled: usize = 0x894; // bool
    }
    // Parent: CCitadelModifierAuraVData
    // Field count: 4
    ...
    pub mod CCitadel_Ability_Jump {
        pub const m_flLastTimeOnZipLine: usize = 0xCA0; // GameTime_t
        pub const m_flLastOnGroundTime: usize = 0xCA4; // GameTime_t
        pub const m_flPhaseStartTime: usize = 0xCA8; // GameTime_t
        pub const m_flJumpTime: usize = 0xCAC; // GameTime_t
        pub const m_LastJumpType: usize = 0xCB0; // EJumpType_t
        pub const m_bShouldCreateAirJumpEffects: usize = 0xCB1; // bool
        pub const m_flDoubleJumpFailTime: usize = 0xCB4; // GameTime_t
        pub const m_eDoubleJumpFailReason: usize = 0xCB8; // ECitadelAbilityOrders
        pub const m_vWallJumpNormalUsed: usize = 0xCBC; // Vector
        pub const m_flGroundDashJumpStartTime: usize = 0xDE0; // CCitadelAutoScaledTime
        pub const m_flGroundDashJumpEndTime: usize = 0xDF8; // CCitadelAutoScaledTime
        pub const m_bJumped: usize = 0xE10; // bool
        pub const m_bCanDashJump: usize = 0xE11; // bool
        pub const m_nDesiredAirJumpCount: usize = 0xE14; // int32
        pub const m_nExecutedAirJumpCount: usize = 0xE18; // int32
        pub const m_bInSlideJump: usize = 0xE1C; // bool
        pub const m_nConsecutiveAirJumps: usize = 0xE1D; // int8
        pub const m_nConsecutiveWallJumps: usize = 0xE1E; // int8
        pub const m_vLastWallCollidedWithNormal: usize = 0xE20; // Vector
    }
    // Parent: C_PointEntity
    // Field count: 0
    pub mod CInfoTarget {}
    ...
    pub mod CCitadel_TechUpgrade_SuperAcolyteGlovesVData {
        pub const m_SpiritMeleeProcModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifierVData
    // Field count: 3
    ...
    pub mod C_DynamicProp {
        pub const m_bUseHitboxesForRenderBox: usize = 0xC88; // bool
        pub const m_bUseAnimGraph: usize = 0xC89; // bool
        pub const m_pOutputAnimBegun: usize = 0xC90; // CEntityIOOutput
        pub const m_pOutputAnimOver: usize = 0xCB8; // CEntityIOOutput
        pub const m_pOutputAnimLoopCycleOver: usize = 0xCE0; // CEntityIOOutput
        pub const m_OnAnimReachedStart: usize = 0xD08; // CEntityIOOutput
        pub const m_OnAnimReachedEnd: usize = 0xD30; // CEntityIOOutput
        pub const m_iszIdleAnim: usize = 0xD58; // CUtlSymbolLarge
        pub const m_nIdleAnimLoopMode: usize = 0xD60; // AnimLoopMode_t
        pub const m_bRandomizeCycle: usize = 0xD64; // bool
        pub const m_bStartDisabled: usize = 0xD65; // bool
        pub const m_bFiredStartEndOutput: usize = 0xD66; // bool
        pub const m_bForceNpcExclude: usize = 0xD67; // bool
        pub const m_bCreateNonSolid: usize = 0xD68; // bool
        pub const m_bIsOverrideProp: usize = 0xD69; // bool
        pub const m_iInitialGlowState: usize = 0xD6C; // int32
        pub const m_nGlowRange: usize = 0xD70; // int32
        pub const m_nGlowRangeMin: usize = 0xD74; // int32
        pub const m_glowColor: usize = 0xD78; // Color
        pub const m_nGlowTeam: usize = 0xD7C; // int32
        pub const m_iCachedFrameCount: usize = 0xD80; // int32
        pub const m_vecCachedRenderMins: usize = 0xD84; // Vector
        pub const m_vecCachedRenderMaxs: usize = 0xD90; // Vector
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod CCitadel_ArmorUpgrade_SpellShield {
        pub const fl_mSpellShieldBreakTime: usize = 0xCB8; // GameTime_t
    }
    // Parent: CitadelAbilityVData
    // Field count: 5
    pub mod CCitadel_Ability_TurretClone_VData {
        pub const m_strTurretParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strSwapParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TurretSound: usize = 0x1720; // CSoundEventName
        pub const m_BuffModifier: usize = 0x1730; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_cameraSequenceTeleport: usize = 0x1740; // CitadelCameraOperationsSequence_t
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CAbilityChargedTackleVData {
        pub const m_ChargePreviewParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ChargePrepareModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ChargeActiveModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
    ...
    pub mod C_NPC_TrooperNeutral {
        pub const m_bPlayingIdle: usize = 0x1468; // bool
        pub const m_bShieldActive: usize = 0x1469; // bool
    }
    // Parent: CCitadel_Modifier_StunnedVData
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Wraith_RapidFireVData {
        pub const m_CastParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TargetBuffSound: usize = 0x1640; // CSoundEventName
        pub const m_RapidFireModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CBaseAnimGraph
    // Field count: 1
    pub mod C_ItemWeaponParts {
        pub const m_hTouchedPlayeres: usize = 0xB20; // C_NetworkUtlVectorBase<CHandle<C_BasePlayerPawn>>
    }
    // Parent: CCitadel_Modifier_Intrinsic_BaseVData
    // Field count: 0
    pub mod CModifier_Operative_Scattercharge_Projectile_VData {}
    // Parent: CitadelAbilityVData
    // Field count: 1
    pub mod CAbilityStackingDamageVData {
        pub const m_StackingModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_BaseEventProc
    // Field count: 2
    ...
    pub mod CCitadel_Ability_Nano_Pounce {
        ...
        pub const m_hCurrentTarget: usize = 0xED4; // CHandle<C_BaseEntity>
        pub const m_hLastCastTarget: usize = 0xED8; // CHandle<C_BaseEntity>
        pub const m_vStartPosition: usize = 0xEDC; // Vector
        pub const m_vDeparturePosition: usize = 0xEE8; // Vector
        pub const m_flDepartureTime: usize = 0xEF8; // CCitadelAutoScaledTime
        pub const m_flArrivalTime: usize = 0xF10; // CCitadelAutoScaledTime
        pub const m_vLastKnownSafePos: usize = 0xF28; // Vector
        pub const m_bIsFirstCastCompleted: usize = 0xF36; // bool
        pub const m_tDoubleCastWindow: usize = 0xF38; // GameTime_t
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod CNPC_TrooperBarrackBossVData {
        pub const m_flBackDoorProtectionRange: usize = 0x17F8; // float32
        pub const m_BackdoorProtectionModifier: usize = 0x1800; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_BackdoorBulletResistModifier: usize = 0x1810; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ObjectiveRegen: usize = 0x1820; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod CFilterModel {
        pub const m_iFilterModel: usize = 0x5C0; // CUtlSymbolLarge
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbilityHornetLeapVData {
        pub const m_flChannelingAirDrag: usize = 0x1560; // float32
        pub const m_flChannelingMaxFallSpeed: usize = 0x1564; // float32
        pub const m_flVerticalMoveSpeedPercent: usize = 0x1568; // float32
        pub const m_flAirDrag: usize = 0x156C; // float32
        pub const m_flAirAcceleration: usize = 0x1570; // float32
        pub const m_flLaunchAirDrag: usize = 0x1574; // float32
        pub const m_flLaunchTime: usize = 0x1578; // float32
        pub const m_flMoveSpeedAboveBaseScale: usize = 0x157C; // float32
        pub const m_LeapModifier: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DustParticle: usize = 0x1590; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    ...
    pub mod CCitadel_Item_AOE_Tech_ShieldVData {
        pub const m_DurationModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: C_GameRules
    // Field count: 0
    ...
    pub mod C_LocalTempEntity {
        pub const flags: usize = 0xB00; // int32
        pub const die: usize = 0xB04; // GameTime_t
        pub const m_flFrameMax: usize = 0xB08; // float32
        pub const x: usize = 0xB0C; // float32
        pub const y: usize = 0xB10; // float32
        pub const fadeSpeed: usize = 0xB14; // float32
        pub const bounceFactor: usize = 0xB18; // float32
        pub const hitSound: usize = 0xB1C; // int32
        pub const priority: usize = 0xB20; // int32
        pub const tentOffset: usize = 0xB24; // Vector
        pub const m_vecTempEntAngVelocity: usize = 0xB30; // QAngle
        pub const tempent_renderamt: usize = 0xB3C; // int32
        pub const m_vecNormal: usize = 0xB40; // Vector
        pub const m_flSpriteScale: usize = 0xB4C; // float32
        pub const m_nFlickerFrame: usize = 0xB50; // int32
        pub const m_flFrameRate: usize = 0xB54; // float32
        pub const m_flFrame: usize = 0xB58; // float32
        pub const m_pszImpactEffect: usize = 0xB60; // char*
        pub const m_pszParticleEffect: usize = 0xB68; // char*
        pub const m_bParticleCollision: usize = 0xB70; // bool
        pub const m_iLastCollisionFrame: usize = 0xB74; // int32
        pub const m_vLastCollisionOrigin: usize = 0xB78; // Vector
        pub const m_vecTempEntVelocity: usize = 0xB84; // Vector
        pub const m_vecPrevAbsOrigin: usize = 0xB90; // Vector
        pub const m_vecTempEntAcceleration: usize = 0xB9C; // Vector
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_InfinitySlash {
        pub const m_flExplodeEndTime: usize = 0xD88; // GameTime_t
        pub const m_flBuffEndTime: usize = 0xD8C; // GameTime_t
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CNPC_Boss_Tier3VData {
        pub const m_nPhase2Health: usize = 0x10D8; // int32
        pub const m_flEyeZOffset: usize = 0x10DC; // float32
        pub const m_flDefaultMoveSpeed: usize = 0x10E0; // float32
        pub const m_flNoShieldMoveSpeed: usize = 0x10E4; // float32
        pub const m_flDyingMoveSpeed: usize = 0x10E8; // float32
        pub const m_flMovingToFinalPositionSpeed: usize = 0x10EC; // float32
        pub const m_DeathSmallExplosionParticle: usize = 0x10F0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DeathLargeExplosionParticle: usize = 0x11D0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_WeakpointBrokenExplosionParticle: usize = 0x12B0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ChargeUpExplosionParticle: usize = 0x1390; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strWIPModelName: usize = 0x1470; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
        pub const m_DyingSmallExplosion: usize = 0x1550; // CSoundEventName
        pub const m_AvatarKilledSound: usize = 0x1560; // CSoundEventName
        pub const m_AvatarBecomePatronSound: usize = 0x1570; // CSoundEventName
        pub const m_PatronLandedSound: usize = 0x1580; // CSoundEventName
        pub const m_PatronKilledSound: usize = 0x1590; // CSoundEventName
        pub const m_LaserSound: usize = 0x15A0; // CSoundEventName
        pub const m_LaserBeamModifier: usize = 0x15B0; // CEmbeddedSubclass<CBaseModifier>
        pub const m_DyingModifier: usize = 0x15C0; // CEmbeddedSubclass<CBaseModifier>
        pub const m_VulnerableModifier: usize = 0x15D0; // CEmbeddedSubclass<CBaseModifier>
        pub const m_Phase1Modifier: usize = 0x15E0; // CEmbeddedSubclass<CBaseModifier>
        pub const m_Phase2Modifier: usize = 0x15F0; // CEmbeddedSubclass<CBaseModifier>
        pub const m_BackdoorProtection: usize = 0x1600; // CEmbeddedSubclass<CBaseModifier>
        pub const m_ObjectiveRegen: usize = 0x1610; // CEmbeddedSubclass<CBaseModifier>
        pub const m_LaserChargingParticle: usize = 0x1620; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_LaserBeamEffect: usize = 0x1700; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_LaserPreviewEffect: usize = 0x17E0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_LaserDamageEffect: usize = 0x18C0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flLaserTargetingZOffset: usize = 0x19A0; // float32
        pub const m_flLaserTrackingSpeed: usize = 0x19A4; // float32
        pub const m_flLaserTrackingMaxSpeed: usize = 0x19A8; // float32
        pub const m_flLaserCastingTrackSpeed: usize = 0x19AC; // float32
        pub const m_flLaserCastingTrackMaxSpeed: usize = 0x19B0; // float32
        pub const m_flLaserDPSToPlayers: usize = 0x19B4; // float32
        pub const m_flLaserDPSToNPCs: usize = 0x19B8; // float32
        pub const m_flLaserDPSMaxHealth: usize = 0x19BC; // float32
        pub const m_flNoShieldLaserTrackingSpeed: usize = 0x19C0; // float32
        pub const m_flNoShieldLaserTrackingMaxSpeed: usize = 0x19C4; // float32
        pub const m_flNoShieldLaserCastingTrackSpeed: usize = 0x19C8; // float32
        pub const m_flNoShieldLaserCastingTrackMaxSpeed: usize = 0x19CC; // float32
        pub const m_flNoShieldLaserDPSToPlayers: usize = 0x19D0; // float32
        pub const m_flNoShieldLaserDPSToNPCs: usize = 0x19D4; // float32
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 2
    ...
    pub mod CItemSingleTargetStunVData {
        pub const m_StunDelayModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_CastParticle: usize = 0x15B8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadel_Item_TrackingProjectileApplyModifierVData
    // Field count: 1
    pub mod CItem_WitheringWhip_VData {
        pub const m_DebuffModifier: usize = 0x16A8; // CEmbeddedSubclass<CBaseModifier>
    }
    // Parent: C_PointEntity
    // Field count: 9
    ...
    pub mod C_DynamicLight {
        pub const m_Flags: usize = 0x860; // uint8
        pub const m_LightStyle: usize = 0x861; // uint8
        pub const m_Radius: usize = 0x864; // float32
        pub const m_Exponent: usize = 0x868; // int32
        pub const m_InnerAngle: usize = 0x86C; // float32
        pub const m_OuterAngle: usize = 0x870; // float32
        pub const m_SpotRadius: usize = 0x874; // float32
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 2
    ...
    pub mod CCitadel_ArmorUpgrade_CloakingDeviceActive_VData {
        pub const m_AmbushModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_InvisModifier: usize = 0x15B8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbilityGuidedArrowVData {
        pub const m_cameraCancelledTransitionBacktoArcher: usize = 0x1560; // CitadelCameraOperationsSequence_t
        pub const m_cameraExplodedTransitionBackToArcher: usize = 0x15E8; // CitadelCameraOperationsSequence_t
        pub const m_flCameraHoldAtExplosion: usize = 0x1670; // float32
        pub const m_flFadeToBlackTime: usize = 0x1674; // float32
        pub const m_SpectatingProjectileParticle: usize = 0x1678; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ExplosionParticle: usize = 0x1758; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_GuidedArrowChannelParticle: usize = 0x1838; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ProjectileModel: usize = 0x1918; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
        pub const m_ArrowOffsetX: usize = 0x19F8; // float32
        pub const m_ArrowCameraDistance: usize = 0x19FC; // float32
        pub const m_ArrowCameraHeightOffset: usize = 0x1A00; // float32
        pub const m_ArrowInitialPitch: usize = 0x1A04; // float32
        pub const m_GuidingModifier: usize = 0x1A08; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DebuffModifier: usize = 0x1A18; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_KillCheckModifier: usize = 0x1A28; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strExplodeSound: usize = 0x1A38; // CSoundEventName
        pub const m_flTrackAmount: usize = 0x1A48; // float32
        pub const m_flSpeedAccel: usize = 0x1A4C; // float32
        pub const m_flSpeedDeccel: usize = 0x1A50; // float32
        pub const m_flBaseProjectileSpeed: usize = 0x1A54; // float32
        pub const m_flMaxProjectileSpeed: usize = 0x1A58; // float32
        pub const m_flArrowModelTurnSpringStrength: usize = 0x1A5C; // float32
        pub const m_flKillCheckWindow: usize = 0x1A60; // float32
        pub const m_flWorldCollideGraceWindow: usize = 0x1A64; // float32
    }
    // Parent: CitadelAbilityVData
    // Field count: 3
    pub mod CAbilityPowerJumpVData {
        pub const m_JumpParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_InAirModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_PowerJumpModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod C_FuncElectrifiedVolume {
        pub const m_nAmbientEffect: usize = 0x860; // ParticleIndex_t
        pub const m_EffectName: usize = 0x868; // CUtlSymbolLarge
        pub const m_bState: usize = 0x870; // bool
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CCitadelYamatoBaseVData {
        pub const m_flShadowFormSpeed: usize = 0x1560; // float32
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod CCitadel_Ability_HatTrick {
        pub const m_hProjectile: usize = 0xCA0; // CHandle<C_CitadelProjectile>
    }
    // Parent: CCitadel_Modifier_BaseEventProcVData
    // Field count: 1
    ...
    pub mod CCitadel_Ability_BloodBombVData {
        pub const m_ExplodeParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SpilledBloodModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strBloodSpillStatName: usize = 0x1650; // CUtlString
    }
    // Parent: CCitadelModifier
    // Field count: 0
    pub mod CCitadel_Modifier_Upgrade_SpellslingerHeadshots_Buff {}
    // Parent: CCitadel_Modifier_BaseEventProc
    // Field count: 0
    ...
    pub mod C_BaseEntity {
        ...
        pub const m_pModifierProp: usize = 0x350; // CModifierProperty*
        pub const m_iMaxHealth: usize = 0x358; // int32
        pub const m_iHealth: usize = 0x35C; // int32
        pub const m_lifeState: usize = 0x360; // uint8
        pub const m_bTakesDamage: usize = 0x361; // bool
        pub const m_nTakeDamageFlags: usize = 0x368; // TakeDamageFlags_t
        pub const m_nPlatformType: usize = 0x370; // EntityPlatformTypes_t
        pub const m_ubInterpolationFrame: usize = 0x371; // uint8
        pub const m_hSceneObjectController: usize = 0x374; // CHandle<C_BaseEntity>
        pub const m_nNoInterpolationTick: usize = 0x378; // int32
        pub const m_nVisibilityNoInterpolationTick: usize = 0x37C; // int32
        pub const m_flProxyRandomValue: usize = 0x380; // float32
        pub const m_iEFlags: usize = 0x384; // int32
        pub const m_nWaterType: usize = 0x388; // uint8
        pub const m_bInterpolateEvenWithNoModel: usize = 0x389; // bool
        pub const m_bPredictionEligible: usize = 0x38A; // bool
        pub const m_bApplyLayerMatchIDToModel: usize = 0x38B; // bool
        pub const m_tokLayerMatchID: usize = 0x38C; // CUtlStringToken
        pub const m_nSubclassID: usize = 0x390; // CUtlStringToken
        pub const m_nSimulationTick: usize = 0x3A0; // int32
        pub const m_iCurrentThinkContext: usize = 0x3A4; // int32
        pub const m_aThinkFunctions: usize = 0x3A8; // CUtlVector<thinkfunc_t>
        pub const m_bDisabledContextThinks: usize = 0x3C0; // bool
        pub const m_flAnimTime: usize = 0x3C4; // float32
        pub const m_flSimulationTime: usize = 0x3C8; // float32
        pub const m_nSceneObjectOverrideFlags: usize = 0x3CC; // uint8
        pub const m_bHasSuccessfullyInterpolated: usize = 0x3CD; // bool
        pub const m_bHasAddedVarsToInterpolation: usize = 0x3CE; // bool
        pub const m_bRenderEvenWhenNotSuccessfullyInterpolated: usize = 0x3CF; // bool
        pub const m_nInterpolationLatchDirtyFlags: usize = 0x3D0; // int32[2]
        pub const m_ListEntry: usize = 0x3D8; // uint16[11]
        pub const m_flCreateTime: usize = 0x3F0; // GameTime_t
        pub const m_flSpeed: usize = 0x3F4; // float32
        pub const m_EntClientFlags: usize = 0x3F8; // uint16
        pub const m_bClientSideRagdoll: usize = 0x3FA; // bool
        pub const m_iTeamNum: usize = 0x3FB; // uint8
        pub const m_spawnflags: usize = 0x3FC; // uint32
        pub const m_nNextThinkTick: usize = 0x400; // GameTick_t
        pub const m_fFlags: usize = 0x408; // uint32
        pub const m_vecAbsVelocity: usize = 0x40C; // Vector
        pub const m_vecVelocity: usize = 0x418; // CNetworkVelocityVector
        pub const m_hEffectEntity: usize = 0x448; // CHandle<C_BaseEntity>
        pub const m_hOwnerEntity: usize = 0x44C; // CHandle<C_BaseEntity>
        pub const m_MoveCollide: usize = 0x450; // MoveCollide_t
        pub const m_MoveType: usize = 0x451; // MoveType_t
        pub const m_nActualMoveType: usize = 0x452; // MoveType_t
        pub const m_flWaterLevel: usize = 0x454; // float32
        pub const m_fEffects: usize = 0x458; // uint32
        pub const m_hGroundEntity: usize = 0x45C; // CHandle<C_BaseEntity>
        pub const m_nGroundBodyIndex: usize = 0x460; // int32
        pub const m_flFriction: usize = 0x464; // float32
        pub const m_flElasticity: usize = 0x468; // float32
        pub const m_flGravityScale: usize = 0x46C; // float32
        pub const m_flTimeScale: usize = 0x470; // float32
        pub const m_bAnimatedEveryTick: usize = 0x474; // bool
        pub const m_flNavIgnoreUntilTime: usize = 0x478; // GameTime_t
        pub const m_hThink: usize = 0x47C; // uint16
        pub const m_fBBoxVisFlags: usize = 0x488; // uint8
        pub const m_bPredictable: usize = 0x489; // bool
        pub const m_bRenderWithViewModels: usize = 0x48A; // bool
        pub const m_nSplitUserPlayerPredictionSlot: usize = 0x48C; // CSplitScreenSlot
        pub const m_nFirstPredictableCommand: usize = 0x490; // int32
        pub const m_nLastPredictableCommand: usize = 0x494; // int32
        pub const m_hOldMoveParent: usize = 0x498; // CHandle<C_BaseEntity>
        pub const m_Particles: usize = 0x4A0; // CParticleProperty
        pub const m_vecPredictedScriptFloats: usize = 0x4C8; // CUtlVector<float32>
        pub const m_vecPredictedScriptFloatIDs: usize = 0x4E0; // CUtlVector<int32>
        pub const m_nNextScriptVarRecordID: usize = 0x510; // int32
        pub const m_vecAngVelocity: usize = 0x520; // QAngle
        pub const m_DataChangeEventRef: usize = 0x52C; // int32
        pub const m_dependencies: usize = 0x530; // CUtlVector<CEntityHandle>
        pub const m_nCreationTick: usize = 0x548; // int32
        pub const m_bAnimTimeChanged: usize = 0x555; // bool
        pub const m_bSimulationTimeChanged: usize = 0x556; // bool
        pub const m_sUniqueHammerID: usize = 0x560; // CUtlString
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod CCitadel_ArmorUpgrade_DebuffReducerVData {
        pub const m_DebuffReducedParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_PurgeCastParticle: usize = 0x1688; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_MoveSpeedModifier: usize = 0x1768; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CScaleFunctionBase
    // Field count: 0
    ...
    pub mod C_Citadel_Bounce_Pad {
        pub const m_flUpFactor: usize = 0xB08; // float32
        pub const m_flBounceVelocity: usize = 0xB0C; // float32
        pub const m_flBarrelBounceVelocity: usize = 0xB10; // float32
        pub const m_flBarrelUpFactor: usize = 0xB14; // float32
        pub const m_bSpeedOnLand: usize = 0xB18; // bool
        pub const m_bHasBouncedPlayerBefore: usize = 0xB19; // bool
    }
    // Parent: C_BreakableProp
    // Field count: 1
    pub mod C_PhysicsProp {
        pub const m_bAwake: usize = 0xC88; // bool
    }
    // Parent: CBaseProp
    // Field count: 29
    pub mod C_BreakableProp {
        pub const m_CPropDataComponent: usize = 0xB40; // CPropDataComponent
        pub const m_OnBreak: usize = 0xB80; // CEntityIOOutput
        pub const m_OnHealthChanged: usize = 0xBA8; // CEntityOutputTemplate<float32>
        pub const m_OnTakeDamage: usize = 0xBD0; // CEntityIOOutput
        pub const m_impactEnergyScale: usize = 0xBF8; // float32
        pub const m_iMinHealthDmg: usize = 0xBFC; // int32
        pub const m_flPressureDelay: usize = 0xC00; // float32
        pub const m_flDefBurstScale: usize = 0xC04; // float32
        pub const m_vDefBurstOffset: usize = 0xC08; // Vector
        pub const m_hBreaker: usize = 0xC14; // CHandle<C_BaseEntity>
        pub const m_PerformanceMode: usize = 0xC18; // PerformanceMode_t
        pub const m_flPreventDamageBeforeTime: usize = 0xC1C; // GameTime_t
        pub const m_BreakableContentsType: usize = 0xC20; // BreakableContentsType_t
        pub const m_strBreakableContentsPropGroupOverride: usize = 0xC28; // CUtlString
        pub const m_strBreakableContentsParticleOverride: usize = 0xC30; // CUtlString
        pub const m_bHasBreakPiecesOrCommands: usize = 0xC38; // bool
        pub const m_explodeDamage: usize = 0xC3C; // float32
        pub const m_explodeRadius: usize = 0xC40; // float32
        pub const m_explosionDelay: usize = 0xC48; // float32
        pub const m_explosionBuildupSound: usize = 0xC50; // CUtlSymbolLarge
        pub const m_explosionCustomEffect: usize = 0xC58; // CUtlSymbolLarge
        pub const m_explosionCustomSound: usize = 0xC60; // CUtlSymbolLarge
        pub const m_explosionModifier: usize = 0xC68; // CUtlSymbolLarge
        pub const m_hPhysicsAttacker: usize = 0xC70; // CHandle<C_BasePlayerPawn>
        pub const m_flLastPhysicsInfluenceTime: usize = 0xC74; // GameTime_t
        pub const m_flDefaultFadeScale: usize = 0xC78; // float32
        pub const m_hLastAttacker: usize = 0xC7C; // CHandle<C_BaseEntity>
        pub const m_hFlareEnt: usize = 0xC80; // CHandle<C_BaseEntity>
        pub const m_noGhostCollision: usize = 0xC84; // bool
    }
    // Parent: CCitadelBaseLockonAbility
    // Field count: 4
    pub mod CCitadel_Ability_Lash_Ultimate {
        pub const m_EGrappleState: usize = 0xE32; // ELashGrappleState
        pub const m_flStateEnterTime: usize = 0xE34; // GameTime_t
        pub const m_flNextStateTime: usize = 0xE38; // GameTime_t
        pub const m_flBoostEndTime: usize = 0xE3C; // GameTime_t
    }
    // Parent: CCitadelModifierVData
    // Field count: 4
    ...
    pub mod CAbilityViscousBowlingVData {
        pub const m_TransformStartFx: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ExplodeFX: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_WallImpactFx: usize = 0x1720; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_BallTrailFx: usize = 0x1800; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_GroundImpactParticle: usize = 0x18E0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_JumpParticle: usize = 0x19C0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DirectionParticle: usize = 0x1AA0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flVerticalCameraOffsetLerpTime: usize = 0x1B80; // float32
        pub const m_flVerticalCameraOffsetBias: usize = 0x1B84; // float32
        pub const m_flVerticalCameraOffset: usize = 0x1B88; // float32
        pub const m_flDistanceCameraOffsetLerpTime: usize = 0x1B8C; // float32
        pub const m_flDistanceCameraOffsetBias: usize = 0x1B90; // float32
        pub const m_flDistanceCameraOffset: usize = 0x1B94; // float32
        pub const m_strPopGraphParamter: usize = 0x1B98; // CGlobalSymbol
        pub const m_BallJumpSound: usize = 0x1BA0; // CSoundEventName
        pub const m_EnterBallSound: usize = 0x1BB0; // CSoundEventName
        pub const m_BallLoopSound: usize = 0x1BC0; // CSoundEventName
        pub const m_ExitBallSound: usize = 0x1BD0; // CSoundEventName
        pub const m_WallImpactSound: usize = 0x1BE0; // CSoundEventName
        pub const m_PlayerImpactSound: usize = 0x1BF0; // CSoundEventName
        pub const m_ImpactModifier: usize = 0x1C00; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DamagePreventionModifier: usize = 0x1C10; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_RollingModifier: usize = 0x1C20; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flTransformToBallTime: usize = 0x1C30; // float32
        pub const m_flTransformFromBallTime: usize = 0x1C34; // float32
        pub const m_flAirTurnRatio: usize = 0x1C38; // float32
        pub const m_flWallTurnRatioMax: usize = 0x1C3C; // float32
        pub const m_flWallTurnRatioMin: usize = 0x1C40; // float32
        pub const m_flTurnRatio: usize = 0x1C44; // float32
        pub const m_flDefaultBallSpeed: usize = 0x1C48; // float32
        pub const m_flFastBallSpeed: usize = 0x1C4C; // float32
        pub const m_flSpeedAccel: usize = 0x1C50; // float32
        pub const m_flSpeedDeccel: usize = 0x1C54; // float32
        pub const m_flElasticity: usize = 0x1C58; // float32
        pub const m_flWallCheckGroundOffset: usize = 0x1C5C; // float32
        pub const m_flWallPauseTime: usize = 0x1C60; // float32
        pub const m_flWallAngleMin: usize = 0x1C64; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadelItemPickupRejuv {
        pub const m_CCitadelAbilityComponent: usize = 0xB38; // CCitadelAbilityComponent
        pub const m_bPickedUp: usize = 0xCD8; // bool
    }
    // Parent: C_BaseToggle
    // Field count: 0
    ...
    // Field count: 24
    pub mod C_Beam {
        pub const m_flFrameRate: usize = 0x860; // float32
        pub const m_flHDRColorScale: usize = 0x864; // float32
        pub const m_flFireTime: usize = 0x868; // GameTime_t
        pub const m_flDamage: usize = 0x86C; // float32
        pub const m_nNumBeamEnts: usize = 0x870; // uint8
        pub const m_queryHandleHalo: usize = 0x874; // int32
        pub const m_hBaseMaterial: usize = 0x898; // CStrongHandle<InfoForResourceTypeIMaterial2>
        pub const m_nHaloIndex: usize = 0x8A0; // CStrongHandle<InfoForResourceTypeIMaterial2>
        pub const m_nBeamType: usize = 0x8A8; // BeamType_t
        pub const m_nBeamFlags: usize = 0x8AC; // uint32
        pub const m_hAttachEntity: usize = 0x8B0; // CHandle<C_BaseEntity>[10]
        pub const m_nAttachIndex: usize = 0x8D8; // AttachmentHandle_t[10]
        pub const m_fWidth: usize = 0x8E4; // float32
        pub const m_fEndWidth: usize = 0x8E8; // float32
        pub const m_fFadeLength: usize = 0x8EC; // float32
        pub const m_fHaloScale: usize = 0x8F0; // float32
        pub const m_fAmplitude: usize = 0x8F4; // float32
        pub const m_fStartFrame: usize = 0x8F8; // float32
        pub const m_fSpeed: usize = 0x8FC; // float32
        pub const m_flFrame: usize = 0x900; // float32
        pub const m_nClipStyle: usize = 0x904; // BeamClipStyle_t
        pub const m_bTurnedOff: usize = 0x908; // bool
        pub const m_vecEndPos: usize = 0x90C; // Vector
        pub const m_hEndEntity: usize = 0x918; // CHandle<C_BaseEntity>
    }
    // Parent: CCitadelModifierVData
    // Field count: 3
    ...
    pub mod CCitadel_Ability_Tengu_AirLift {
        pub const m_nHoldBombEffect: usize = 0xCA0; // ParticleIndex_t
        pub const m_bFlying: usize = 0xEA0; // bool
        pub const m_bFlyingStarted: usize = 0xEA1; // bool
        pub const m_bIsGrabbing: usize = 0xEA2; // bool
        pub const m_bIsHoldingBomb: usize = 0xEA3; // bool
        pub const m_flCurrentSpeed: usize = 0xEA4; // float32
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CAbilityChronoSwapVData {
        pub const m_BubbleMoveModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strSwapStarted: usize = 0x1570; // CSoundEventName
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod CCitadelSpectateDirectedCamera {
        pub const m_flCameraDist: usize = 0x56C; // float32
        pub const m_flCameraPitch: usize = 0x570; // float32
        pub const m_flCameraHeight: usize = 0x574; // float32
        pub const m_hTarget: usize = 0x578; // CHandle<C_BaseEntity>
    }
    // Parent: CitadelAbilityVData
    // Field count: 9
    pub mod CAbilityExplosiveBarrelVData {
        pub const m_BarrelExplodeParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_MirvExplodeParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_BarrelBurnParticle: usize = 0x1720; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strExplodeSound: usize = 0x1800; // CSoundEventName
        pub const m_strMirvExplodeSound: usize = 0x1810; // CSoundEventName
        pub const m_strRiccochetSound: usize = 0x1820; // CSoundEventName
        pub const m_strBarrelSoundLp: usize = 0x1830; // CSoundEventName
        pub const m_strBarrelLaunchSound: usize = 0x1840; // CSoundEventName
        pub const m_strBarrelMeleedSound: usize = 0x1850; // CSoundEventName
    }
    // Parent: CitadelAbilityVData
    // Field count: 7
    pub mod CCitadel_Ability_MobileResupplyVData {
        pub const m_flResupplyForceScale: usize = 0x1560; // float32
        pub const m_flResupplyUp: usize = 0x1564; // float32
        pub const m_strKilledSound: usize = 0x1568; // CSoundEventName
        pub const m_AuraModifier: usize = 0x1578; // CEmbeddedSubclass<CBaseModifier>
        pub const m_DispenserModel: usize = 0x1588; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
        pub const m_SprayParticle: usize = 0x1668; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DestroyedParticle: usize = 0x1748; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod CAbilityTokamakHeatSinksInherentVData {
        pub const m_HotTracerParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_HotWeaponFxParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strHotWeaponShootSound: usize = 0x1720; // CSoundEventName
        pub const m_strOverheatRed: usize = 0x1730; // CSoundEventName
        pub const m_strOverheatFull: usize = 0x1740; // CSoundEventName
    }
    // Parent: CCitadelModifierVData
    // Field count: 12
    ...
    pub mod CCitadel_Ability_WreckerTeleport {
        ...
        pub const m_flArrowSpeed: usize = 0xCAC; // float32
        pub const m_flSnapAnglesBackTime: usize = 0xCB0; // GameTime_t
        pub const m_flCastTimeDamage: usize = 0xCB4; // float32
        pub const m_flCastTime: usize = 0xCB8; // GameTime_t
        pub const m_bNeedsExplosion: usize = 0xCBC; // bool
        pub const m_vProjectileRemovedOrigin: usize = 0xCC0; // Vector
        pub const m_angCasterAnglesAtCastTime: usize = 0xCCC; // QAngle
    ...
    pub mod CCitadel_GrandFinaleStage {
        ...
        pub const m_flStartEmitTime: usize = 0xB18; // GameTime_t
        pub const m_flEndEmitTime: usize = 0xB1C; // GameTime_t
        pub const m_nTouchCount: usize = 0xB20; // int32
    }
    // Parent: CCitadelModifierAura
    // Field count: 0
    ...
    pub mod C_PointWorldText {
        ...
        pub const m_messageText: usize = 0x880; // char[512]
        pub const m_FontName: usize = 0xA80; // char[64]
        pub const m_BackgroundMaterialName: usize = 0xAC0; // char[64]
        pub const m_bEnabled: usize = 0xB00; // bool
        pub const m_bFullbright: usize = 0xB01; // bool
        pub const m_flWorldUnitsPerPx: usize = 0xB04; // float32
        pub const m_flFontSize: usize = 0xB08; // float32
        pub const m_flDepthOffset: usize = 0xB0C; // float32
        pub const m_bDrawBackground: usize = 0xB10; // bool
        pub const m_flBackgroundBorderWidth: usize = 0xB14; // float32
        pub const m_flBackgroundBorderHeight: usize = 0xB18; // float32
        pub const m_flBackgroundWorldToUV: usize = 0xB1C; // float32
        pub const m_Color: usize = 0xB20; // Color
        pub const m_nJustifyHorizontal: usize = 0xB24; // PointWorldTextJustifyHorizontal_t
        pub const m_nJustifyVertical: usize = 0xB28; // PointWorldTextJustifyVertical_t
        pub const m_nReorientMode: usize = 0xB2C; // PointWorldTextReorientMode_t
    }
    // Parent: C_BaseEntity
    // Field count: 0
    ...
    pub mod CNPC_MidBossVData {
        pub const m_iStartingHealth: usize = 0x10D8; // int32
        pub const m_iHealthGainPerMinute: usize = 0x10DC; // int32
        pub const m_flAggroTime: usize = 0x10E0; // float32
        pub const m_DyingSmallExplosion: usize = 0x10E8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DyingFinalExplosion: usize = 0x11C8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_flDyingDuration: usize = 0x12A8; // float32
        pub const m_KnockbackAura: usize = 0x12B0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_AggroEnemy: usize = 0x12C0; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifierAuraVData
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Tengu_StoneFormVData {
        ...
        pub const m_StoneFormParticle: usize = 0x1720; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CastTargetSound: usize = 0x1800; // CSoundEventName
        pub const m_strImpactSound: usize = 0x1810; // CSoundEventName
        pub const m_strFallCollideImpactSound: usize = 0x1820; // CSoundEventName
        pub const m_DragModifier: usize = 0x1830; // CEmbeddedSubclass<CBaseModifier>
        pub const m_strTrueFormModel: usize = 0x1840; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
        pub const m_flLandHoldTime: usize = 0x1920; // float32
        pub const m_flRisingTime: usize = 0x1924; // float32
        pub const m_flCollideRadius: usize = 0x1928; // float32
    }
    // Parent: CitadelAbilityVData
    // Field count: 6
    pub mod CCitadel_Ability_UltComboVData {
        pub const m_MeleeSwingParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_MeleeImpactParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SelfModifier: usize = 0x1720; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_TargetModifier: usize = 0x1730; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_KillCheckModifier: usize = 0x1740; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flKillCheckWindow: usize = 0x1750; // float32
    }
    // Parent: CCitadel_Ability_PrimaryWeapon
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Magician_MagicBolt {
        ...
        pub const m_iCurrentRedirects: usize = 0xCC0; // int32
    }
    // Parent: CitadelAbilityVData
    // Field count: 2
    pub mod CAbilityDustStormVData {
        pub const m_DustStormAura: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_GrenadeTrailModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CitadelItemVData
    // Field count: 1
    pub mod CCitadel_UtilityUpgrade_DebuffImmunityVData {
        pub const m_DebuffImmunityModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CitadelItemVData
    // Field count: 2
    pub mod CCitadel_UtilityUpgrade_RocketBootsVData {
        ...
        pub const m_InAirWatcherModifier: usize = 0x1688; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_BaseBulletPreRollProcVData
    // Field count: 2
    ...
    pub mod C_BasePropDoor {
        pub const m_eDoorState: usize = 0xDB0; // DoorState_t
        pub const m_modelChanged: usize = 0xDB4; // bool
        pub const m_bLocked: usize = 0xDB5; // bool
        pub const m_bNoNPCs: usize = 0xDB6; // bool
        pub const m_closedPosition: usize = 0xDB8; // Vector
        pub const m_closedAngles: usize = 0xDC4; // QAngle
        pub const m_hMaster: usize = 0xDD0; // CHandle<C_BasePropDoor>
        pub const m_vWhereToSetLightingOrigin: usize = 0xDD4; // Vector
    }
    // Parent: C_PointEntity
    // Field count: 0
    ...
    // Parent: CCitadelModifierVData
    // Field count: 1
    pub mod CModifier_Upgrade_ArcaneSurge_WeaponBuff_VData {
        pub const m_TriggeredSound: usize = 0x608; // CSoundEventName
    }
    // Parent: CCitadelModifier
    // Field count: 7
    ...
    pub mod CCitadel_ArmorUpgrade_AblativeCoatVData {
        pub const m_RestoreEffectModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_OnTakeDamageEffectModifier: usize = 0x15B8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_OnBreakEffectModifier: usize = 0x15C8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ResistBuffModifier: usize = 0x15D8; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flOnTakeDamageEffectDuration: usize = 0x15E8; // float32
        pub const m_flOnBreakEffectDuration: usize = 0x15EC; // float32
        pub const m_flOnRestoreEffectDuration: usize = 0x15F0; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod C_PhysPropClientside {
        pub const m_flTouchDelta: usize = 0xC88; // GameTime_t
        pub const m_fDeathTime: usize = 0xC8C; // GameTime_t
        pub const m_inertiaScale: usize = 0xC90; // float32
        pub const m_vecDamagePosition: usize = 0xC94; // Vector
        pub const m_vecDamageDirection: usize = 0xCA0; // Vector
        pub const m_nDamageType: usize = 0xCAC; // DamageTypes_t
    }
    // Parent: C_CitadelProjectile
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Viscous_Telepunch {
        pub const m_vecTeleportPosition: usize = 0xE98; // Vector
        pub const m_vecTeleportPositionNormal: usize = 0xEA4; // Vector
        pub const m_eTelepunchState: usize = 0xEB0; // ETelepunchState_t
        pub const m_flNextStateTime: usize = 0xEB4; // GameTime_t
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 2
    pub mod CCitadel_Ability_GooGrenade {
        pub const m_vecPuddleModifiers: usize = 0xCA0; // CUtlVector<CHandle<C_BaseEntity>>
        pub const m_LastDetonateTime: usize = 0xEE8; // GameTime_t
    }
    // Parent: CitadelAbilityVData
    // Field count: 6
    pub mod CCitadel_Ability_ViscousWeapon_Alt_VData {
        pub const m_strChargingParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ImpactParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_FiringParticle: usize = 0x1720; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ExplosionSound: usize = 0x1800; // CSoundEventName
        pub const m_ChargeSound: usize = 0x1810; // CSoundEventName
        pub const m_ShootSound: usize = 0x1820; // CSoundEventName
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 4
    pub mod CCitadel_Ability_Chrono_TimeWall {
        pub const m_hChargingParticle: usize = 0xCA0; // ParticleIndex_t
        pub const m_vSpawnPos: usize = 0xCA4; // Vector
        pub const m_qAngles: usize = 0xCB0; // QAngle
        pub const m_bAirCast: usize = 0xCBC; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadelBaseDashCastAbility {
        pub const m_hAbilityToTrigger: usize = 0xCA0; // CHandle<C_CitadelBaseAbility>
        pub const m_flDashCastStartTime: usize = 0xCA4; // GameTime_t
        pub const m_vDashCastDir: usize = 0xCA8; // Vector
    }
    // Parent: CBaseFilter
    // Field count: 1
    pub mod CFilterProximity {
        pub const m_flRadius: usize = 0x5C0; // float32
    }
    // Parent: C_BaseEntity
    // Field count: 4
    ...
    pub mod CCitadel_Ability_BurrowVData {
        pub const m_ExplodeParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_BurrowStartParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_BurrowEndParticle: usize = 0x1720; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_BurrowInGroundParticle: usize = 0x1800; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_BurrowModifier: usize = 0x18E0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SpinModifier: usize = 0x18F0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strBurrowEndSound: usize = 0x1900; // CSoundEventName
        pub const m_flChannelEndEnemyPopUpForce: usize = 0x1910; // float32
        pub const m_flChannelEndEnemyPopUpCylinderHeight: usize = 0x1914; // float32
        pub const m_cameraSpinStart: usize = 0x1918; // CitadelCameraOperationsSequence_t
    }
    // Parent: CCitadel_Modifier_BaseBulletPreRollProc
    // Field count: 0
    ...
    pub mod CAbilityWreckerTeleportVData {
        pub const m_SpectatingProjectileParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ExplosionParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ChannelParticle: usize = 0x1720; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CastParticle: usize = 0x1800; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ArrowOffsetX: usize = 0x18E0; // float32
        pub const m_ArrowCameraDistance: usize = 0x18E4; // float32
        pub const m_ArrowCameraHeightOffset: usize = 0x18E8; // float32
        pub const m_ArrowInitialPitch: usize = 0x18EC; // float32
        pub const m_GuidingModifier: usize = 0x18F0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DebuffModifier: usize = 0x1900; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strExplodeSound: usize = 0x1910; // CSoundEventName
        pub const m_flTrackAmount: usize = 0x1920; // float32
        pub const m_flSpeedAccel: usize = 0x1924; // float32
        pub const m_flSpeedDeccel: usize = 0x1928; // float32
        pub const m_flBaseProjectileSpeed: usize = 0x192C; // float32
        pub const m_flMaxProjectileSpeed: usize = 0x1930; // float32
    }
    // Parent: CitadelItemVData
    // Field count: 1
    pub mod CCitadel_WeaponUpgrade_SpellslingerHeadshots_VData {
        pub const m_HeadshotBuffModifier: usize = 0x15A8; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadelBaseLockonAbility {
        ...
        pub const m_LockOnStartTime: usize = 0xE20; // GameTime_t
        pub const m_nTargetingLightEffect: usize = 0xE28; // ParticleIndex_t
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CAbilityStompVData {
        pub const m_StompParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strStompExplosionSound: usize = 0x1640; // CSoundEventName
        pub const m_strCastDelayLocalPlayerSound: usize = 0x1650; // CSoundEventName
        pub const m_DebuffModifier: usize = 0x1660; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_BulletResistModifier: usize = 0x1670; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 0
    ...
    pub mod CAbilityStormCloudVData {
        pub const m_StormCloudModifier: usize = 0x1560; // CEmbeddedSubclass<CBaseModifier>
        pub const m_flOscillateFrequency: usize = 0x1570; // float32
        pub const m_flOscillateSpeed: usize = 0x1574; // float32
        pub const m_flOscillateSpeedStart: usize = 0x1578; // float32
        pub const m_flOscillateStartOffset: usize = 0x157C; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod CCitadel_Ability_ShivDaggerVData {
        pub const m_DamageDebuffModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_SlowDebuffModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DaggerStuckParticle: usize = 0x1580; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DaggerImpactParticle: usize = 0x1660; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DaggerExplodeParticle: usize = 0x1740; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strDaggerHitSound: usize = 0x1820; // CSoundEventName
        pub const m_strDaggerExplodeSound: usize = 0x1830; // CSoundEventName
    }
    // Parent: CCitadel_Modifier_Stunned
    // Field count: 2
    ...
    pub mod C_Citadel_BreakblePropPickup {
        ...
        pub const m_sPickupName: usize = 0xB08; // CUtlString
        pub const m_nNameOffset: usize = 0xB10; // int32
        pub const m_sAmbientNoise: usize = 0xB18; // CUtlString
    }
    // Parent: CCitadelModifierVData
    // Field count: 2
    ...
    pub mod CCitadel_Ability_Shakedown_TargetVData {
        pub const m_RootModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_PulseModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Mantle {
        pub const m_flVertOffset: usize = 0xCA0; // float32
        pub const m_flHorizGap: usize = 0xCA4; // float32
        pub const m_vStartPos: usize = 0xCA8; // Vector
        pub const m_vTargetPos: usize = 0xCB4; // Vector
        pub const m_angFacing: usize = 0xCC0; // QAngle
        pub const m_nMantleTypeIndex: usize = 0xCCC; // int32
    ...
    pub mod C_PhysMagnet {
        pub const m_aAttachedObjectsFromServer: usize = 0xB00; // CUtlVector<int32>
        pub const m_aAttachedObjects: usize = 0xB18; // CUtlVector<CHandle<C_BaseEntity>>
    }
    // Parent: CitadelAbilityVData
    // Field count: 6
    pub mod CCitadel_Ability_Magician_AnimalCurseVData {
        pub const m_CurseModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_AirDampingModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_TargetWarningSound: usize = 0x1580; // CSoundEventName
        ...
        pub const m_TargetWarningParticle: usize = 0x1670; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ProjectileExplodeParticle: usize = 0x1750; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Wrecker_Ultimate {
        pub const m_angBeamAngles: usize = 0xCC0; // QAngle
        pub const m_bNeedsBeamReset: usize = 0xCD8; // bool
    }
    // Parent: CCitadelModifierVData
    // Field count: 8
    ...
    pub mod CCitadel_Ability_HornetLeap {
        pub const m_bLeaping: usize = 0xCA2; // bool
        pub const m_flLeapStartTime: usize = 0xCA4; // GameTime_t
        pub const m_nFXIndex: usize = 0xCA8; // ParticleIndex_t
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Gunslinger_SpreadingFireVData {
        pub const m_ImpactParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_FireDebuffModifier: usize = 0x1640; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Chrono_TimeWallVData {
        pub const m_AuraModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_TimeWallParticle: usize = 0x1570; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TimeWallChargeParticle: usize = 0x1650; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TimeWallHitParticle: usize = 0x1730; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_TimeWallHitTimerParticle: usize = 0x1810; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strWallCreated: usize = 0x18F0; // CSoundEventName
        pub const m_strChargeUpSound: usize = 0x1900; // CSoundEventName
    }
    // Parent: CCitadelModifierVData
    // Field count: 1
    ...
    pub mod CAbilityChargedShotVData {
        pub const m_ChannelParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ChannelStartParticle: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_ShootParticle: usize = 0x1720; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbilityHookVData {
        pub const m_SelfModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_TargetModifier: usize = 0x1570; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_BulletAmpModifier: usize = 0x1580; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_ShieldModifier: usize = 0x1590; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_HookOutParticle: usize = 0x15A0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strHookSuccessSound: usize = 0x1680; // CSoundEventName
        pub const m_strHookAllySound: usize = 0x1690; // CSoundEventName
        pub const m_strHookMissSound: usize = 0x16A0; // CSoundEventName
        pub const m_strHookImpactGeoSound: usize = 0x16B0; // CSoundEventName
        pub const m_SelfBuffCastSound: usize = 0x16C0; // CSoundEventName
        pub const m_flTrooperHitRadius: usize = 0x16D0; // float32
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 4
    pub mod CCitadel_Ability_IcePath {
        pub const m_bIcePathing: usize = 0xD10; // bool
        pub const m_qLastAngles: usize = 0xD14; // QAngle
        pub const m_vLastVelocity: usize = 0xD20; // Vector
        pub const m_bFirstMovementTick: usize = 0xD2C; // bool
    }
    // Parent: CCitadelModifier
    // Field count: 1
    ...
    pub mod CCitadel_Ability_Slide {
        pub const m_flGroundDashSlideTime: usize = 0xCF8; // CCitadelAutoScaledTime
        pub const m_flSlowGetupStartTime: usize = 0xD10; // GameTime_t
        pub const m_bShouldTriggerSlowGetup: usize = 0xD14; // bool
        pub const m_bWantsSlide: usize = 0xD15; // bool
        pub const m_bAirborneWhenDuckPressed: usize = 0xD16; // bool
        pub const m_bIsSliding: usize = 0xD17; // bool
        pub const m_flSpeedAdjust: usize = 0xD18; // float32
        pub const m_flDuckPressedTime: usize = 0xD1C; // GameTime_t
        pub const m_flSlideChangeTime: usize = 0xD20; // GameTime_t
        pub const m_flSlidingOnFlatStartTime: usize = 0xD24; // GameTime_t
        pub const m_nJumpsThisSlideSession: usize = 0xD28; // int32
        pub const m_flOnGroundStartTime: usize = 0xD2C; // GameTime_t
        pub const m_flDashSlideStartTime: usize = 0xD30; // GameTime_t
        pub const m_bStartedSlideViaProbeSlope: usize = 0xD34; // bool
        pub const m_nSlideEffectIndex: usize = 0xD38; // ParticleIndex_t
    }
    // Parent: C_AI_CitadelNPC
    // Field count: 6
    pub mod C_NPC_Boss_Tier3 {
        pub const m_iLane: usize = 0x1468; // int32
        pub const m_angTargeting1: usize = 0x1470; // QAngle
        pub const m_angTargeting2: usize = 0x1488; // QAngle
        pub const m_nElectricBeamCasts: usize = 0x14A0; // int32
        pub const m_eAliveState: usize = 0x14A4; // ETier3State_t
        pub const m_ePhase: usize = 0x14A8; // ETier3Phase_t
    }
    // Parent: CCitadelModifier
    // Field count: 8
    ...
    pub mod CCitadel_Ability_Uppercut {
        pub const m_bShouldUseResources: usize = 0xF50; // bool
    }
    // Parent: C_CitadelBaseAbility
    // Field count: 1
    pub mod CCitadel_Ability_PsychicPulse {
        pub const m_vecPulseTargets: usize = 0xCD8; // C_NetworkUtlVectorBase<CHandle<C_BaseEntity>>
    }
    // Parent: C_BaseEntity
    // Field count: 0
    ...
    // Field count: 24
    pub mod C_Sprite {
        pub const m_hSpriteMaterial: usize = 0x860; // CStrongHandle<InfoForResourceTypeIMaterial2>
        pub const m_hAttachedToEntity: usize = 0x868; // CHandle<C_BaseEntity>
        pub const m_nAttachment: usize = 0x86C; // AttachmentHandle_t
        pub const m_flSpriteFramerate: usize = 0x870; // float32
        pub const m_flFrame: usize = 0x874; // float32
        pub const m_flDieTime: usize = 0x878; // GameTime_t
        pub const m_nBrightness: usize = 0x888; // uint32
        pub const m_flBrightnessDuration: usize = 0x88C; // float32
        pub const m_flSpriteScale: usize = 0x890; // float32
        pub const m_flScaleDuration: usize = 0x894; // float32
        pub const m_bWorldSpaceScale: usize = 0x898; // bool
        pub const m_flGlowProxySize: usize = 0x89C; // float32
        pub const m_flHDRColorScale: usize = 0x8A0; // float32
        pub const m_flLastTime: usize = 0x8A4; // GameTime_t
        pub const m_flMaxFrame: usize = 0x8A8; // float32
        pub const m_flStartScale: usize = 0x8AC; // float32
        pub const m_flDestScale: usize = 0x8B0; // float32
        pub const m_flScaleTimeStart: usize = 0x8B4; // GameTime_t
        pub const m_nStartBrightness: usize = 0x8B8; // int32
        pub const m_nDestBrightness: usize = 0x8BC; // int32
        pub const m_flBrightnessTimeStart: usize = 0x8C0; // GameTime_t
        pub const m_hOldSpriteMaterial: usize = 0x8C8; // CWeakHandle<InfoForResourceTypeIMaterial2>
        pub const m_nSpriteWidth: usize = 0x968; // int32
        pub const m_nSpriteHeight: usize = 0x96C; // int32
    }
    // Parent: CitadelAbilityVData
    // Field count: 9
    pub mod CAbilityBullChargeVData {
        pub const m_cameraSequenceImpact: usize = 0x1560; // CitadelCameraOperationsSequence_t
        pub const m_ModifierTossAirControlLockout: usize = 0x15E8; // CEmbeddedSubclass<CBaseModifier>
        pub const m_ModifierWeaponPowerIncrease: usize = 0x15F8; // CEmbeddedSubclass<CBaseModifier>
        pub const m_ModifierChargeDragEnemy: usize = 0x1608; // CEmbeddedSubclass<CBaseModifier>
        pub const m_ModifierBullCharging: usize = 0x1618; // CEmbeddedSubclass<CBaseModifier>
        pub const m_WallImpactParticle: usize = 0x1628; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strWallSlamSound: usize = 0x1708; // CSoundEventName
        pub const m_flWallStunLookAheadDist: usize = 0x1718; // float32
        pub const m_flEndChargeVelocityScale: usize = 0x171C; // float32
    }
    ...
    pub mod CAbilityShivDashVData {
        pub const m_DashModifier: usize = 0x1560; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_DashImpactEffect: usize = 0x1570; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DashSwingEffect: usize = 0x1650; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_DashLineEffect: usize = 0x1730; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_strDashStartWithTargets: usize = 0x1810; // CSoundEventName
        pub const m_strDashStartEcho: usize = 0x1820; // CSoundEventName
        pub const m_strDashStartMiss: usize = 0x1830; // CSoundEventName
        pub const m_strDashHitEnemy: usize = 0x1840; // CSoundEventName
        pub const m_flEchoDelay: usize = 0x1850; // float32
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CAbilityHornetSnipeVData {
        pub const m_AssassinateShotParticle: usize = 0x1560; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_AssassinateShotParticleOwnerOnly: usize = 0x1640; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_LaserSightParticle: usize = 0x1720; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_LaserSightParticleOwnerOnly: usize = 0x1800; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_SnipeModifier: usize = 0x18E0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_BuffOnKillModifier: usize = 0x18F0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_GlowEnemyModifier: usize = 0x1900; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_strSnipeImpactSound: usize = 0x1910; // CSoundEventName
        pub const m_strZoomIn: usize = 0x1920; // CSoundEventName
        pub const m_strZoomOut: usize = 0x1930; // CSoundEventName
        pub const m_flMinScopeTimeToShoot: usize = 0x1940; // float32
        pub const m_flFadeToBlackTime: usize = 0x1944; // float32
        pub const m_flFoVChangeTime: usize = 0x1948; // float32
        pub const m_ScopeFoV: usize = 0x1950; // CUtlVector<float32>
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod C_RagdollProp {
        pub const m_ragPos: usize = 0xB08; // C_NetworkUtlVectorBase<Vector>
        pub const m_ragAngles: usize = 0xB20; // C_NetworkUtlVectorBase<QAngle>
        pub const m_flBlendWeight: usize = 0xB38; // float32
        pub const m_hRagdollSource: usize = 0xB3C; // CHandle<C_BaseEntity>
        pub const m_iEyeAttachment: usize = 0xB40; // AttachmentHandle_t
        pub const m_flBlendWeightCurrent: usize = 0xB44; // float32
        pub const m_parentPhysicsBoneIndices: usize = 0xB48; // CUtlVector<int32>
        pub const m_worldSpaceBoneComputationOrder: usize = 0xB60; // CUtlVector<int32>
    }
    // Parent: CCitadel_Item
    // Field count: 0
    ...
    pub mod CBaseDashCastAbilityVData {
        pub const m_AbilityToTrigger: usize = 0x1560; // CSubclassName<4>
        pub const m_flDashCastTriggerRadius: usize = 0x1570; // float32
        pub const m_flDashSpeed: usize = 0x1574; // float32
        pub const m_bSnapToZeroSpeedOnEnd: usize = 0x1578; // bool
        pub const m_bUseCurveToDefineSpeed: usize = 0x1579; // bool
        pub const m_MovementSpeedCurve: usize = 0x1580; // CPiecewiseCurve
        pub const m_flMovementSpeedCurveAvgSpeed: usize = 0x15C0; // float32
        pub const m_strTargetHitSound: usize = 0x15C8; // CSoundEventName
        pub const m_strMissSound: usize = 0x15D8; // CSoundEventName
    }
    // Parent: CCitadelModifier
    // Field count: 0
    ...
    pub mod CCitadel_Ability_Gravity_Lasso_VData {
        pub const m_GravityLassoSelf: usize = 0x1560; // CEmbeddedSubclass<CBaseModifier>
        pub const m_GravityLassoTarget: usize = 0x1570; // CEmbeddedSubclass<CBaseModifier>
    }
    // Parent: CCitadel_Modifier_BaseEventProcVData
    // Field count: 4
    ...
    pub mod CCitadel_Item_HealthRegenAuraVData {
        pub const m_HealParticle: usize = 0x15A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_CastHealParticle: usize = 0x1688; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        pub const m_HealingPulseTrackerModifier: usize = 0x1768; // CEmbeddedSubclass<CCitadelModifier>
    }
    // Parent: CCitadel_Modifier_BaseShield
    // Field count: 0
    ...
    pub mod C_HeroPreview {
        pub const m_CCitadelHeroComponent: usize = 0x568; // CCitadelHeroComponent
    }
    // Parent: None
    // Field count: 3
    ...
    pub mod CCitadel_Ability_GoldenIdolVData {
        pub const m_sIdolDropOffSound: usize = 0x1640; // CSoundEventName
        pub const m_DropoffTimerModifier: usize = 0x1650; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_HoldingIdolModifier: usize = 0x1660; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_RevealedHoldingIdolModifier: usize = 0x1670; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_Bonus01: usize = 0x1680; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_Bonus02: usize = 0x1690; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_NoPickupModifier: usize = 0x16A0; // CEmbeddedSubclass<CCitadelModifier>
        pub const m_flInstantGoldPercentage: usize = 0x16B0; // float32
        pub const m_iComebackBounty: usize = 0x16B4; // int32
        pub const m_flCasterBonusPercent: usize = 0x16B8; // float32
        pub const m_flRevealTime: usize = 0x16BC; // float32
        pub const m_flDamageTickRate: usize = 0x16C0; // float32
        pub const m_flMaxHealthDamage: usize = 0x16C4; // float32
        pub const m_flTimeToDamage: usize = 0x16C8; // float32
        pub const m_flNoPickupTime: usize = 0x16CC; // float32
    }
    // Parent: CitadelAbilityVData
    // Field count: 2
    ...
    pub mod CCitadel_Ability_CardToss {
        pub const m_bCardIsFlying: usize = 0xF20; // bool
    }
    // Parent: CCitadelModifierVData
    // Field count: 5
